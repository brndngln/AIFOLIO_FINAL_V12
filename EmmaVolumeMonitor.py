...
def authorize_volume_access(token: str):
    if validate_biometric(token):
        ...
        raise PermissionError("❌ Unauthorized volume access. EMMA biometric validation failed.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--biometric", type=str, help="Biometric token for volume access")
