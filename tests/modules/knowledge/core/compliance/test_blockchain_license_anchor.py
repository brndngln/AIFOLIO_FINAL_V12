...
try:
    from modules.knowledge.core.compliance.blockchain_license_anchor import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.core.compliance.blockchain_license_anchor: {e}", allow_module_level=True)
