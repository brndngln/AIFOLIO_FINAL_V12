...
try:
    from modules.knowledge.features.automation.backend.admin_tools.manual_triggers import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.admin_tools.manual_triggers: {e}", allow_module_level=True)
