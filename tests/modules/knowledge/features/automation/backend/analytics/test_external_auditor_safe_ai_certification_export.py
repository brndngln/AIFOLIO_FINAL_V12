...
try:
    from modules.knowledge.features.automation.backend.analytics.external_auditor_safe_ai_certification_export import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.analytics.external_auditor_safe_ai_certification_export: {e}", allow_module_level=True)
