...
try:
    from modules.knowledge.features.automation.backend.analytics.global_vault_ecosystem_maturity_scorecard import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.analytics.global_vault_ecosystem_maturity_scorecard: {e}", allow_module_level=True)
