...
try:
    from modules.knowledge.features.automation.backend.analytics.static_partner_revenue_contribution import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.analytics.static_partner_revenue_contribution: {e}", allow_module_level=True)
