...
try:
    from modules.knowledge.features.automation.backend.analytics.cross_partner_safe_ai_alignment_report import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.analytics.cross_partner_safe_ai_alignment_report: {e}", allow_module_level=True)
