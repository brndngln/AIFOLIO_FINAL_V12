...
try:
    from modules.knowledge.features.automation.backend.analytics.global_safe_ai_business_impact_map import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.analytics.global_safe_ai_business_impact_map: {e}", allow_module_level=True)
