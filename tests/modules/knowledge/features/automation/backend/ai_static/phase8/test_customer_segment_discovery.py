...
try:
    from modules.knowledge.features.automation.backend.ai_static.phase8.customer_segment_discovery import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.ai_static.phase8.customer_segment_discovery: {e}", allow_module_level=True)
