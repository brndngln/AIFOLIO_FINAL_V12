...
try:
    from modules.knowledge.features.automation.backend.ai_static.phase8.cross_market_promotion_planner import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import modules.knowledge.features.automation.backend.ai_static.phase8.cross_market_promotion_planner: {e}", allow_module_level=True)
