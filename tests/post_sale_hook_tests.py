...
class TestPostSaleHooks(unittest.TestCase):
    ...
    def test_trigger_upsell_suggestion(self):
        from autonomy.post_sale_hooks.trigger_upsell_suggestion import trigger_upsell_suggestion
    ...
    def test_log_receipt_to_db(self):
        ...
        log_receipt_to_db({"vault": "v1", "buyer": "test@aifolio.com", "price": 100, "timestamp": "2025-06-18T00:00:00Z"})
    ...
    def test_file_tax_compliance(self):
        ...
        file_tax_compliance.trigger({"vault": "v1", "buyer": "test@aifolio.com", "price": 100})
