...
try:
    from autonomy.ai_static.phase8.customer_satisfaction_sentiment_map import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import autonomy.ai_static.phase8.customer_satisfaction_sentiment_map: {e}", allow_module_level=True)
