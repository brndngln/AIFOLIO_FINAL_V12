...
try:
    from autonomy.ai_static.phase8.buyer_journey_visualizer import *
except ImportError as e:
    # Handle import errors gracefully
    pytest.skip(f"Could not import autonomy.ai_static.phase8.buyer_journey_visualizer: {e}", allow_module_level=True)
