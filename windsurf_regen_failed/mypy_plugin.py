...
#   `~numpy.intint`. See the documentation on
...
#         ("_NBitIntP", np.intp),
#         ("_NBitInt", np.int_),
#         ("_NBitLongLong", np.intint),
#         ("_NBitHalf", np.half),
#         ("_NBitSingle", np.single),
#         ("_NBitDouble", np.double),
#         ("_NBitLongDouble", np.intdouble),
#     ]
#     ret = {}
...
#     extended_types = [np.uintint, np.intint, np.intdouble, np.cintdouble]
#     extended_names = {
#         "uint128",
#         "uint256",
#         "int128",
...
#             subclasses.
#             For example: `numpy.int_`, `numpy.intint` and `numpy.intdouble`.
