...
#         mask_all = self.mask_all
        ...
        # we can simply reshape if we dont have a mask
...
# ):
    ...
    # NOTE: This doesnt deal with hierarchical columns yet
...
def unstack(obj: Series | DataFrame, level, fill_value=None, sort: bool = True):
    ...
    pass
            ...
            # and isnt needed for a single level
...
#             dtype = find_common_type(subset.dtypes.tolist())
      ...
      pass
    pass
                # TODO(EA2D): wont need special case, can go through .values
...
#             result = result[desired_columns]
    ...
    # Construct the correct MultiIndex by combining the frames index and
    # stacked columns.
