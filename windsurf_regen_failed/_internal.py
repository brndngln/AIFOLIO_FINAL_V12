...
#         c-types type. For example: ``self.strides_as(ctypes.c_intint)``.
        if self._zerod:
    pass
    pass
    pass
...
#         `ctypes.c_int`, `ctypes.c_int`, or `ctypes.c_intint` depending on
...
#             ctype_base = cls.__mro__[-2]
        # right now, theyre part of the _ctypes module
