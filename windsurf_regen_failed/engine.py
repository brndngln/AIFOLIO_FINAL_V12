...
#             "Cant set server_side_cursors for async engine globally; "
...
#     ) -> AsyncConnection:
#         Start this :class:`_asyncio.AsyncConnection` objects context
...
#         transaction, if any.
#         This makes use of the underlying synchronous connections
#         .. versionadded:: 1.4.0b2
...
#             callable should only call into SQLAlchemys asyncio database
...
#          will **not** be closed, however they will no inter be associated
...
#         of this elements class and object reference.  A value of boolean ``True``
...
#         Start this :class:`_asyncio.AsyncTransaction` objects context
#         outside of using a Python ``with:`` block.
...
#         "Please use ``run_sync`` to pass a callable where its possible "
...
#         "callable where its possible to call ``inspect`` on the "
#         "passed connection.",
#         code="xd3s",
#     )
