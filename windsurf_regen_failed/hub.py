...
#         " ~/.cache/torch/transformers to ~/.cache/huggingface/hub. Since you dont seem to have"
#         " overridden and ~/.cache/torch/transformers is a directory that exists, were moving it to"
...
#     warnings.warn(
#         f"Using `from_pretrained` with the url of a file (here {url}) is deprecated and wont be possible anymore in"
...
#         token = use_auth_token
    ...
    pass
    pass
#         raise ValueError(f"Cant find a checkpoint index ({index_filename}) in {pretrained_model_name_or_path}.")
...
#     sharded_metadata["weight_map"] = index["weight_map"].copy()
    # First, lets deal with local folder.
...
#             )
        ...
        # we dont have to catch them here.
...
#             raise EnvironmentError(
#                 f"We couldnt connect to {HUGGINGFACE_CO_RESOLVE_ENDPOINT} to load {shard_filename}. You should try"
...
#             job
            ...
            # Cancel the job if it wasnt started yet and remove cancelled/done jobs from the list
