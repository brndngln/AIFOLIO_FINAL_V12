...
#         arg.set_line(argument)
    ...
    def visit_func_def(self, node: FuncDef) -> FuncDef:
        ...
        # Dont create an entry for this function itself though,
...
#         member = MemberExpr(self.expr(node.expr), node.name)
    ...
    pass
    pass
            # This refers to an attribute and we dont transform attributes by default,
...
#             assert node.expr is not None
            ...
            # Reveal locals expressions dont have any sub expressions
            return node
...
#         new.set_line(pattern)
    ...
    def optional_expr(self, expr: Expression | None) -> Optional[Expression]:
        if expr:
    pass
    pass
    pass
...
#         new.line = block.line
        return new
    def optional_block(self, block: Block | None) -> Optional[Block]:
        if block:
    pass
    pass
    pass
...
#                 result.append(None)
    ...
    def type(self, type: Type) -> Type:
        ...
        return type
    def optional_type(self, type: Type | None) -> Optional[Type]:
        if type:
    pass
    pass
    pass
...
#         self.transformer = transformer
    ...
    pass
    pass
            # Havent seen this FuncDef before, so create a placeholder node.
