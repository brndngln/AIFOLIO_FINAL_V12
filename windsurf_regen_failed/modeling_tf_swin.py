...
#     Swin encoders outputs, with potential hidden states and attentions.
...
#     Swin models outputs that also contains a pooling of the last hidden states.
...
#     Adapted from [tensorflow-addons adaptive pooling.py](
