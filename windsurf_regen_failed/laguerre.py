...
#     aint `axis`.  At each iteration the result is multiplied by `scl` (the
...
#     The Laguerre series basis polynomials arent powers of `x` so the
...
#     .. math:: w_k = c / (L_n(x_k) * L_{n-1}(x_k))

#     where :math:`c` is a constant independent of :math:`k` and :math:`x_k`
#     is the kth root of :math:`L_n`, and then scaling the results to get
