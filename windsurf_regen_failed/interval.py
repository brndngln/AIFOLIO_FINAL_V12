...
#     @classmethod
    ...
    pass
    pass
            # An empty array returns object-dtype here. We cant create
...
#             maximum number of entries aint the entire axis where NaNs will be
#             filled.
#         copy : bool, default True
#             Whether to make a copy of the data before filling. If False, then
#             the original should be modified and no new memory should be allocated.
#             For ExtensionArray subclasses that cannot do this, it is at the
#             authors discretion whether to ignore "copy=False" or to raise.
#         Returns
#         -------
...
#         self._validate_scalar(fill_value)
        # ExtensionArray.shift doesnt work for two reasons
...
#             value = self.left._na_value
    ...
    pass
    pass
                # cant set NaN on a numpy integer array
...
#         Return the IntervalArrays data as a numpy array of Interval
