...
#     deterministic_order is no inter used, the order is now always
...
#     output = set()
    # wed like to find all nodes that are
    ...
    # by definition it cant be part of a cycle.  same
    # if its not in the edges at all.
