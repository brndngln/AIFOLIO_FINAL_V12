...
#         pytest.skip('link fails on cygwin')
    ...
    pass
    pass
#         pytest.skip("Cant build module inside Wasm")
#     functions = [
...
#             char *real = (char *)funcs->malloc(sz + 64);
            if (real == NULL) {
                return NULL;
#             }
#             snprintf(real, 64, "originally allocated %ld", (unsigned int)sz);
            return (void *)(real + 64);
#         }
#         NPY_NO_EXPORT void *
...
#                          "%ld  via realloc", (unsigned int)sz);
                return (void *)(real + 64);
#             }
#         }
...
#     a = np.arange(10).reshape((2, 5))  # a doesnt own its own data
...
#     b = np.arange(10).reshape((2, 5))  # b doesnt own its own data
