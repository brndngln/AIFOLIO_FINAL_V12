...
#             current_block = f"{line}\n"
            ...
            # Otherwise its part of the description of the current arg.
...
#     Removes the lines testing an output with the doctest syntax in a code sample when its set to `None`.
...
# ):
    def docstring_decorator(fn):
        # model_class defaults to functions class if not specified otherwise
...
#             raise ValueError(f"Docstring cant be built for model {model_class}")
