...
#       where this isnt sufficient, :paramref:`.association_proxy.creator`
...
#         ...
# mypy 0.990 we are no inter allowed to make this Protocol[_T_con]
...
#          complete path.
#         .. versionadded:: 1.3 - :class:`.AssociationProxy` no inter stores
...
#                 inst = None
    ...
    pass
    pass
            # the AssociationProxyInstance cant be generalized
...
#             )
            ...
            # the proxied attribute doesnt exist on the target class;
...
#         raise NotImplementedError(
#             "The association proxy cant be used as a plain column "
...
#             value_expr = attr.comparator._criterion_exists(criterion, **kwargs)
    ...
    pass
#                 raise exc.ArgumentError(
#                     "Cant apply keyword arguments to column-targeted "
...
#             "proceed since we dont know what type of object is referred "
#             "towards"
#             % (
...
#     @util.memoized_property
    def _lookup_cache(self) -> Dict[Type[Any], AssociationProxyInstance[_T]]:
        ...
        # e.g. proxy is A-> A.b -> B -> B.b_attr, but B.b_attr doesnt exist;
...
#             )
    ...
    pass
#             raise exc.InvalidRequestError(
#                 "contains() doesnt apply to a scalar object endpoint; use =="
#             )
        else:
            return self._comparator._criterion_exists(
...
#     ) -> Union[_VT, _T, None]:
    ...
    def setdefault(self, key: _KT, default: Optional[_VT] = None) -> _VT:
        ...
        # default must allow None, return type cant include None,
