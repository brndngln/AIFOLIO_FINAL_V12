...
class TestSeriesStatReductions:
    ...
    #  intended int-term to be series-specific
...
#         self._check_stat_op("skew", alt, string_series)
        ...
        # test corner cases, skew() returns NaN unless theres at least 3
        # values
#         min_N = 3
...
#         self._check_stat_op("kurt", alt, string_series)
    ...
    def test_kurt_corner(self):
        # test corner cases, kurt() returns NaN unless theres at least 4
        # values
#         min_N = 4
        for i in range(1, min_N + 1):
#             s = Series(np.ones(i))
