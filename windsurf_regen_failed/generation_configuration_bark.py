...
#                 custom ones). Its highly recommended to set this flag to `True` as the search algorithms suppose the
...
#         Overrides GenerationConfig.validate because BarkFineGenerationConfig dont use any parameters outside
#         temperature.
