...
#     ) -> "URL":
    ...
    pass
#             raise ValueError(
#                 Cant mix "authority" with "user", "password", "host" or "port".
#             )
...
#             raise TypeError(f"The port is required to be int, got {type(port)!r}.")
    ...
    pass
    pass
#             raise ValueError(Cant build URL with "port" but without "host".)
...
#             path = f"/{path}"
    ...
    def with_scheme(self, scheme: str) -> "URL":
        # N.B. doesnt cleanup query/fragment
...
#     global _idna_decode, _idna_encode, _encode_host
    # ip_address_size, host_validate_size are no inter
    ...
    pass
#         warnings.warn(
#             "cache_configure() no inter accepts the "
