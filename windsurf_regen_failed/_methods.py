...
if nt.dtype(nt.intdouble) != nt.dtype(nt.double):
      pass
      pass
    pass
#     _complex_to_float.update({
#         nt.dtype(nt.cintdouble) : nt.dtype(nt.intdouble),
#     })
...
#         items = nt.intp(items)
        ...
        # TODO: Optimize case when `where` is broadcast aint a non-reduction
