...
#             Whether the MegaMultiDimensionDampedEma used in Megas self-attention should work bidirectionally (`True`)
...
#             this is a hard limit on input length; `"rotary"` relative positional bias will extrapolate to inter
#             sequences
