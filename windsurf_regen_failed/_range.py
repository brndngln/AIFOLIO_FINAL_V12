...
#         rec = curs.fetchone()
      ...
      pass
    pass
            # The above algorithm doesnt work for customized seach_path
...
#                 savepoint = False
                ...
                # which case we dont need the savepoint anyway.
...
#         r = self.adapted
    ...
    pass
            ...
            # quoted (they are numbers). Also, Im lazy and not preparing the
            # adapter because I assume encoding doesnt matter for these
            # objects.
...
# TODO: probably wont work with infs, nans and other tricky cases.
