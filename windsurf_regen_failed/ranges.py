...
#         olower = other.lower
#         olower_b = other.bounds[0]
        # Check whether this upper edge is less than others lower end
...
#         oupper = other.upper
#         oupper_b = other.bounds[1]
        # Check whether this lower edge is greater than others upper end
...
#         olower = other.lower
#         olower_b = other.bounds[0]
        # Check whether this lower edge is not less than others lower end
...
#         oupper = other.upper
#         oupper_b = other.bounds[1]
        # Check whether this upper edge is not greater than others upper end
...
#         and also render as ``INT4RANGE`` in SQL and DDL.
    ...
    pass
            ...
            # Im choosing #1 as the resulting type object
...
#         spec = value.lower if value.lower is not None else value.upper
    ...
    pass
            ...
            # empty Range, SQL datatype cant be determined here
