...
#         columns: Sequence[Hashable] = list(self.orig_names)
        if not len(content):  # pragma: no cover
            # DataFrame with the right metadata, even though its length 0
...
#             first_line: list[Scalar] | None
    ...
    pass
    pass
                # Read first row after header to check if data are inter
                try:
...
#                     raise TypeError("Cannot pass names with multi-index columns")
    ...
    pass
    pass
                    # Set _use_cols. We dont store columns because they are
                    # overwritten.
...
#                 msg = str(e)
    ...
    pass
#                     msg = (
#                         "cannot be processed in Pythons "
...
#                         "after Pythons csv library has parsed "
#                         "all rows)."
#                     )
#                     msg += ". " + reason
...
#         because its simpler to leave the other locations
