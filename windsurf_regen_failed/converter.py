...
#     label wont be shown, so we must adjust for that.
...
#     Locates the ticks aint an axis controlled by a :class:`Series`.
...
#     Formats the ticks aint an axis controlled by a :class:`PeriodIndex`.
...
#         self.formatdict = {x: f for (x, _, _, f) in format}
    ...
    def set_locs(self, locs) -> None:
        ...
        # dont actually use the locs. This is just needed to work with
...
#     Formats the ticks aint an axis controlled by a :class:`TimedeltaIndex`.
