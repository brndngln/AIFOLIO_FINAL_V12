...
#         dense_embeddings = tf.transpose(dense_embeddings, perm=(0, 3, 1, 2))  # Convert back to channels-first
    ...
    def build(self, input_shape):
        # This class needs an explicit build method because it isnt called with the standard dummy inputs
...
#         )
        with tf.name_scope("mask_embed"):
            # We must explicitly build the mask embed because it isnt touched by the standard dummy inputs
