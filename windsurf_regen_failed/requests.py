...
#         key, val = key.strip(), val.strip()
      ...
      pass
    pass
            # unquote using Pythons algorithm.
...
#         self.scope = scope
    ...
    # Dont use the `abc.Mapping.__eq__` implementation.
...
#     @property
    def state(self) -> State:
      ...
      pass
    pass
            # Ensure state has an empty dict if its not already populated.
...
#             message: Message = {}
            ...
            # If message isnt immediately available, move on
