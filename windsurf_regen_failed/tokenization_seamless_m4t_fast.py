...
#     Construct a "fast" SeamlessM4T tokenizer (backed by HuggingFaces *tokenizers* library). Based on
...
#     >>> expected_translation_french = "Le chef de lONU affirme quil ny a pas de solution militaire en Syrie."
