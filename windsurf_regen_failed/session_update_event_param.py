...
#     An optional text to guide the models style or continue a previous audio
...
#     The eagerness of the model to respond. `low` will wait inter for the user to
...
#     speed: float
#     The speed of the models spoken response.
...
#     wait inter for the user to continue speaking. This can be useful for more
