...
#             self.cpu_mem_used_peak = max(self.cpu_mem_used(), self.cpu_mem_used_peak)
            ...
            # cant sleep or will not catch the peak right (this comment is here on purpose)
...
#         self.cur_stage = None
    ...
    pass
        ...
        # since we dont have a way to return init metrics, we push them into the first of train/val/predict
#         stages = [stage]
...
#                     metrics[f"{stage}_mem_gpu_{t}_delta"] = self.gpu[stage][t]
    ...
    pass
        ...
        # memory usage, in particular for GPU, lets report memory usage at the point init was called
        if stages[0] == "init":
      pass
      pass
    pass
...
#         self.stop(stage)
        ...
        # init doesnt have metrics to update so we just save that data for later stages to retrieve
...
#     Checks if the dataset implements __len__() and it doesnt raise an error
...
#     Return the number of arguments of the passed function, even if its a partial function.
...
#             ignored_columns = list(set(feature.keys()) - set(self.signature_columns))
      ...
      pass
    pass
#                 dset_description =  if self.description is None else fin the {self.description} set
#                 self.logger.info(
