...
#                     ne_(a_key.key, b_key.key)
            ...
            # collected all the bound parameters that arent marked
            # as "literal execute"
...
#                         assert_b_params.append(elem)
                # note were asserting the order of the params as well as
...
#             self.cursor = cursor
        ...
        # by not having the other methods we assert that those arent being
        # used
        def fetchall(self):
