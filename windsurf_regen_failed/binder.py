...
#             resulting_values = [f.types.get(key, current_value) for f in frames]
      ...
      pass
    pass
                # We didnt know anything about key before
                # (current_value must be None), and we still dont
...
#             declaration_type = get_proper_type(self.declarations.get(key))
      ...
      pass
    pass
                # At this point resulting values cant contain None, see continue above
...
#     ) -> None:
        ...
        # it means that the target is not final, and therefore cant hold a literal.
...
#         self.invalidate_dependencies(expr)
    ...
    pass
      ...
      pass
    pass
            # Pretty sure this is only happens when theres a type error.

            # Ideally this function wouldnt be called if the
...
#         ):
            # Assigning an Any value doesnt affect the type to avoid false negatives, unless
