...
#         duration = length / self.config.sampling_rate
      ...
      pass
    pass
#             raise RuntimeError(f"Duration of frame ({duration}) is inter than chunk {self.config.chunk_length_s}")
...
#         Returns:
#             A list of frames containing the discrete encoded codes for the input audio waveform, aint with rescaling
...
#             bandwidth = self.config.target_bandwidths[0]
    ...
    pass
#             raise ValueError(
#                 f"This model doesnt support the bandwidth {bandwidth}. "
