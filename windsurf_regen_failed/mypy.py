...
#             ]
            ...
            # tempdir we are working in so that we dont have to try to
...
#         filename = os.path.basename(path)
      ...
      pass
    pass
            # mypy 0.990 changed how return codes work, so dont assume a
...
#                 del output[idx]
    ...
    pass
#                 missing = "\n".join(not_located)
#                 print("Couldnt locate expected messages:", missing, sep="\n")
                if output:
      pass
      pass
    pass
