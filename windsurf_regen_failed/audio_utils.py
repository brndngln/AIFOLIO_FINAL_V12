...
#     This code is adapted from *torchaudio* and *librosa*. Note that the default parameters of torchaudios
...
#             shorter than `frame_length`, but were assuming the array has already been zero-padded.
#         frame_length (`int`):
...
#             How to convert the spectrogram to log scale. Possible options are: `None` (dont convert), `"log"` (take
