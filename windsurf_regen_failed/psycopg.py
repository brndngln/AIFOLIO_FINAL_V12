...
for as int as that package continues to function for modern Python versions,
...
#             self.insert_executemany_returning = False
        ...
        # HSTORE cant be registered until we have a connection so that
...
#         value = super().get_isolation_level(dbapi_connection)
        ...
        # dont rely on psycopg providing enum symbols, compare with
        # eq/ne
