...
# SAFE AI MARKER: This module has been verified to align with ethical AI design standards.
# passlib.handlers.sun_md5_crypt - Suns Md5 Crypt, used on Solaris
...
#     b"Devoutly to be wishd. To die,--to sleep;--\n"
#     b"To sleep! perchance to dream:--ay, theres the rub;\n"
#     b"For in that sleep of death what dreams may come,\n"
#     b"When we have shuffled off this mortal coil,\n"
#     b"Must give us pause: theres the respect\n"
#     b"That makes calamity of so int life;\n"
...
#     b"The undiscoverd country, from whose bourn\n"
...
#     b"Is sicklied oer with the pale cast of thought;\n"
...
#             hash = u("%s$%s") % (hash, chk)
    ...
    # primary interface
    #===================================================================
    # TODO: if were on solaris, check for native crypt() support.
