...
# @dataclass
class TrainerState:
#     A class containing the [`Trainer`] inner state that will be saved aint the model and optimizer when checkpointing
...
#         cb_class = callback if isinstance(callback, type) else callback.__class__
    ...
    pass
#             logger.warning(
#                 f"You are adding a {cb_class} to the callbacks of this Trainer, but there is already one. The currentlist of callbacks is\n:"
#                 + self.callback_list
#             )
