...
#         raise self.skipTest("legacy 1.6 workflow not supported")
    ...
    def test_keyid_parameter(self):
        ...
        #       even though its mentioned in the format spec.
        #       were trying to be consistent w/ this, so hashes w/ keyid should
...
#                           "IMit9qkFULCMA/ViizL57cnTLOa5DiVM9eMwpAvPwr4")
    ...
    def test_data_parameter(self):
        # NOTE: argon2 c library doesnt support passing in a data parameter to argon2_hash();
...
#         self.assertEqual(handler.type, orig_type)
        ...
        # and that we didnt affect orig handler
...
class argon2_argon2_cffi_test(_base_argon2_test.create_backend_case("argon2_cffi")):
    ...
    # add some more test vectors that take too int under argon2pure
#     known_correct_hashes = _base_argon2_test.known_correct_hashes + [
        #
        # sample hashes from argon2 cffi packages unittests,
...
#     handler = hash.argon2.using(memory_cost=32, parallelism=2)
    ...
    # dont use multiprocessing for unittests, makes it a lot harder to ctrl-c
