...
#         1. `preprocess`: A grid of 1024 points evenly separated is generated aint with bounding boxes and point
#            labels.
...
#                 A filtering threshold in `[0,1]` applied on the models predicted mask quality.
#             stability_score_thresh (`float`, *optional*, defaults to 0.95):
#                 A filtering threshold in `[0,1]`, using the stability of the mask under changes to the cutoff used to
#                 binarize the models mask predictions.
...
#         target_size = self.image_processor.size["intest_edge"]
