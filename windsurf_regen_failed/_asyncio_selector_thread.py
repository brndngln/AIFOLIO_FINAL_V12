...
#         self._receive.setblocking(False)
        ...
        #   macOS (darwin 15.5): 1
        #   Windows 10: 525347
        # Windows youre weird. (And on Windows setting SNDBUF to 0 makes send
        # blocking, even on non-blocking sockets, so dont do that.)
...
#         self._send.setsockopt(socket.SOL_SOCKET, socket.SO_SNDBUF, 1)
        ...
        # platforms this fails b/c AF_UNIX sockets arent actually TCP.
        try:
