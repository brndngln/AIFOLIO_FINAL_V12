...
#     Length: 4, dtype: int64
    ...
    # that _typ to ensure that users dont unnecessarily use EAs inside
...
#             fv = np.nan
    ...
    # Base EA class (and all other EA classes) dont have limit_area keyword
