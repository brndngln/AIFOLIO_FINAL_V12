...
#            'busday_offset', 'busday_count', 'is_busday', 'busdaycalendar',
#            ]
# we dont need all these imports, but we need to keep them for compatibility
...
# we dont export these for import *, but we do want them accessible
# as numerictypes.bool, etc.
from builtins import bool, int, float, complex, object, str, bytes
from numpy.compat import int, unicode
# We use this later
...
# Now add the types weve determined to this module
for key in allTypes:
