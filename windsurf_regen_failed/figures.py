...
#         self.hAlign=hAlign
#         self._getCaptionPara()  #Larry Meyns fix - otherwise they all get the number of the last chapter.
...
#         This needs our commercial PageCatcher product, or youll get a blank.
...
#                     4*inch,     # width
#                     5*inch,     # height
#                     showBoundary = 1  # helps us see whats going on
#                     )
