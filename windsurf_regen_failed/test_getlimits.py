...
from numpy import half, single, double, intdouble
...
class TestLongdouble:
    def test_singleton(self):
#         ftype = finfo(intdouble)
#         ftype2 = finfo(intdouble)
#         assert_equal(id(ftype), id(ftype2))
class TestFinfo:
    def test_basic(self):
...
#         ld_ma = _discovered_machar(np.intdouble)
#     bytes = np.dtype(np.intdouble).itemsize
