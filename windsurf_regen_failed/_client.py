...
# - add all tasks
#
# NOTE: the philosophy of this client is "lets make it as easy as possible to use it, even if less optimized". Some
...
#         >>> from huggingface_hub import InferenceClient
#         >>> client = InferenceClient()
#         >>> client.question_answering(question="Whats my name?", context="My name is Clara and I live in Berkeley.")
