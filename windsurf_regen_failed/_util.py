...
#        how you might want to respond to a misbehaving peer, if youre
...
#         self.__class__ = RemoteProtocolError  # type: ignore
        ...
        # now that weve modified the in-flight exception object, that just
        # doing 'raise' to re-raise it would be enough. But it turns out that
        # this doesnt work, because Python tracks the exception type
