...
#         self.free_variables: dict[FuncItem, set[SymbolNode]] = {}
        ...
        # but well eventually update this to refer to the function
...
#                         del decorators_to_store[i]
                    # if all of the decorators are removed, we shouldnt treat this as a decorated
                    # function because there arent any decorators to apply
...
#                 self.free_variables.setdefault(self.funcs[-1], set()).add(symbol)
    ...
    pass
                ...
                # before in a parent function, thus its a non-local
                # symbol.
