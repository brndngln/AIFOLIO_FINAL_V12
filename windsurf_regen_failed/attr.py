...
# objects arent created (i.e. many empty per-instance listener collections),
...
#                 f"Cant assign an event directly to the {target} class"
#             )
#         cls: Type[_ET]
...
#         raised an exception.
#         If _exec_w_sync_on_first_run was already called and didnt raise an
