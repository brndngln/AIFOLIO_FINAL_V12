...
#                     break
                ...
                # If none of the aliases match, just use the first one (itll be reported as missing)
#                 name = aliases[0]
...
#                 continue
    ...
    pass
                # authorized missing keys dont have to be loaded
...
#     current_pt_params_dict = dict(pt_model.named_parameters())
    ...
    # TF models always have a prefix, some of PyTorch models (base ones) dont
#     start_prefix_to_remove =
