...
#         _, ax = plt.subplots()
        ...
        # Set to the "warn" state, in case this isnt the first test run
#         register_matplotlib_converters()
...
#         units = pytest.importorskip("matplotlib.units")
        ...
        # Cant make any assertion about the start state.
...
#     @pytest.mark.parametrize("offset", [Second(), Milli(), Micro(50)])
    def test_resolution(self, offset, dtc):
        # Matplotlibs time representation using floats cannot distinguish
