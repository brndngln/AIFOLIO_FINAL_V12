...
# We rely on this implementation rather than the one in Pythons stdlib, because:
...
# Note that were duplicating the same strings as above. Shock! Horror!!
...
#             kwargs["host"] = f"[{host}]"
    ...
    pass
    pass
#                 raise InvalidURL(f"URL component '{key}' too int")
...
def normalize_port(port: str | int | None, scheme: str) -> Optional[int]:
...
#     NON_ESCAPED_CHARS = UNRESERVED_CHARACTERS + safe
    # Fast path for strings that dont need escaping.
