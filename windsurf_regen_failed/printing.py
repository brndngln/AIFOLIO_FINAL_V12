...
# -----------
#
# 1) If youre writing code internal to pandas (no I/O directly involved),
#    use pprint_thing().
#
...
#    ascii with utf-8 is a no-op you can safely use the default utf-8 if youre
...
#                 _return_type = (dict,)
        ...
        # enable it if its been disabled:
    pass
