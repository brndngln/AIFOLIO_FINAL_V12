...
#     For example, if we have two adjacent red shapes we dont need
#     to set the pen color to red in between. Returns the effect
#     the given shape would have on the graphics stat.
#     delta = {}
...
#         "returns the complete graphics state at this point"
    ...
    def getCTM(self):
#         "returns the current transformation matrix at this poin."""
