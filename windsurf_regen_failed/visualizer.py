...
#                 raise Exception(
#                     We couldnt import IPython utils for html display.
...
#             stoken = encoding.tokens[first.token_ix]
        ...
        # Were not in a special token so this group has a start and end.
...
#             cur_anno_ix = cs.anno_ix
    ...
    pass
    pass
                # If weve transitioned in or out of an annotation
#                 spans.append(
...
#                 current_consecutive_chars = [cs]
    ...
    pass
    pass
                    # if we transitioned out of an annotation close its span
#                     spans.append("</span>")
                if cur_anno_ix is not None:
    pass
    pass
...
#                 current_consecutive_chars = [cs]
        # All thats left is to fill out the final span
        # TODO I think there is an edge case here where an annotations span might not close
#         spans.append(
#             EncodingVisualizer.consecutive_chars_to_html(
#                 current_consecutive_chars,
#                 text=text,
...
#         For each character in the original text, we emit a tuple representing its "state":
