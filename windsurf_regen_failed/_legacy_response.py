...
#         Returns the rich python representation of this responses data.
...
#                     body=response.text,
#                 )
            # If the API responds with content that isnt JSON then we just return
...
#                 f.write(data)
#     @deprecated(
#         "Due to a bug, this method doesnt actually stream the response content, `.with_streaming_response.method()` should be used instead"
#     )
    def stream_to_file(
#         self,
#         file: str | os.PathLike[str],
