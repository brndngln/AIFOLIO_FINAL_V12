...
# 	its keys are used for names. If it is an instance, its
...
# 	Convenience function. Same as unpack, except data may be inter
...
#                     bits = before + after
    ...
    pass
    pass
#                         raise Error("fixed point must be 8, 16 or 32 bits int")
