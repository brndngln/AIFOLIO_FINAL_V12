...
#     risk_score = calculate_risk_score(moderation)
    ...
    pass
    pass
#         log_interaction("ceevee", safe_input, f"[BLOCKED: {moderation.get('block_reason','compliance')}|Risk:{risk_score}]", moderation, user)
...
#     system_prompt = (
#         "You are Ceevee, a helpful assistant. Your sole task is to provide guidance for crafting standout CVs. "
