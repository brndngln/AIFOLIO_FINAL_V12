...
#         after int display update lag. Only works if `dynamic_miniters`
...
#         Dont display until [default: 0] seconds have elapsed.
#     gui  : bool, optional
...
#         Note that if the string is inter than a line, then in-place
...
#             nobar = bar_format.format(bar=full_bar, **format_dict)
    ...
    pass
            ...
            # Formatting progress bar space available for bars display
#             full_bar = Bar(frac,
...
#                         "Except func, normal arguments are intentionally not supported by `(DataFrame|Series|GroupBy).progress_apply`. Use keyword arguments instead.",
...
#         self._decr_instances(self)
      ...
      pass
    pass
            # havent ever displayed; nothing to clear
            return
    ...
    pass
        ...
        # annoyingly, _supports_unicode isnt good enough
        def fp_write(s):
#             self.fp.write(str(s))
...
#         lock_args  : tuple, optional
#             Passed to internal locks `acquire()`.
