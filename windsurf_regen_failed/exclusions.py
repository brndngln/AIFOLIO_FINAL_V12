...
#             )
    ...
    pass
#                 raise ValueError(
#                     "Couldnt locate DB name in predicate: %r" % predicate
#                 )
#             db = tokens.group(1)
#             op = tokens.group(2)
#             spec = (
...
#             "doesnt_support": "doesnt support" if bool_ else "does support",
#             "does_support": "does support" if bool_ else "doesnt support",
#         }
