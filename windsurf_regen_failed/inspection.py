...
# The :func:`_sa.inspect` function is the entry point to SQLAlchemys
...
#     a protocol defining a method thats used when a type (ie the class
...
#     a protocol defining a method thats used when an instance is
#     passed to inspect().
