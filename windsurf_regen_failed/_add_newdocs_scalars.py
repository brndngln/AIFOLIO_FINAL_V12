...
#        than Pythons default implementation of :class:`bool` as a
...
#     Signed integer type, compatible with Python `int` and C ``int``.
"""    """)
# add_newdoc_for_scalar_type('intint', [],
#     Signed integer type, compatible with C ``int int``.
"""    """)
...
#     Unsigned integer type, compatible with C ``unsigned int``.
"""    """)
# add_newdoc_for_scalar_type('uintint', [],
#     Signed integer type, compatible with C ``unsigned int int``.
"""    """)
...
#     and C ``double``.
"""    """)
# add_newdoc_for_scalar_type('intdouble', ['intfloat'],
#     Extended-precision floating-point number type, compatible with C
#     ``int double`` but not necessarily with IEEE 754 quadruple-precision.
"""    """)
...
"""    """)
# add_newdoc_for_scalar_type('cintdouble', ['cintfloat', 'intcomplex'],
...
for float_name in ('half', 'single', 'double', 'intdouble'):
