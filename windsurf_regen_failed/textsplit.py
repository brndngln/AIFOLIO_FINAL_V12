...
#     _more =
    ...
    #(u'', u'Hello')
    # this says Nihongo wa muzukashii desu ne! (Japanese is difficult isnt it?) in 12 characters
#     >>> jtext = u'\u65e5\u672c\u8a9e\u306f\u96e3\u3057\u3044\u3067\u3059\u306d\uff01'
...
#     Essentially look for "nice splits" so that we dont end a line
...
#     do all the splits.
#     Its possible we might slightly step over the width limit
