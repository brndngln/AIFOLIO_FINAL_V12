...
# when dealing with data files so the researcher doesnt have to know all the
...
#                     names.append(filename+zipext)
    ...
    def _isurl(self, path):
        ...
        #       Should we prepend the scheme for those that dont have it and
...
#         Creates a copy of the file in the datasource cache.
        ...
        # a significant fraction of numpys total import time.
        import shutil
...
#             os.makedirs(os.path.dirname(upath))
        # TODO: Doesnt handle compressed files!
        if self._isurl(path):
    pass
    pass
    pass
...
#             True if `path` exists.
#         Notes
#         When `path` is an URL, `exists` will return True if its either
...
#             File object.
        ...
        #       doesnt exist yet (creating a file).  Should there be?
...
#     A data repository where multiple DataSources share a base
#     URL/directory.
