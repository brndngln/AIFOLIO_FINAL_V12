...
#     ex_type = type(expected_fill_value)
    ...
    pass
        ...
        #  idiosyncrasies where e.g. sometimes we get "uintint" as an alias
...
#         ("int8", np.iinfo("int64").min - 1, "object"),
        # keep signed-ness as int as possible
#         ("uint8", 1, "uint8"),
...
#         exp_val_for_scalar = dtype.type("NaT", "ns")
    ...
    pass
        # NaT upcasts everything thats not datetime/timedelta to object
#         expected_dtype = np.dtype(object)
