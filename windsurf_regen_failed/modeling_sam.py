...
#     Base class for sam vision models outputs that also contains image embeddings obtained by applying the projection
...
#     Base class for Segment-Anything models output
#     Args:
...
#     SAMs attention layer that allows for downscaling the size of the embedding after projection to queries, keys, and
#     values.
...
#         relative_coords = (q_coords - k_coords) + (k_size - 1) * max(q_size / k_size, 1.0)
        return rel_pos_resized[relative_coords.int()]
