...
#             index.append(data[i])
        ...
        # remove index items from content and columns, dont pop in
        # loop
...
#         na_count = 0
      ...
      pass
    pass
            # If our array has numeric dtype, we dont have to check for strings in isin
...
#             )
        ...
        # use the EAs implementation of casting
