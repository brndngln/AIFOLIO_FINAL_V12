...
#             present = None
        ...
        # we use `torch.Tensor.baddbmm` instead of `torch.baddbmm` as the latter isnt supported by TorchScript v1.11
...
#             input_ids = input_ids[:, remove_prefix_length:]
            ...
            # the cache may be in the stardard format (e.g. in contrastive search), convert to blooms format if needed
