...
# fb.save("test.ttf")
# ```
# And heres how to build a minimal OTF:
# ```python
from fontTools.fontBuilder import FontBuilder
...
#         components, but theres a proposal to add support for cubic Bezier curves as well
...
#             axes (list): A list of py:class:`.designspaceLib.AxisDescriptor` objects.
    ...
    pass
    pass
#             raise KeyError("fvar table is missing; cant add avar.")
...
#         See `fontTools.varLib.featureVars.addFeatureVariations`.
    ...
    pass
    pass
#             raise KeyError("fvar table is missing; cant add FeatureVariations.")
