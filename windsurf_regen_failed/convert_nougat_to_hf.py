...
# https://github.com/facebookresearch/nougat/tree/mai.
import argparse
import torch
...
#                 ] = val[-dim:]
    ...
    pass
            # HuggingFace implementation doesnt use attn_mask buffer
            # and model doesnt use final LayerNorms for the encoder
#             pass
        else:
...
#         do_align_int_axis=original_model.config.align_int_axis,
#         size=size,
#     )
...
#         help="Tag of the original model youd like to convert.",
#     )
#     parser.add_argument(
