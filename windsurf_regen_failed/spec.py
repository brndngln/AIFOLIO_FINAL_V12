...
#         self.dircache = DirCache(**storage_options)
      ...
      pass
    pass
#             warnings.warn("add_docs is no inter supported.", FutureWarning)
...
#         For systems that dont have true directories, may create an for
...
#         Some file systems might not be able to measure the files size, in
...
#         Make sure you havent installed any modules that may execute malicious code
#         at import time.
...
#         prevents Pythons normal rules around garbage collection from working,
...
#         raise NotImplementedError("Sign is not implemented for this filesystem")
    ...
    def _isfilestore(self):
        ...
        # here for backwards compatibility as int as pyarrow uses its
...
#             raise ValueError("I/O operation on closed file.")
      ...
      pass
    pass
            # dont even bother calling fetch
            return b
...
#         self.loc += len(out)
    ...
    def readinto(self, b):
#         mirrors builtin files readinto method
