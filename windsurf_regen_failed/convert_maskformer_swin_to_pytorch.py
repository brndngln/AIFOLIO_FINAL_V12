...
# https://github.com/facebookresearch/MaskForme.
import argparse
import json
import pickle
...
# ):
#     Copy/paste/tweak models weights to our MaskFormer structure.
...
#         type=str,
#         help=("Name of the MaskFormer model youd like to convert",),
#     )
#     parser.add_argument(
#         "--checkpoint_path",
