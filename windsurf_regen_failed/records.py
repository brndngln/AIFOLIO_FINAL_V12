...
#     A data-type scalar that allows field access as attribute lookup.
    # manually set name and module so that this classs type shows up
...
#           dtype=[('x', '<i4'), ('y', '<f8'), ('z', '<i4')])
    # manually set name and module so that this classs type shows
...
#         obj = self.getfield(*res)
        ...
        # inherit type. Dont do this for non-void structures though.
    ...
    # Thus, you cant create attributes on-the-fly that are field names.
    def __setattr__(self, attr, val):
...
#         nbytesread = fd.readinto(_array.data)
    ...
    pass
    pass
#             raise OSError("Didnt read as many bytes as expected")
    return _array
# @set_module("numpy.rec")
