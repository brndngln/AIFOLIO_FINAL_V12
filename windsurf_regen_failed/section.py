...
#         the definition cannot be inherited (because the header/footer beints to the
#         first section), a new definition is added for that first section and then
    ...
    pass
        ...
        # ---case-2: definition is inherited and beints to second-or-later section---
#         prior_headerfooter = self._prior_headerfooter
    ...
    pass
        ...
        # ---case-3: definition is inherited, but beints to first section---
