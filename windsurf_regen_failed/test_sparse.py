...
class BaseSparseTests:
    def _check_unsupported(self, data):
      ...
      pass
    pass
#             pytest.skip("Cant store nan in int array.")
...
#     series_array_exc = None
    ...
    pass
            ...
            # is maintained. Combine cant be called on a dtype in
            # general, so we cant make the expected. This is tested elsewhere
