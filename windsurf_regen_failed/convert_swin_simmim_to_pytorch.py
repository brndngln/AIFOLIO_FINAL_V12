...
# URL: https://github.com/microsoft/Swin-Transformer/blob/main/MODELHUB.md#simmim-pretrained-swin-v1-model.
import argparse
import requests
import torch
...
#         help="Name of the Swin SimMIM model youd like to convert.",
#     )
#     parser.add_argument(
#         "--checkpoint_path",
