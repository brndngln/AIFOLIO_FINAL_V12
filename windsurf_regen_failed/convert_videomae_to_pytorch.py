...
#             raise ValueError("Model name should either contain kinetics or ssv2 in case its fine-tuned.")
...
#         type=str,
#         help=(
#             "URL of the original PyTorch checkpoint (on Google Drive) youd like to convert. Should be a direct"
#             " download link."
#         ),
#     )
#     parser.add_argument(
