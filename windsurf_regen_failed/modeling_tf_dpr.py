...
#         self.config = config
    ...
    pass
    pass
#             raise ValueError("Encoder hidden_size cant be zero")
...
#             ```
#             DPR is a model with absolute position embeddings so its usually advised to pad the inputs on the right
