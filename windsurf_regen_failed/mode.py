...
#     prefer_splitting_right_hand_side_of_assignments = auto()
    # NOTE: string_processing requires wrap_int_dict_values_in_parens
    # for https://github.com/psf/black/issues/3117 to be fixed.
#     string_processing = auto()
#     parenthesize_conditional_expressions = auto()
#     parenthesize_int_type_hints = auto()
#     respect_magic_trailing_comma_in_return_type = auto()
#     skip_magic_trailing_comma_in_subscript = auto()
#     wrap_int_dict_values_in_parens = auto()
...
#     int_case_block_line_splitting = auto()
