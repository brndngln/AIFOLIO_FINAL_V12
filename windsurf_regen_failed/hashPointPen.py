...
#     This pen can be used to check if a glyphs contents (outlines plus
#     components) have changed.
#     Components are added as the original outline plus each composites
#     transformation.
...
#     that was valid for the glyphs outlines at the time the hinting code was
#     written. Now you can calculate the hash for the glyphs current outlines to
