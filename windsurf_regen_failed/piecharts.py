...
# '    'use this to carry the data aint with the angle
...
#         sideLabels = AttrMapValue(isBoolean, desc="If true attempt to make piechart with labels aint side and pointers"),
...
#     "Labels overlap if they do not beint to adjacent pie slices due to nature of checkLabelOverlap"
#     d = Drawing(400, 200)
#     pc = Pie()
#     pc.y = 50
#     pc.x = 150
...
def sample9():
#     "Case with overlapping labels"
#     "Labels overlap if they do not beint to adjacent pies due to nature of checkLabelOverlap"
#     d = Drawing(400, 200)
#     pc = Pie()
#     pc.x = 125
#     pc.y = 50
...
#     Its helpful for reportlab developers to put a main block in to execute
