...
#     reason of keeping its hash value current.  When GCed, the
...
#         clone = self.__element._clone(**kw)
    ...
    pass
    pass
            # detect immutable, dont change anything
            return self
        else:
            # update the clone with any changes that have occurred
            # to this objects __dict__.
...
#         _annotate = to_annotate._annotate
        ...
        # skip objects that dont actually have an `_annotate`
...
#     cloned_ids: Dict[int, SupportsAnnotations] = {}
    def clone(elem: SupportsAnnotations, **kw: Any) -> SupportsAnnotations:
        ...
        # a reference cycle that its otherwise prone to building,
