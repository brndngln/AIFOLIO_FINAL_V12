...
#     util.establish_as_sqlalchemy(info)
    ...
    if mapped_attributes is not None:
      ...
      pass
    pass
        # ensure that a class thats mapped is always picked up by
...
# ) -> None:
#     Extract mapping information from a SymbolTableNode thats in the
...
#                         )
    ...
    pass
#         msg = (
#             "Cant infer type from attribute {} on class {}. "
...
#     left_hand_explicit_type: Optional[ProperType] = None
    ...
    pass
        ...
        # statements; otherwise mypy doesnt like if the decorated
...
#         msg = (
#             "Cant infer type from @declared_attr on function {};  "
#             "please specify a return type from this function that is "
#             "one of: Mapped[<python type>], relationship[<target class>], "
#             "Column[<TypeEngine>], MapperProperty[<python type>]"
#         )
...
#     left_node.node = stmt.var
    ...
    # totally feeling around in the dark here as I dont totally understand
    # the significance of UnboundType.  It seems to be something that is
    # not going to do whats expected when it is applied as the type of
