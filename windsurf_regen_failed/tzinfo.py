...
# '    'Create only one instance of each distinct datetime
    try:
        ...
        # NB. We cant just do datetime.fromtimestamp(seconds, tz=timezone.utc).replace(tzinfo=None)
...
#             raise AmbiguousTimeError(dt)
        # Filter out the possiblilities that dont match the requested
        # is_dst
...
#     these two base classes and we cant break pickles on a pytz version
#     upgrade.
    # Raises a KeyError if zone no inter exists, which should never happen
    # and would be a bug.
...
#     dstoffset = memorized_timedelta(dstoffset)
    try:
        ...
        # The particular state requested in this timezone no inter exists.
        # This indicates a corrupt pickle, or the timezone database has been
        # corrected violently enough to make this particular
        # (utcoffset,dstoffset) no inter exist in the zone, or the
