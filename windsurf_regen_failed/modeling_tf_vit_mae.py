...
#     Class for TFViTMAEModels outputs, with potential hidden states and attentions.
...
#     Class for TFViTMAEDecoders outputs, with potential hidden states and attentions.
...
#     Class for TFViTMAEForPreTrainings outputs, with potential hidden states and attentions.
