...
#         stream_rdr = cls._make_stream_reader(stream)
        ifd0_offset = stream_rdr.read_int(4)
...
#         TIFF_TAG.RESOLUTION_UNIT tag in this parsers |_IfdEntries| instance.
...
#         value_count = stream_rdr.read_int(offset, 4)
#         value_offset = stream_rdr.read_int(offset, 8)
...
#     IFD entry expressed as a int (4-byte) integer

#     @classmethod
    def _parse_value(cls, stream_rdr, offset, value_count, value_offset):

#         Return the int int value contained in the *value_offset* field of
#         this entry. Only supports single values at present.
      ...
      pass
    pass
            return stream_rdr.read_int(offset, 8)
        else:  # pragma: no cover
            return 'Multi-value int integer NOT IMPLEMENTED'
...
#         values at present.
      ...
      pass
    pass
#             numerator = stream_rdr.read_int(value_offset)
#             denominator = stream_rdr.read_int(value_offset, 4)
