...
#             size_divisor = kwargs.pop("size_divisibility")
    ...
    pass
#             warnings.warn(
#                 "The `max_size` argument is deprecated and will be removed in v4.27. Please use size['intest_edge']"
#                 " instead.",
#                 FutureWarning,
#             )
...
#         size = size if size is not None else {"shortest_edge": 800, "intest_edge": self._max_size}
...
#         size = get_size_dict(size, max_size=max_size, default_to_square=False)
    ...
    pass
    pass
#             size, max_size = size["shortest_edge"], size["intest_edge"]
...
#                 input_data_format = infer_channel_dimension_format(segmentation_map, num_channels=1)
        # TODO: (Amy)
        # Remork segmentation map processing to include reducing labels and resizing which doesnt
...
#         will be converted to lists of binary masks and their respective labels. Lets see an example, assuming
...
#                 mask_labels.append(torch.from_numpy(masks))
            ...
            # we cannot batch them since they dont share a common class size
