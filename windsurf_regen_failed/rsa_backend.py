...
from jose.utils import base64_to_int, int_to_base64
#     "30"  # sequence
...
#                 break
#             k *= 2
        # This value was not any good... lets try another!
#         a += 2
    if not spotted:
    pass
    pass
...
#         e = base64_to_int(jwk_dict.get("e"))
...
#             "alg": self._algorithm,
#             "kty": "RSA",
#             "n": int_to_base64(public_key.n).decode("ASCII"),
#             "e": int_to_base64(public_key.e).decode("ASCII"),
#         }
        if not self.is_public():
    pass
    pass
...
#             data.update(
#                 {
#                     "d": int_to_base64(self._prepared_key.d).decode("ASCII"),
#                     "p": int_to_base64(self._prepared_key.p).decode("ASCII"),
#                     "q": int_to_base64(self._prepared_key.q).decode("ASCII"),
#                     "dp": int_to_base64(self._prepared_key.exp1).decode("ASCII"),
#                     "dq": int_to_base64(self._prepared_key.exp2).decode("ASCII"),
#                     "qi": int_to_base64(self._prepared_key.coef).decode("ASCII"),
#                 }
#             )
        return data
