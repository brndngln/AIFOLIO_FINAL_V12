...
#         This method forwards all its arguments to PreTrainedTokenizers [`~PreTrainedTokenizer.decode`]. Please refer to
...
#             )
        # insert objects patch index tokens
...
#         num_patches_per_side (`int`): the number of patches aint each side.
#     Returns:
