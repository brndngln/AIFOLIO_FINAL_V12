...
def _guess_content_type(filename: str | None) -> Optional[str]:
...
# ) -> Optional[bytes]:
    ...
    pass
      ...
      pass
    pass
                return section.strip()[len(bboundary=) :].strip(b'')
    return None
...
#         file_length = peek_filelike_length(self.file)
        ...
        # If we cant determine the filesize without reading it into memory,
