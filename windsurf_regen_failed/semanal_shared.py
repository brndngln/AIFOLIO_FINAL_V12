...
#     we dont prevent their existence).
...
def find_dataclass_transform_spec(node: Node | None) -> Optional[DataclassTransformSpec]:
...
#         node = node.info
    ...
    pass
        ...
        #
        # The wording doesnt make this entirely explicit, but Pyright (the reference
