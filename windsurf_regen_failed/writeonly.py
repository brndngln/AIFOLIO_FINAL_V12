...
#                     f"Attribute {attr} cant load the existing state from the "
...
#     ) -> NoReturn:
#         raise NotImplementedError(
#             "Dynamic attributes dont support collection population."
#         )
    def get_history(
#         self,
#         state: InstanceState[Any],
...
#         prop = mapper._props[self.attr.key]
    ...
    pass
            ...
            # doesnt fail, and secondary is then in _from_obj[1].
...
#         raise TypeError(
#             "WriteOnly collections dont support iteration in-place; "
...
#         the parent instances collection on the next flush.
...
#         The given item will be removed from the parent instances collection on
#         the next flush.
