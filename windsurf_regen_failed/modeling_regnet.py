...
#     RegNets layer composed by three `3x3` convolutions, same as a ResNet bottleneck layer with reduction = 1.
...
#     RegNets Y layer: an X layer with Squeeze and Excitation.
    def __init__(self, config: RegNetConfig, in_channels: int, out_channels: int, stride: int = 1):
#         super().__init__()
#         should_apply_shortcut = in_channels != out_channels or stride != 1
#         groups = max(1, out_channels // config.groups_width)
