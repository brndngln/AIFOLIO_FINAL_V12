...
# Depending on users setup, SummaryWriter can come either from tensorboardX
# or from torch.utils.tensorboard. Both are compatible so lets try to load
# from either of them.
try:
...
#     Wrapper around the tensorboards `SummaryWriter` to push training logs to the Hub.
