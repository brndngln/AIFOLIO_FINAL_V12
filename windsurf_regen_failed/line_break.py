...
#         length -= len(hyphenation_character.encode())
    ...
    pass
        # Set an infinite width as we dont want to break lines when drawing,
...
#         index = text.find('\n')
    ...
    pass
    pass
            # Keep only the first line plus one character, we dont need more
#             text = text[:index+2]
#         self.text = text
...
#     short_text = text
    ...
    pass
    pass
            # Trying to find minimum or very small size, lets naively split on
...
#                 short_text = text[:space_index+2]  # index + space + one letter
            ...
            # Use the magic ration and hope that well get the right amount of text.
...
#         second_line_text = encoded_text[resume_index:].decode()
        ...
        # The line cant be split earlier, try to hyphenate the first word.
#         first_line_text = ''
...
#         break_point = None
        ...
        # Find then second lines first break point.
...
#                 break
    ...
    pass
            ...
            # we dont break before or inside the hyphenate character
#             hyphenated = True
...
#                 resume_index += len(soft_hyphen.encode())
    ...
    pass
        # Recreate the layout with no max_width to be sure that
        # we dont break inside the hyphenate-character string
#         hyphenated = True
#         hyphenated_first_line_text = (
...
#         resume_index = len(first_line_text.encode())
    # Step 5: Try to break word if its too int for the line
#     overflow_wrap = style['overflow_wrap']
#     first_line_width, _ = line_size(first_line, style)
#     space = max_width - first_line_width
    # If we can break words and the first line is too int
#     can_break = (
