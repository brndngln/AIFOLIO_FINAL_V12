...
# sufficient, and we dont have to do anything here.  This table
...
#                     continue
      ...
      pass
    pass
#                     pass  # Dont complain about `x_blah` flags
...
#                 print(f"{prefix}Dont know what type {key} should have", file=stderr)
#                 continue
