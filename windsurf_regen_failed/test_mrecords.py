...
#         assert_equal(mbase_first.tolist(), (1, 1.1, b'one'))
        # Used to be mask, now its recordmask
...
#         assert_equal(ma.getmaskarray(mbase['a']), [0]*5)
        # Use to be _mask, now its recordmask
...
#                               dtype=bool))
        # Set a field to mask ........................
#         mbase.c = masked
        # Use to be mask, and now its still mask !
...
#         mbase.mask = nomask
        # So, the mask of a field is no inter set to nomask...
