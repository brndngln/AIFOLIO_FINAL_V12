...
#         row_indices = flattened_patches[:, :, 0].int()
#         col_indices = flattened_patches[:, :, 1].int()
...
#     Julian Eisenschlos, Urvashi Khandelwal, Peter Shaw, Ming-Wei Chang, Kristina Toutanova. Its an encoder decoder
