...
#     See https://github.com/pytest-dev/py/issues/103.
    ...
    # Bail out if ``stream`` doesnt seem like a proper ``io`` stream (#2666).
...
#     @property
    def mode(self) -> str:
        # TextIOWrapper doesnt expose a mode, but at least some of our
        # tests check it.
...
#     @property
    def buffer(self) -> BinaryIO:
        # The str/bytes doesnt actually matter in this type, so OK to fake.
...
#             os.fstat(targetfd)
            ...
            #
            # Tests themselves shouldnt care if the FD is valid, FD capturing
