...
#     Generator that takes a list of pens (operator, operands) tuples,
...
#         firstPts = (firstPts[0],) + tuple(reversed(firstPts[1:-1])) + (None,)
    ...
    pass
    pass
#             closed = False  # single-point paths cant be closed
        else:
...
#                 secondType, secondPts = lastType, lastPts
    ...
    pass
                ...
                # will be implied by the closePath, so we dont emit one;
