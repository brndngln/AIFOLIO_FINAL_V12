...
#     )
    def test_dti_cmp_tdi_tzawareness(self, other):
        # GH#22074
        # reversion test that we _dont_ call _assert_tzawareness_compat
...
#     ):
        # GH#22005, GH#22163 check DataFrame doesnt raise TypeError
#         tz = tz_naive_fixture
...
#             dt64vals - dtarr
    ...
    def test_dt64arr_add_dtlike_raises(self, tz_naive_fixture, box_with_array):
        # GH#22163 ensure DataFrame doesnt cast Timestamp to i8
        # GH#9631
#         tz = tz_naive_fixture
...
#         )
        ...
        # we arent testing that here, so ignore.
...
#         ser - offset_cls(5)
    ...
    def test_dti_add_tick_tzaware(self, tz_aware_fixture, box_with_array):
        # GH#21610, GH#22163 ensure DataFrame doesnt return object-dtype
#         tz = tz_aware_fixture
        if tz == "US/Pacific":
      pass
      pass
...
#             tdi._values -= dti
    ...
    # TODO: A couple other tests beint in this section.  Move them in
    # A PR where there isnt already a giant diff.
...
#         expected = Series(index + Timedelta(seconds=5), index=index, name=names[2])
        ...
        # passing name arg isnt enough when names[2] is None
