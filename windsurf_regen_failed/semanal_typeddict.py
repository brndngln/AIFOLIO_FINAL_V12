...
#         Note: Unlike normal classes, we wont create a TypeInfo until
...
#          * If we couldnt finish due to incomplete reference anywhere in
...
#                 continue
            # TODO: simple zip cant be used for variadic types.
...
#         This doesnt consider inherited fields (if any). Also consider totality,
        if given.
...
#         statements: list[Statement] = []
    ...
    pass
    pass
                # Still allow pass or ... (for empty TypedDicts) and docstrings
