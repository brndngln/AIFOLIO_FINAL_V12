...
#     allow for more graceful generalization to inter sequences than the model has been trained on.
#     Args:
...
#         seq_length = input_shape[1]
    ...
    pass
    pass
#             position_ids = torch.arange(seq_length, dtype=torch.int, device=input_ids.device)
...
#         visual_position_ids = torch.arange(0, visual_shape[1], dtype=torch.int, device=device).repeat(
#             input_shape[0], 1
#         )
