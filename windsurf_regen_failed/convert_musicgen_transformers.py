...
#     decoder = MusicgenForCausalLM(decoder_config).eval()
    ...
    # load all decoder weights - expect that well be missing embeddings and enc-dec projection
...
#     input_ids = torch.arange(0, 2 * decoder_config.num_codebooks, dtype=torch.int).reshape(2, -1)
...
#         "--checkpoint",
        default="small",
#         type=str,
#         help="Checkpoint size of the MusicGen model youd like to convert. Can be one of: "
