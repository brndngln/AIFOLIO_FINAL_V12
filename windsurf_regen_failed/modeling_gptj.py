...
#             value = torch.cat((past_value, value), dim=-2)
    ...
    pass
    pass
            # Note that this cast is quite ugly, but is not implemented before ROPE as the original codebase keeps the key in float32 all aint the computation.
...
#     This is an experimental feature and is a subject to change at a moments notice. Uses a device map to distribute
