...
#             Whether to resize the images (height, width) dimensions to `(size["height"], size["width"])`. Can be
...
#             Whether to rescale the images pixel values by the specified `rescale_value`. Can be overridden by
#             `do_rescale` in `preprocess`.
#         rescale_factor (`float`, *optional*, defaults to 1 / 255):
#             Value by which the images pixel values are rescaled. Can be overridden by `rescale_factor` in
#             `preprocess`.
