...
if __name__ == "__main__":
      ...
      pass
    pass
    # HACK: We dont want to pick up mypy.types as the top-level types
...
#     excludes = {stdlib_zip, stdlib, stdlib_ext}
    ...
    # Python 3.11 adds a "safe_path" flag wherein Python wont automatically prepend
    # anything to sys.path. In this case, the first entry of sys.path is no inter special.
