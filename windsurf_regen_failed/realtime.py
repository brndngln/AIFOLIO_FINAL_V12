...
#         An alternative to `.with_raw_response` that doesnt eagerly read the response body.
...
#         Canceling this method is safe. Theres no risk of losing data.
...
#         This is helpful if youre using `.recv_bytes()`.
...
#     Note that if your application doesnt work well with the context manager approach then you
...
#         👋 If your application doesnt work well with the context manager approach then you
...
#         `instructions`, and `temperature`. These fields will override the Sessions
...
#         Add a new Item to the Conversations context, including messages, function
...
#         yet played. This will synchronize the servers understanding of the audio with
#         the clients playback.

#         Truncating audio will delete the server-side text transcript to ensure there
#         is not text in the context that hasnt been heard by the user.
...
#         Send this event when you want to retrieve the servers representation of a specific item in the conversation history. This is useful, for example, to inspect user audio after noise cancellation and VAD.
