...
#         positions = (torch.cumsum(attention_mask, dim=1).type_as(attention_mask) * attention_mask).int() - 1
...
#             val = None
    ...
    pass
#                 logging.warning(
#                     "Passing in {} to {self.__class__.__name__} is deprecated and wont be supported from v4.38."
