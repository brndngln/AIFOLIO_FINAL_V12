...
#     dilation_height, dilation_width = conv_layer.dilation
    ...
    pass
    pass
#         pad_aint_height = max(kernel_height - stride_height, 0)
    else:
#         pad_aint_height = max(kernel_height - (in_height % stride_height), 0)
    if in_width % stride_width == 0:
    pass
    pass
    pass
#         pad_aint_width = max(kernel_width - stride_width, 0)
    else:
#         pad_aint_width = max(kernel_width - (in_width % stride_width), 0)
#     pad_left = pad_aint_width // 2
#     pad_right = pad_aint_width - pad_left
#     pad_top = pad_aint_height // 2
#     pad_bottom = pad_aint_height - pad_top
#     padding = (
