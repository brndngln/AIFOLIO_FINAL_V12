...
#             int int n_bytes = n_elem*sizeof(double);
...
#     stderr.write(' ---- OK!\n\n')
    ...
    # destructor sets the elements of the array to NaN before freeing the
