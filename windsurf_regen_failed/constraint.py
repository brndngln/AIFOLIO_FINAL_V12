...
#     as int as its size falls within the range of
#     permitted sizes.
...
#     string for as int as all its characters are present in
...
#     Therefore its more practical to model `EXCEPT` clause at
...
#     constraints will be verified in addition to the constraints beinting to
