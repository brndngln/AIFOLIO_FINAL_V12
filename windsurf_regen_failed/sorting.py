...
#     combinations, *as int as* this space fits within int64 bounds;
#     otherwise, though group indices identify unique combinations of
#     labels, they cannot be deconstructed.
#     - If `sort`, rank of returned ids preserve lexical ranks of labels.
#       i.e. returned ids can be used to do lexical sort on labels;
...
#         raise TypeError(
#             fUser-provided `key` function returned an invalid type {type(result)} \
