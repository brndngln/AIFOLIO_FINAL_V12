...
#                 (likely to push/pop type_lookup_funcs scope)
#             type_lookup_func:
...
#     bad_octal_constant = '0[0-7]*[89]'
    ...
    #
    # Without this change, pythons `re` module would recursively try parsing each ambiguous escape sequence in multiple ways.
...
#             self.pp_line = t.value
            ...
            # Ignore: GCCs cpp sometimes inserts a numeric flag
            # after the file name
#             pass
