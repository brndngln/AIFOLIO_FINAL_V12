...
#         assert_framelist_equal(df1, df2)
    ...
    def test_skiprows_slice_int(self, spam_data):
...
#             <td width="50%">
#             <p class="biglink"><a class="biglink" href="whatsnew/2.7.html">Whats new in Python 2.7?</a><br/>
#                 <span class="linkdescr">or <a href="whatsnew/index.html">all "Whats new" documents</a> since 2.0</span></p>
...
#         Dont fail with bs4 when there is a header and only one column
