...
#     Construct a "Fast" BPE tokenizer for HerBERT (backed by HuggingFaces *tokenizers* library).

#     Peculiarities:

#     - uses BERTs pre-tokenizer: BertPreTokenizer splits tokens on spaces, and also on punctuation. Each occurrence of
