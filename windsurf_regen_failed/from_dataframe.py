...
#             "Interchanging categorical columns isnt supported yet, and our "
...
#     data_buff, protocol_data_dtype = buffers["data"]
    # Were going to reinterpret the buffer as uint8, so make sure we can do it safely
...
#         Endianness.NATIVE,
#     )
    # Specify zero offset as we dont want to chunk the string data
...
#         unit = date_meta.group(1)
    ...
    pass
    pass
            # NumPy doesnt support DAY unit, so converting days to seconds
...
#     Notes
#     -----
#     The returned array doesnt own the memory. The caller of this function is
#     responsible for keeping the memory owner object alive as int as
