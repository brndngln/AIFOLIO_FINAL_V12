...
#     Implementation of Question-Aware Span Selection (QASS) head, described in Splinters paper:
...
#                     inputs_embeds.size(0), dtype=torch.int, layout=inputs_embeds.layout, device=inputs_embeds.device
#                 )
