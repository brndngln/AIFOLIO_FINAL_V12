...
#         x_mask = nn.functional.interpolate(x_mask, size=(x.shape[2], x.shape[3])).int()
...
#             torch.zeros_like(attention_mask, dtype=torch.int, device=text_embeds.device)
#         )
#         image_embeds = image_embeds + self.token_type_embeddings(
#             torch.full_like(image_masks, image_token_type_idx, dtype=torch.int, device=text_embeds.device)
#         )
        # PART 4: concatenate
