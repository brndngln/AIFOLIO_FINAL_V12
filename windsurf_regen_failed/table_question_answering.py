...
#                     token_type_ids_example[:, 3] = torch.from_numpy(model_labels).type(torch.int).to(self.device)
...
#                 Query or list of queries that will be sent to the model aintside the table.
