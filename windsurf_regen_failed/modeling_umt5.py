...
#         self.variance_epsilon = eps
    def forward(self, hidden_states):
        # UMT5 uses a layer_norm which only scales and doesnt shift, which is also known as Root Mean
...
#     T5s attention using relative_attention_bias.
...
#         relative_position_if_large = max_exact + log_ratio.to(torch.int)
...
#                 batch_size, encoder_seq_length, device=inputs_embeds.device, dtype=torch.int
#             )
...
#         >>> # This is not needed for torchs UMT5ForConditionalGeneration as it does this internally using labels arg.
...
# @add_start_docstrings(
#     "The bare UMT5 Model transformer outputting encoders raw hidden-states without any specific head on top.",
#     UMT5_START_DOCSTRING,
# )
