...
#         )
        # Dont process unnecessary holidays
#         dates = date_range(
...
#         end = Timestamp(end)
        # If we dont have a cache or the dates are outside the prior cache, we
        # get them again
...
#         Merge holiday calendars together.  The callers class
