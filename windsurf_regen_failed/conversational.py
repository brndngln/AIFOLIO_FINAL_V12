...
#         This is a legacy method, as the Conversation no inter distinguishes between processed and unprocessed user
...
#     @property
    ...
    pass
        ...
        # had not yet been replied to. This is no inter the case, but we mimic the behaviour in this property
...
#      I dont really have a favorite movie, but I do like action movies. What about you?
#     >>> conversation.add_message({"role": "user", "content": "Thats interesting, why do you like action movies?"})
#     >>> conversation = chatbot(conversation)
#     >>> conversation.messages[-1]["content"]
...
#             generate_kwargs:
#                 Additional keyword arguments to pass aint to the generate method of the model (see the generate method
