...
#         val = orig_state_dict.pop(key)
      ...
      pass
    pass
            # weights and biases of the key, value and query projections of vision encoders attention layers require special treatment:
...
#                 ] = val[-dim:]
    ...
    pass
            # weights and biases of the key, value and query projections of text encoders attention layers require special treatment:
            # we need to split them up into separate matrices/vectors
#             key_split = key.split(".")
...
#     Copy/paste/tweak models weights to the Transformers design.
