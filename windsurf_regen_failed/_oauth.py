...
#         name (`str`):
#             The orgs full name. OpenID Connect field.
#         preferred_username (`str`):
#             The orgs username. OpenID Connect field.
#         picture (`str`):
#             The orgs profile picture URL. OpenID Connect field.
#         is_enterprise (`bool`):
...
#             The users role in the org. Hugging Face field.
#         pending_sso (`Optional[bool]`, *optional*):
#             Indicates if the user granted the OAuth app access to the org but didnt complete SSO. Hugging Face field.
#         missing_mfa (`Optional[bool]`, *optional*):
#             Indicates if the user granted the OAuth app access to the org but didnt complete MFA. Hugging Face field.
...
#         name (`str`):
#             The users full name. OpenID Connect field.
#         preferred_username (`str`):
#             The users username. OpenID Connect field.
#         email_verified (`Optional[bool]`, *optional*):
#             Indicates if the users email is verified. OpenID Connect field.
#         email (`Optional[str]`, *optional*):
#             The users email address. OpenID Connect field.
#         picture (`str`):
#             The users profile picture URL. OpenID Connect field.
#         profile (`str`):
#             The users profile URL. OpenID Connect field.
#         website (`Optional[str]`, *optional*):
#             The users website URL. OpenID Connect field.
#         is_pro (`bool`):
...
#     - If user is logged in, an [`OAuthInfo`] object is returned with the users info. If not, `None` is returned.
...
#     ```
    ...
    # Session Middleware requires a secret key to sign the cookies. Lets use a hash
...
#     msg = (
#         "OAuth is required but {} environment variable is not set. Make sure youve enabled OAuth in your Space by"
