...
#     Inserts a system (or developer) message as the first item in the models
#     context.
#     When using aint with `previous_response_id`, the instructions from a previous
...
#     - **Built-in tools**: Tools that are provided by OpenAI that extend the models
#       capabilities, like
...
#     - `auto`: If the context of this response and previous ones exceeds the models
