...
#         self.styleName = None
#         self.isBold = False   #true if its somehow bold
#         self.isItalic = False #true if its italic or oblique or somehow slanty
...
#                     pass  #pickle load failed.  Ho hum, maybe its an old pickle.  Better rebuild it.
        for dirName in self._dirs:
            try:
...
#                     f.typeCode = ext  #strip the dot
                    ...
                    #have .afm to go with it, and dont handle .otf now.
                    if ext in ('otf', 'pfa'):
    pass
    pass
    pass
