...
#     The protocol dependencies however are only stored here, and shouldnt be deleted unless
...
#     _negative_subtype_caches: Final[SubtypeCache]
    ...
    # A blocking error will be generated in this case, since we cant proceed safely.
...
#     proto_deps: dict[str, set[str]] | None
    ...
    # wed have a.A -> {p.P, ...} in the map. This map is flushed after every incremental
    # update.
#     _attempted_protocols: Final[dict[str, set[str]]]
    ...
    # a value of type a.A to a function expecting something compatible with Iterable, wed have
...
#                     continue
                ...
                #
                # Note: strictly speaking, the protocol doesnt need to be
