...
#         Generate a |_Chunk| subclass instance for each chunk in this parsers
...
#         chunk_offset = 8
        while True:
#             chunk_data_len = self._stream_rdr.read_int(chunk_offset)
...
#             yield chunk_type, data_offset
    ...
    pass
#                 break
            # incr offset for chunk len int, chunk type, chunk data, and CRC
...
#         px_width = stream_rdr.read_int(offset)
#         px_height = stream_rdr.read_int(offset, 4)
...
#         horz_px_per_unit = stream_rdr.read_int(offset)
#         vert_px_per_unit = stream_rdr.read_int(offset, 4)
