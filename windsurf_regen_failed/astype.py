...
#         raise ValueError(msg)
    ...
    if copy or arr.dtype == object or dtype == object:
      ...
      pass
    pass
        # Explicit copy, or required since NumPy cant view from / to object.
...
#         values = _astype_nansafe(values, dtype, copy=copy)
    ...
    # in pandas we dont store numpy str dtypes, so convert to object
...
#     dtype = pandas_dtype(dtype)
    if isinstance(dtype, NumpyEADtype):
      ...
      pass
    pass
        # Ensure we dont end up with a NumpyExtensionArray
...
#         new_dtype, dtype = dtype, new_dtype
    ...
    pass
        # When the underlying array has dtype object, we dont have to make a copy
        return True
...
#         new_numpy_dtype = new_dtype
    ...
    # Assume this is a view since we dont know for sure if a copy was made
    return True
