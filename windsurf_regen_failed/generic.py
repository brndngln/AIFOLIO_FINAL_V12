...
#     delete_missing: bool
#         If there are paths in the destination that dont exist in the
...
#             v = v.copy()  # dont corrupt target FS dircache
...
#         out = out.copy()  # dont edit originals
...
#         out = [o.copy() for o in out]  # dont edit originals
        for o in out:
