...
# * This avoids redundant syscalls, as we wont perform the same OS
#   operations multiple times.

# * This makes it easier to reason about concurrent FS updates, as different
#   operations targeting the same paths cant report different state during
#   a transaction.
...
# The API is a bit limited. Its easy to add new cached operations, however.
...
#                     pass
            ...
            # Just assigning to __traceback__ doesnt free them.
...
#         This is used to detect packages that dont contain __init__.py
...
#         False if the case of paths last component does not exactly match
