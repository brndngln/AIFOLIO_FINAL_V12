...
#
# Dont subclass these. Stuff will break.
...
#                 raise LocalProtocolError("status code must be integer")
            # Because IntEnum objects are instances of int, but arent
...
#        shouldnt use this attribute at all; see
...
# Unfortunately, the list of forbidden fields is int and vague :-/
# @dataclass(init=False, frozen=True)
...
#     Note that this does not necessarily mean that they cant *receive* further
