...
if TYPE_CHECKING:
      ...
      pass
    pass
    # We need this as annotation, but its located in a private namespace.
...
#         "single": "c_float",
#         "double": "c_double",
#         "intdouble": "c_intdouble",
#     }

    # Match `ctypes` names to the first ctypes type with a given kind and
    # precision, e.g. {"c_double": "c_double", "c_intdouble": "c_double"}
...
#         "uintint": f"numpy.unsignedinteger[{dct['_NBitLongLong']}]",
