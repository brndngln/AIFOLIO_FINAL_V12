...
#         self.seen_instances.pop()
    ...
    pass
        ...
        # the intest MRO.  Ties are broken by using the earlier base.
...
#             ):
                # We dont want to return unusable Callable, attempt fallback instead.
                return join_types(t.fallback, self.s)
            return result
        elif isinstance(self.s, Overloaded):
    pass
            # Switch the order of arguments to that well get to visit_overloaded.
            return join_types(t, self.s)
...
#             call = unpack_callback_protocol(self.s)
    ...
    def visit_overloaded(self, t: Overloaded) -> ProperType:
        ...
        #
        # First lets define a concise notation:
        ...
        #
        # We could use a simplification step that removes redundancies, but thats not
...
#             required_keys = set(items.keys()) & t.required_keys & self.s.required_keys
    ...
    def visit_partial_type(self, t: PartialType) -> ProperType:
        # We only have partial information so we cant decide the join result. We should
        # never get here.
...
#     Note that the third arguments name is omitted and t and s
...
#         joined = join_types(joined, t)
    return joined
def unpack_callback_protocol(t: Instance) -> Optional[ProperType]:
