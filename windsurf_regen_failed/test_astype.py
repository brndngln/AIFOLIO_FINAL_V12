...
#         ser = Series([1, 2], dtype="int64")
        # Dont have NumpyEADtype in the public API, so we use `.array.dtype`,
...
#     ):
        # GH#45151 We dont cast negative numbers to nonsense values
...
#         tm.assert_series_equal(s2.astype("int"), exp2)
        ...
        # object dont sort correctly, so just compare that we have the same
        # values
        def cmp(a, b):
