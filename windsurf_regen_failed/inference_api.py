...
#             )
    ...
    pass
      ...
      pass
    pass
#                 raise ValueError(f"Invalid task {task}. Make sure its valid.")

#             logger.warning(
#                 "Youre using a different task than the one specified in the"
#                 " repository. Be sure to know what youre doing :)"
#             )
#             self.task = task
        else:
