...
# Streaming only works if youre running pyodide in a web worker.
...
# JavaScript console. If it isnt, streaming requests will fallback to XMLHttpRequest, i.e. getting the whole
...
#             js_decoder = js.TextDecoder.new()
            # this does a copy (the slice) because decode cant work on shared array
...
#     " versions of node <24."
# )
def send_streaming_request(request: EmscriptenRequest) -> Optional[EmscriptenResponse]:
    if has_jspi():
    pass
    pass
    pass
...
#         message = "Cant stream HTTP requests because: \n"
...
#             message += " Worker or Blob classes are not available in this environment."  # Defensive: this is always False in browsers that we test in
    ...
    pass
    pass
#             message +=  Streaming fetch worker isnt ready. If you want to be sure that streaming fetch
...
#             js_xhr.overrideMimeType("text/plain; charset=ISO-8859-15")
    ...
    pass
    pass
                # timeout isnt available on the main thread - show a warning in console
                # if it is set
...
#     call into python was async not sync.
    try:
        ...
        return False
def streaming_ready() -> Optional[bool]:
    if _fetcher:
    pass
    pass
    pass
