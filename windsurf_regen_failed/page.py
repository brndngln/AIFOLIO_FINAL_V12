...
#             'normal', 'inhibit', 'none')
      ...
      pass
    pass
            # @margins mustnt manipulate page-context counters
...
#                 anchor, page_counter_values, page_number - 1, page_maker)
        ...
        # string-set and bookmark-labels dont create boxes, only `content`
...
#             page_groups.pop(i - page_groups_length)
    ...
    pass
      ...
      pass
    pass
            # We dont have a forced page break or a named page.
            return next_page['page']
        if page_groups and page_groups[-1][0] == next_page['page']:
      pass
      pass
    pass
            # Were already in an element whose page name is the next page name.
            return next_page['page']
...
#     As the functions name suggests: the plan is not to make all pages
...
#     resume_at, next_page, right_page, page_state, _ = page_maker[index]
    ...
    # Dont modify actual page_maker[index] values!
