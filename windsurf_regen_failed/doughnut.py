...
#         sideLabels = AttrMapValue(isBoolean, desc="If true attempt to make chart with labels aint side and pointers", advancedUsage=1),
...
#         multi = isListOfListOfNoneOrNumber(data)
    ...
    pass
    pass
            #its a nested list, more than one sequence
#             normData = []
#             n = []
            for l in data:
...
#                     labels = list(labels) + [''] * m
            ...
            #theres no point in raising errors for less than enough labels if
