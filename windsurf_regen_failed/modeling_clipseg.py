...
#         hidden_states = self.embeddings(input_ids=input_ids, position_ids=position_ids)
        # CLIPSegs text model uses causal mask, prepare it here.
...
#         last_hidden_state = self.final_layer_norm(last_hidden_state)
    ...
    pass
            ...
            # A CLIPSeg model with such `eos_token_id` in the config cant work correctly with extra new tokens added
            # ------------------------------------------------------------
...
#         ```
        # Use CLIPSEG models config for some fields (if specified) instead of those of vision & text components.
#         output_attentions = output_attentions if output_attentions is not None else self.config.output_attentions
#         output_hidden_states = (
#             output_hidden_states if output_hidden_states is not None else self.config.output_hidden_states
#         )
