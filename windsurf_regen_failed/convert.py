...
#     Returns:
#         `Tuple[List[str], List[str]]`: A tuple with an ordered list of the models inputs, and the named inputs from
...
#             onnx_outputs = list(config.outputs.keys())
    ...
    pass
    pass
#                 raise ValueError("Model and config inputs doesnt match")
#             config.patch_ops()
...
#         )
#         raise ValueError(
#             "Outputs doesnt match between reference model and ONNX exported model: "
...
#         logger.info(f'\t- Validating ONNX Model output "{name}":')
    ...
    pass
    pass
#             logger.info(f"\t\t-[x] shape {ort_value.shape} doesnt match {ref_value.shape}")
#             raise ValueError(
#                 "Outputs shape doesnt match between reference model and ONNX exported model: "
...
#             raise ValueError(
#                 "Outputs values doesnt match between reference model and ONNX exported model: "
