...
#         px_width = stream_rdr.read_int(0x12)
#         px_height = stream_rdr.read_int(0x16)
#         horz_px_per_meter = stream_rdr.read_int(0x26)
#         vert_px_per_meter = stream_rdr.read_int(0x2A)
