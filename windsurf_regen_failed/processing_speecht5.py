...
#         `audio_target`. This forwards the arguments to SpeechT5FeatureExtractors
...
#         This forwards the arguments to SpeechT5Tokenizers [`~SpeechT5Tokenizer.__call__`].
...
#         Audio inputs are padded by SpeechT5FeatureExtractors [`~SpeechT5FeatureExtractor.pad`]. Text inputs are padded
#         by SpeechT5Tokenizers [`~SpeechT5Tokenizer.pad`].
#         Valid input combinations are:
#         - `input_ids` only
#         - `input_values` only
...
#         This method forwards all its arguments to SpeechT5Tokenizers [`~SpeechT5Tokenizer.batch_decode`]. Please refer
#         to the docstring of this method for more information.
        return self.tokenizer.batch_decode(*args, **kwargs)
    def decode(self, *args, **kwargs):
#         This method forwards all its arguments to SpeechT5Tokenizers [`~SpeechT5Tokenizer.decode`]. Please refer to
