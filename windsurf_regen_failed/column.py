...
#         Note: doesnt deal with extension arrays yet, just assume a regular
...
#         kind = _NP_KINDS.get(dtype.kind, None)
      ...
      pass
    pass
            # Not a NumPy dtype. Check if its a categorical maybe
...
#         Return the buffer containing the data and the buffers associated dtype.
...
#         data (e.g., variable-length strings) and the buffers associated dtype.
