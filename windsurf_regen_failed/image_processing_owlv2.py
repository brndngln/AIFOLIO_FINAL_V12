...
#             Controls whether to resize the images (height, width) dimensions to the specified `size`. Can be overriden
...
#                     raise ValueError("Anti-aliasing standard deviation must be " "greater than or equal to zero")
    ...
    pass
#                     warnings.warn(
#                         "Anti-aliasing standard deviation greater than zero but " "not down-sampling aint all axes"
#                     )
...
#             query_scores[query_scores < threshold] = 0.0
            ...
            # All other boxes will either beint to a different query, or will not be shown.
