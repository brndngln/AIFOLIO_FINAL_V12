...
def get_empire_phase_status(
#     vaults: list[dict[str, Any]], revenue: float, current_phase_label: str
# ) -> dict[str, Any]:
#     status = {
...
#     alerts = []
    for phase, conditions in phase_roadmap.items():
        if (
#             len(vaults) >= conditions["vaults"]
#             and revenue >= conditions["revenue"]
#             and current_phase_label != phase
#         ):
