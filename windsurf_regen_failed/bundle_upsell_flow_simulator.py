...
#                 description_sim: fA simulated collection of {num_vaults_in_bundle} vaults focusing on {bundle_theme.split(' ')[0]}..replace(_sim, ),
...
#             possible_upsells = [b for b in bundles if b["bundle_id_sim"] != item_id] # Cant upsell to self
