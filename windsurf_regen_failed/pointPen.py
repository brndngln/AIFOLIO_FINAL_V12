...
# (if youre familiar with postscript anyway), the **PointPen**
...
#         segments = []
    ...
    pass
    pass
            # Its an open contour, insert a "move" segment for the first
            # point and remove that first point from the point list.
#             pt, segmentType, smooth, name, kwargs = points[0]
#             segments.append(("move", [(pt, smooth, name, kwargs)]))
#             points.pop(0)
        else:
            # Its a closed contour. Locate the first on-curve point, and
...
#                     break
    ...
    pass
                ...
                # points. Add a "None" point. (See also the Pen protocols
...
#             del segments[0]
            ...
            # Its a closed path, do a moveTo to the last
...
#             movePt, _, _, _ = points[-1]
    ...
    pass
            ...
            # one "qcurve" segment that ends with a point thats None. We
...
#             del self.contour[-1]
            ...
            # Theres an implied line at the end, replace "move" with "line"
            # for the first point
...
#     should be "smooth", ie. that its a "tangent" point or a "curve" point.
...
#             indices = range(1, nPoints - 1)
    ...
    pass
            ...
            # simply abuse Pythons negative index feature, and start at -1
#             indices = range(-1, nPoints - 1)
        else:
