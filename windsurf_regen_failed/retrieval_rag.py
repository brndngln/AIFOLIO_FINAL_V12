...
#             msg = (
#                 f"Cant load {filename}. Make sure that:\n\n"
...
#     >>> # To load the legacy index built originally for Rags paper
#     >>> from transformers import RagRetriever
...
#                 passages_path = os.path.join(save_directory, "hf_dataset")
                # datasets dont support save_to_disk with indexes right now
...
#                 A batch of query vectors to retrieve with.
#             prefix (`str`, *optional*):
#                 The prefix used by the generators tokenizer.
#             n_docs (`int`, *optional*):
#                 The number of docs retrieved per query.
