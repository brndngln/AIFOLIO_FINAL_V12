...
#     parents (which havent been setup yet). This includes obtaining the
#     values of fixtures required by the item (which havent been obtained
#     yet).
#         The item.
