...
#     min_salt_size = max_salt_size = 4
    ...
    # but its been reported (issue 30) that some servers use larger salts.
...
#     This class stores passwords using LDAPs plain MD5 format, and follows the :ref:`password-hash-api`.
...
#     This class stores passwords using LDAPs plain SHA1 format, and follows the :ref:`password-hash-api`.
...
#     This class stores passwords using LDAPs salted MD5 format, and follows the :ref:`password-hash-api`.
...
#     This class stores passwords using LDAPs "Salted SHA1" format,
...
#     This class stores passwords using LDAPs "Salted SHA2-256" format,
#     and follows the :ref:`password-hash-api`.
...
#     This class stores passwords using LDAPs "Salted SHA2-512" format,
#     and follows the :ref:`password-hash-api`.
...
def _init_ldap_crypt_handlers():
    # NOTE: I dont like to implicitly modify globals() like this,
    #       but dont want to write out all these handlers out either :)
#     g = globals()
