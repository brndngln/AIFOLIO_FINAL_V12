...
#     shouldnt be processed in Python 3 mode, even if the module happens to exist.
...
#         ):
            ...
            # to exist, even if there is no stub. Note that we cant verify that the
            # return type is compatible, since we havent bound types yet.
...
#             body.accept(self)
    # The remaining methods are an optimization: dont visit nested expressions
