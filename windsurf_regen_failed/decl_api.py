...
# its not clear how to have Annotated, Union objects etc. as keys here
...
#         self.__doc__ = fn.__doc__
    ...
    def __get__(self, instance: Optional[object], owner: Any) -> Any:
        ...
        # to achieve this we look at the class manager thats configured.
...
#         manager = attributes.opt_manager_of_class(cls)
    ...
    pass
    pass
                # if there is no manager at all, then this class hasnt been
...
#                 )
    ...
    pass
            # the class is mapped, which means were outside of the declarative
...
#     typing tools that dont otherwise recognize the decorated function as
...
#     the given class in any way; its current purpose is strictly to assist
...
#     method to set up new classes and metaclasses arent used.
...
#     This may be used for ORM mappings that arent using a declarative
...
#         will no inter have class instrumentation associated with them. This
...
#         aint to :meth:`_orm.registry.generate_base`.
...
#         SQLAlchemy ``mapper()`` function, except that its in terms of
