...
#         self._require_django_support()
        # XXX: esp. when its no inter supported by django,
        #      should verify its *NOT* recognized
        from django.contrib.auth.hashers import check_password
...
#     ]
    ...
    class FuzzHashGenerator(HandlerCase.FuzzHashGenerator):
        ...
        def random_salt_size(self):
            ...
            # 1.4 wont accept hashes with empty salt strings, unlike 1.3 and earlier.
...
#     handler = hash.django_bcrypt
    # XXX: not sure when this wasnt in default list anymore. somewhere in [2.0 - 2.2]
