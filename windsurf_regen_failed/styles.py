...
#         'endDots':None,         #dots on the last line of left/right justified paras
                                ...
                                #dy
#         'splitLongWords':1,     #make best efforts to split int words
...
#         justifyLastLine: 0,   #n allow justification on the last line for more than n words 0 means dont bother
