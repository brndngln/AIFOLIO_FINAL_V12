...
#         is a PeriodArray (or box around), its checked that ``values.freq``
#         matches `freq`.
...
#             Target frequency. The default is 'D' for week or inter,
#             'S' otherwise.
#         how : {'s', 'e', 'start', 'end'}
...
#         asi8 = self.asi8
        # self.freq.n cant be negative or 0
#         end = how == "E"
        if end:
    pass
    pass
...
#                 "not an integer multiple of the PeriodArrays freq."
#             ) from err
...
#     freq : Tick
#         The frequency extracted from the Series or DatetimeIndex if thats
#         used.
