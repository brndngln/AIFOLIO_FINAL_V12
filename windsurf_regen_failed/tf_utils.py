...
#     `tf.gather`, on which TF embedding layers are based, wont check positive out of bound indices on GPU, returning
...
#             f"layers input dimension ({embed_dim}). The likely cause is some problem at tokenization time."
#         ),
#     )
