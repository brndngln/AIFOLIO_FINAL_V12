...
#         reduce_edge_list(end_edges)
    # Base cases. Either start/end are empty and were done, or the final,
...
#         slices.append(path + (slice(start[divergence_idx] + 1, end[divergence_idx] + 1),))
    ...
    # separately. If theres contiguous meat in between them, we can index it
    # in one big chunk
    else:
#         slices.extend(upper())
...
#         self,
        ...
        # plateau earlier than this on all GPUs Ive run the model on.
