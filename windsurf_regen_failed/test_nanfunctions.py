...
#      np.array([False, True, False, True])),
    # int64 array that cant possibly have nans
#     (np.array([1, 5, 7, 9], dtype=np.int64),
#      True),
    # bool array that cant possibly have nans
#     (np.array([False, True, False, True]),
#      True),
...
#         assert_equal(actual, expected)
        # the above wont distinguish between True proper
        # and an array of True values; we want True proper
        # for types that cant possibly contain NaN
