...
#     Dinat encoders outputs, with potential hidden states and attentions.
#     Args:
...
#     Dinat models outputs that also contains a pooling of the last hidden states.
#     Args:
#         last_hidden_state (`torch.FloatTensor` of shape `(batch_size, sequence_length, hidden_size)`):
#             Sequence of hidden-states at the output of the last layer of the model.
...
#     See discussion: https://github.com/tensorflow/tpu/issues/494#issuecomment-532968956 ... Ive opted for changing the
...
#         value_layer = self.transpose_for_scores(self.value(hidden_states))
        # Apply the scale factor before computing attention weights. Its usually more efficient because
