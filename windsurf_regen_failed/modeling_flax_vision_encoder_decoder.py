...
#             Pixel values. Pixel values can be obtained using the vision models image processor. For example, using
...
#         >>> # use GPT2s eos_token as the pad as well as eos token
...
#         pixel_values = jnp.transpose(pixel_values, (0, 2, 3, 1))
      ...
      pass
    pass
#             raise ValueError("`decoder_input_ids` cant be `None`.")
        if decoder_attention_mask is None:
      pass
      pass
    pass
