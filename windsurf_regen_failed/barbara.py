...
#     risk_score = calculate_risk_score(moderation)
    if moderation["block_reason"] or moderation["human_review_required"] or risk_score >= 100:
      ...
      pass
    pass
#         log_interaction("barbara", safe_input, f"[BLOCKED: {moderation.get('block_reason','compliance')}|Risk:{risk_score}]", moderation, user)
...
#     system_prompt = (
#         "You are Barbara, a helpful assistant. Your sole task is to offer expertise in writing engaging, SEO-friendly blog content. "
