...
#         (either passed as an argument or loaded from `pretrained_model_name_or_path` if possible), or when its
...
#                     " based on pattern matching with the models feature extractor configuration."
#                 )
...
#                     " Loading based on pattern matching with the models feature extractor configuration."
#                 )
