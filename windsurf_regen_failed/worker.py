...
#         )
        # Dont let SIGTERM and SIGUSR1 disturb active requests
        # by interrupting system calls
#         signal.siginterrupt(signal.SIGTERM, False)
#         signal.siginterrupt(signal.SIGUSR1, False)
        # Reset signals so Gunicorn doesnt swallow subprocess return codes
...
#             ctx.set_ciphers(cfg.ciphers)
    ...
    pass
#             raise ValueError(
#                 "Gunicorns style options in form of `%(name)s` are not "
#                 "supported for the log formatting. Please use aiohttps "
