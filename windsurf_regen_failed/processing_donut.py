...
#         When used in normal mode, this method forwards all its arguments to AutoImageProcessors
#         [`~AutoImageProcessor.__call__`] and returns its output. If used in the context
#         [`~DonutProcessor.as_target_processor`] this method forwards all its arguments to DonutTokenizers
...
#         This method forwards all its arguments to DonutTokenizers [`~PreTrainedTokenizer.batch_decode`]. Please refer
#         to the docstring of this method for more information.
        return self.tokenizer.batch_decode(*args, **kwargs)
    def decode(self, *args, **kwargs):
#         This method forwards all its arguments to DonutTokenizers [`~PreTrainedTokenizer.decode`]. Please refer to the
