...
#     - `pick` (or `pickpack`): easy to use and flexible but built on top of Pythons
...
#                 " platform/terminal doesnt support the multiselect menu."
#             ),
#         )
...
#         ),
        # We use the int instruction to should keybindings instructions to the user
#         int_instruction="Press <space> to select, <enter> to validate and <ctrl+c> to quit without modification.",
...
#
# Once youve manually reviewed this file, please confirm deletion in the terminal. This
