...
#     peak-to-peak value that cannot be represented with the arrays data type.
...
#     The ISE is estimated using cross-validation and can be regarded as a generalization of Scotts rule.
...
#     Doanes histogram bin estimator.
...
#     If the IQR is 0, its unlikely any variance-based estimators will be of
...
#                 "supplied range of [{}, {}] is not finite".format(first_edge, last_edge))
    ...
    pass
        # handle empty arrays. Cant determine range, so use 0-1.
...
#         larger, non-normal datasets. This is the default method in Rs
#         ``hist`` method.
#     'doane'
#         .. math:: n_h = 1 + \log_{2}(n) +
...
#         weights beinting to the samples falling into each bin.
#     Returns
#     -------
#     H : ndarray
