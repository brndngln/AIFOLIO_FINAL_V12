...
#         transform_match_stmt(self.builder, stmt)
    ...
    # Constructs that shouldnt ever show up

    def visit_enum_call_expr(self, o: EnumCallExpr) -> Value:
#         assert False, "cant compile analysis-only expressions"
...
#         assert False, "cant compile Var; should have been handled already?"
