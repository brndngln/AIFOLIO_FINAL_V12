...
#     Copy/paste/tweak models weights to our DPT structure.
...
#         type=str,
#         help="URL of the original DPT checkpoint youd like to convert.",
#     )
#     parser.add_argument(
...
#         "--model_name",
        default="dpt-large",
#         type=str,
#         help="Name of the model, in case youre pushing to the hub.",
#     )
#     parser.add_argument(
#         "--show_prediction",
#         action="store_true",
