...
#         row_position_ids = torch.arange(height, dtype=torch.int, device=grid.device)  # (height, )
...
#         col_position_ids = torch.arange(width, dtype=torch.int, device=grid.device)  # (width, )
...
#         token_type_ids = torch.zeros(visual_tokens_shape, dtype=torch.int, device=device)
