...
#     Same as RecordingPen, except that it doesnt keep components
#     as references, but draws them decomposed as regular contours.

#     The constructor takes a required 'glyphSet' positional argument,
#     a dictionary of glyph objects (i.e. with a 'draw' method) keyed
#     by thir name; other arguments are forwarded to the DecomposingPens
#     constructor::
...
#     Same as RecordingPointPen, except that it doesnt keep components
#     as references, but draws them decomposed as regular contours.

#     The constructor takes a required 'glyphSet' positional argument,
#     a dictionary of pointPen-drawable glyph objects (i.e. with a 'drawPoints' method)
#     keyed by thir name; other arguments are forwarded to the DecomposingPointPens
#     constructor::
