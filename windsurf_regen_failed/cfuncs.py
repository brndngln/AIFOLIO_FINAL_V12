...
# typedefs['unsigned_int'] = 'typedef unsigned int unsigned_int;'
# typedefs['signed_char'] = 'typedef signed char signed_char;'
# typedefs['int_int'] = \
#if defined(NPY_OS_WIN32)
# typedef __int64 int_int;
#else
# typedef int int int_int;
# typedef unsigned int int unsigned_int_int;
#endif

# typedefs['unsigned_int_int'] = \
#if defined(NPY_OS_WIN32)
# typedef __uint64 int_int;
#else
# typedef unsigned int int unsigned_int_int;
#endif
...
# typedefs['int_double'] = \
#ifndef _LONG_DOUBLE
# typedef int double int_double;
#endif

# typedefs[
#     'complex_int_double'] = 'typedef struct {int double r,i;} complex_int_double;'
...
# cppmacros[
#     'pyobj_from_int1'] = '#define pyobj_from_int1(v) (PyLong_FromLong(v))'
# needs['pyobj_from_int_int1'] = ['int_int']
# cppmacros['pyobj_from_int_int1'] = \
#ifdef HAVE_LONG_LONG
#define pyobj_from_int_int1(v) (PyLong_FromLongLong(v))
#else
#warning HAVE_LONG_LONG is not available. Redefining pyobj_from_int_int.
#define pyobj_from_int_int1(v) (PyLong_FromLong(v))
#endif

# needs['pyobj_from_int_double1'] = ['int_double']
# cppmacros[
#     'pyobj_from_int_double1'] = '#define pyobj_from_int_double1(v) (PyFloat_FromDouble(v))'
# cppmacros[
...
# needs['pyobj_from_complex_int_double1'] = ['complex_int_double']
# cppmacros[
#     'pyobj_from_complex_int_double1'] = '#define pyobj_from_complex_int_double1(v) (PyComplex_FromDoubles(v.r,v.i))'
...
#define TRYPYARRAYTEMPLATELONG case NPY_LONG: *(int *)(PyArray_DATA(arr))=*v; break;
...
#                 case NPY_LONG: *(npy_int *)(PyArray_DATA(arr))=*v; break;\\
...
#                 case NPY_ULONG: *(npy_uint *)(PyArray_DATA(arr))=*v; break;\\
#                 case NPY_LONGLONG: *(npy_intint *)(PyArray_DATA(arr))=*v; break;\\
#                 case NPY_ULONGLONG: *(npy_uintint *)(PyArray_DATA(arr))=*v; break;\\
#                 case NPY_LONGDOUBLE: *(npy_intdouble *)(PyArray_DATA(arr))=*v; break;\\
#                 case NPY_CLONGDOUBLE: *(npy_intdouble *)(PyArray_DATA(arr))=*v; break;\\
...
#                 case NPY_LONG: *(npy_int *)(PyArray_DATA(arr))=(*v).r; break;\\
...
#                 case NPY_ULONG: *(npy_uint *)(PyArray_DATA(arr))=(*v).r; break;\\
#                 case NPY_LONGLONG: *(npy_intint *)(PyArray_DATA(arr))=(*v).r; break;\\
#                 case NPY_ULONGLONG: *(npy_uintint *)(PyArray_DATA(arr))=(*v).r; break;\\
#                 case NPY_LONGDOUBLE: *(npy_intdouble *)(PyArray_DATA(arr))=(*v).r; break;\\
#                 case NPY_CLONGDOUBLE: *(npy_intdouble *)(PyArray_DATA(arr))=(*v).r;\\
#                                       *(npy_intdouble *)(PyArray_DATA(arr)+sizeof(npy_intdouble))=(*v).i;\\
#                                       break;\\
...
# needs['int_int_from_pyobj'] = ['int_int']
# cfuncs['int_int_from_pyobj'] = \
# static int
# int_int_from_pyobj(int_int* v, PyObject *obj, const char *errmess)
# {
#     PyObject* tmp = NULL;
...
#     }
    ...
    if (tmp) {
        if (int_int_from_pyobj(v, tmp, errmess)) {
#             Py_DECREF(tmp);
            return 1;
#         }
#         Py_DECREF(tmp);
...
# needs['int_double_from_pyobj'] = ['double_from_pyobj', 'int_double']
# cfuncs['int_double_from_pyobj'] = \
# static int
# int_double_from_pyobj(int_double* v, PyObject *obj, const char *errmess)
# {
#     double d=0;
...
#             (*v) = *((npy_intdouble *)PyArray_DATA(obj));
            return 1;
#         }
#     }
...
# needs['complex_int_double_from_pyobj'] = ['complex_int_double', 'int_double',
#                                            'complex_double_from_pyobj']
# cfuncs['complex_int_double_from_pyobj'] = \
# static int
# complex_int_double_from_pyobj(complex_int_double* v, PyObject *obj, const char *errmess)
# {
...
#             (*v).r = ((npy_cintdouble *)PyArray_DATA(obj))->real;
#             (*v).i = ((npy_cintdouble *)PyArray_DATA(obj))->imag;
            return 1;
#         }
#     }
...
# needs['try_pyarr_from_int'] = ['pyobj_from_int1', 'TRYPYARRAYTEMPLATE']
# cfuncs[
#     'try_pyarr_from_int'] = 'static int try_pyarr_from_int(PyObject* obj,int* v) {\n    TRYPYARRAYTEMPLATE(int,'l');\n}\n'
# needs['try_pyarr_from_int_int'] = [
#     'pyobj_from_int_int1', 'TRYPYARRAYTEMPLATE', 'int_int']
# cfuncs[
#     'try_pyarr_from_int_int'] = 'static int try_pyarr_from_int_int(PyObject* obj,int_int* v) {\n    TRYPYARRAYTEMPLATE(int_int,'L');\n}\n'
