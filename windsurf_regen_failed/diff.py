...
#         cur_tokens = tokens
    # After weve tracked all the tokens, we can combine spans of text
...
#     chunks (not tokens).
    ...
    # to keep markup from the old document; anything that we cant
...
#             merge_delete(del_tokens, result)
    # If deletes were inserted directly as <del> then wed have an
...
#     here we add <ins>ins_chunks</ins> to the end of that.
    # Though we dont throw away unbalanced_start or unbalanced_end
...
#     doc.extend(unbalanced_start)
    ...
    pass
    pass
        # Fix up the case where the word before the insert didnt end with
        # a space
#         doc[-1] += ' '
#     doc.append('<ins>')
...
#      Raised when the document no inter contains any pending deletes
#     (DEL_START/DEL_END)
...
#             pre_delete, delete, post_delete = split_delete(chunks)
            ...
            # Nothing found, weve cleaned up the entire doc
#             break
...
#         doc = pre_delete
    ...
    pass
    pass
            # Fix up case where the word before us didnt have a trailing space
#             doc[-1] += ' '
#         doc.append('<del>')
        if balanced and balanced[-1].endswith(' '):
    pass
...
#     document.  If this doesnt work out, we just throw away
...
#         next = post_delete[0]
    ...
    pass
    pass
            # Reached a word, we cant move the delete text forward
#             break
        if next[1] == '/':
    pass
    pass
...
#         name = next.split()[0].strip('<>/')
    ...
    pass
    pass
            # Cant move into an insert or delete
#             break
        if name == finding_name:
    pass
    pass
...
#     If cleanup is true, make sure theres no <head> or <body>, and get
...
#         result[-1].post_tags.extend(tag_accum)
    return result
# All the tags in HTML that dont require end tags:
# empty_tags = (
...
#     If skip_outer is true, then dont serialize the outermost tag
