...
#     ) -> None:
#         optional inlined form of add() which can assume item isnt present
#         in the ma.
#         self.add(state)
...
#                 result.append(value)
    ...
    def _fast_discard(self, state: InstanceState[Any]) -> None:
        ...
        # GCed, inlines _managed_removed_state
#         key = state.key
#         assert key is not None
        try:
#             st = self._dict[key]
...
#         "identity map is no inter valid.  Has the owning Session "
