...
#                 delattr(cls, attr_name)
                ...
                # pycparsers users are installed in -OO mode which strips
                # docstrings away.
...
#     functions parameters must be accessible via its `_params` attribute.
    for xxx, yyy in func._params:
        # Use the template methods body for each new method
