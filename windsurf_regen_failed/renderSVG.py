...
#         useClip = False True means dont use a clipPath definition put the global clip into the clip property
...
#         implementation = getDOMImplementation('minidom')
        ...
        #  "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd">
        #So well use that for our SVG 1.0 output.
#         doctype = implementation.createDocumentType("svg",
#                   "-//W3C//DTD SVG 1.0//EN",
#                   "http://www.w3.org/TR/2001/REC-SVG-20010904/DTD/svg10.dtd")
...
#             items = [k+': '+str(style[k]) for k in keys]
        return '; '.join(items) + ';'
    def _escape(self, s):
#         I dont think this was ever needed; seems to have been copied from renderPS
        return s
...
#                 'fontSize':'_fontSize'}
    def _get_link_info_dict(self, obj):
        ...
        #attributes value - use the empty string instead.
...
#         title = getattr(obj, "hrefTitle", ") or "
    ...
    pass
            ...
            #However, the links dont work (Safari 3.2.1 on the Mac).
            #
