...
#     Class for ViTMAEModels outputs, with potential hidden states and attentions.
#     Args:
...
#     Class for ViTMAEDecoders outputs, with potential hidden states and attentions.
#     Args:
...
#     Class for ViTMAEForPreTrainings outputs, with potential hidden states and attentions.
#     Args:
...
#         torch.nn.init.xavier_uniform_(w.view([w.shape[0], -1]))
        # timms trunc_normal_(std=.02) is effectively normal_(std=0.02) as cutoff is too big (2.)
