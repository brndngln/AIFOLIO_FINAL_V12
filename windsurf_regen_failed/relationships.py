...
#             is internal to the ORMs attribute mechanics.
#             self.prop = prop
...
#                     "Cant compare a collection to an object or collection; "
...
#         of ``u1``.
        # in this callable, were trying to thread the needle through
        # a wide variety of scenarios, including:
        #
        # * the object hasn't been flushed yet and there's no value for
        #   the attribute as of yet
        #
        # * the object hasnt been flushed yet but it has a user-defined
        #   value
        #
        # * the object has a value but its expired and not locally present
        #
        # * the object has a value but its expired and not locally present,
        #   and the object is also detached
        #
        # * The object hadnt been flushed yet, there was no value, but
        #   later, the object has been expired and detached, and *now*
        #   theyre trying to evaluate it
        #
...
#             )
            ...
            # only if we cant get a value now due to detachment do we return
...
#             )
    ...
    pass
#                     raise sa_exc.InvalidRequestError(
#                         "Cant resolve value for column %s on object "
...
#                 "be a Table object or other FROM clause; cant send a mapped "
...
#             )
            # we dont allow the collection class to be a
...
#                 self.uselist = False
        ...
        # `relationship("B")`, use that, dont replace it with class we
...
#         ):
#             raise sa_exc.ArgumentError(
#                 "On %s, cant set passive_deletes=all in conjunction "
...
#                         )
            ...
            # a custom join doesnt have to be specified in
            # both directions.
...
#                 sj = kwargs.pop("secondaryjoin", None)
    ...
    pass
#                     raise sa_exc.InvalidRequestError(
#                         "Cant assign secondaryjoin on a backref "
...
#         memoize the use_get attribute of this RelationshipLoaders
#         lazyloader.
...
#             )
        # find a join between the given mappers mapped table and
        # the given table. will try the mappers local table first
...
#         and the join condition that dont have a
...
#                     manytoone_local = manytoone_local.difference(self_equated)
                ...
                # present, we know the direction, otherwise its still
                # ambiguous.
...
#                     raise sa_exc.ArgumentError(
#                         "Cant determine relationship"
#                         " direction for relationship '%s' - foreign "
#                         "key columns within the join condition are present "
#                         "in both the parent and the childs mapped tables.  "
...
#                     "nor the childs mapped tables" % self.prop
#                 )
    def _deannotate_pairs(
#         self, collection: _ColumnPairIterable
#     ) -> _MutableColumnPairs:
#         provide deannotation for the various lists of
#         pairs, so that using them in hashes doesnt incur
...
#         criterion, equivalent column sets, etc.
        ...
        # replacement traversals wont ever dig into it.
