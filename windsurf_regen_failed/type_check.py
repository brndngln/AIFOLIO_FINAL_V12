...
#                  'I': 'unsigned integer',
#                  'l': 'int integer',
#                  'L': 'unsigned int integer',
#                  'q': 'int int integer',
#                  'Q': 'unsigned int int integer',
#                  'f': 'single precision',
#                  'd': 'double precision',
#                  'g': 'int precision',
#                  'F': 'complex single precision',
#                  'D': 'complex double precision',
#                  'G': 'complex int double precision',
#                  'S': 'string',
#                  'U': 'unicode',
#                  'V': 'void',
#                  'O': 'object'
...
# array_type = [[_nx.half, _nx.single, _nx.double, _nx.intdouble],
#               [None, _nx.csingle, _nx.cdouble, _nx.cintdouble]]
...
#             p = array_precision.get(t, None)
      ...
      pass
    pass
#                 raise TypeError("cant get common type for non-numeric array")
