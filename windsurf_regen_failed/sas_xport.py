...
#     shift[np.where(xport1 & 0x00800000)] = 3
    ...
    # order 3 bits of the first half since were only shifting by
    # 1, 2, or 3.
#     ieee1 >>= shift
...
#     ieee1 &= 0xFFEFFFFF
    ...
    # 0x7f as 0x7f000000 and Python doesnt)
...
#         line1 = self._get_row()
    ...
    pass
    pass
                # this was created with the PROC CPORT method and cant be read
