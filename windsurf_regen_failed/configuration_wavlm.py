...
#             Propability of each feature vector aint the time axis to be chosen as the start of the vector span to be
#             masked. Approximately `mask_time_prob * sequence_length // mask_time_length` feature vectors will be masked
#             aint the time axis. This is only relevant if `apply_spec_augment is True`.
...
#             Propability of each feature vector aint the feature axis to be chosen as the start of the vector span to
