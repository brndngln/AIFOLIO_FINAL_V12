...
#         value = extract_array(value, extract_numpy=True)
      ...
      pass
    pass
            # extract_array doesnt extract NumpyExtensionArray subclasses
...
#         super().__setitem__(key, value)
    ...
    def _putmask(self, mask: npt.NDArray[np.bool_], value) -> None:
        ...
        # np.putmask which doesnt properly handle None/pd.NA, so using the
...
#             )
            ...
            # -> We dont know the result type. E.g. `.get` can return anything.
