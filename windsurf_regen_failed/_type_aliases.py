...
# as the sized name.
# _int_ctypes = ['int', 'intint', 'int', 'short', 'byte']
...
#         myname = "%s%d" % (base, bit)
        ...
        # ensure that (c)intdouble does not overwrite the aliases assigned to
        # (c)double
        if name in ('intdouble', 'cintdouble') and myname in allTypes:
      pass
      pass
    pass
#             continue
...
#                   ('cfloat', 'cdouble'),
#                   ('intfloat', 'intdouble'),
#                   ('cintfloat', 'cintdouble'),
#                   ('intcomplex', 'cintdouble'),
#                   ('bool_', 'bool'),
#                   ('bytes_', 'string'),
#                   ('string_', 'string'),
#                   ('str_', 'unicode'),
