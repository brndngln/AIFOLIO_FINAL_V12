...
#         hash passwords which dont have an associated user account
...
#         PIX & ASA. Its behavior has been confirmed for ASA 9.6,
...
#                 spoil_digest = secret + _DUMMY_BYTES
        ...
        #   DEVIATION: were letting them through, and repeating their
...
#         secret = right_pad_string(secret, pad_size)
    ...
    pass
    pass
            # make sure digest wont match truncated version of secret
#             secret += spoil_digest
...
#     Aside from a different internal algorithm, its use and format is identical
