...
#     Also, Chrome, Firefox, and Safari all currently accept `http://exam_ple.com` as a URL, so were in good
...
#     In case the `name` is not provided, its inferred from the email address.
#     ```py
