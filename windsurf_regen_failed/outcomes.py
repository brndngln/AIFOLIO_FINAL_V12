...
if TYPE_CHECKING:
    ...
    # available from typing_extensions, but we dont want a runtime dependency
...
#         self.allow_module_level = allow_module_level
        # If true, the skip location is reported as the items location,
...
#         If given, the imported modules ``__version__`` attribute must be at
...
#     compile(modname, , eval)  # to catch syntaxerrors
    ...
    with warnings.catch_warnings():
        ...
        # of existing directories with the same name were trying to
