...
#     If one of the models tensor is bigger than `max_shard_size`, it will end up in its own shard which will have a
...
#             Extra information to save aint with the model. Some metadata will be added for each dropped tensors.
...
#         pass
    ...
    pass
        ...
        # this is a XLA tensor, it must be created using torch_xlas
...
#     guaranteed to be unique and constant for this tensors storage during its lifetime. Two tensor storages with
#     non-overlapping lifetimes may have the same id.
#     In the case of meta tensors, we return None since we cant tell if they share the same storage.
