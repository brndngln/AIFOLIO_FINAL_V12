...
#         .. warning::
#            Pythons datetime uses microsecond resolution, which is lower than
...
#         Pythons standard `datetime` library uses a different representation
#         timedeltas. This method converts a Series of pandas Timedeltas
...
# ):
    def __new__(cls, data: Series):  # pyright: ignore[reportInconsistentConstructor]
        # CombinedDatetimelikeProperties isnt really instantiated. Instead
