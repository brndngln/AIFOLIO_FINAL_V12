...
#             type=str,
#             required=True,
#             help="Models id or path (ex: bert-base-cased)",
#         )
#         self.add_argument("--tokenizer", type=str, help="Tokenizers id or path (ex: bert-base-cased)")
#         self.add_argument(
#             "--framework",
#             type=str,
#             choices=["pt", "tf"],
...
#         raise ImportError(
#             "onnxruntime doesnt seem to be currently installed. "
...
#         - a BatchEncoding reference which was used to infer all the above information
    ...
    pass
            ...
            # Lets assume batch is the first axis with only 1 element (~~ might not be always true ...)
...
#         tokenizer: The tokenizer name which will be loaded by the pipeline, default to the models value
...
#     Notes: TensorFlow cannot export model bigger than 2GB due to internal constraint from TensorFlow
    ...
    pass
#         raise Exception("Cannot convert because TF is not installed. Please install tensorflow first.")
#     print("/!\\ Please note TensorFlow doesnt support exporting model > 2Gb /!")
    try:
...
#         opset: The actual version of the ONNX operator set to use
#         tokenizer: The name of the model to load for the pipeline, default to the models name if not provided
#         use_external_format:
...
#     quantizer.quantize_model()
    # Append "-quantized" at the end of the models name
...
#             check_onnxruntime_requirements(ORT_QUANTIZE_MINIMUM_VERSION)
            # onnxruntime optimizations doesnt provide the same level of performances on TensorFlow than PyTorch
