...
#                     is not given it will prompt until its aborted.
#                        be hidden.
...
#             echo(text.rstrip(" "), nl=False, err=err)
            ...
            # getpass doesnt print a newline if the user aborts input with ^C.
...
#     Because of this, the ProgressBar class object wont display
...
#     Removes ANSI styling information from a string.  Usually its not
#     necessary to use this function as Clicks echo function will
