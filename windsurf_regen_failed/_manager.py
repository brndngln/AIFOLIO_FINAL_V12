...
#         The short project name. Prefer snake case. Make sure its unique!
...
#     ) -> object | list[object]:
    ...
    def register(self, plugin: _Plugin, name: str | None = None) -> Optional[str]:
...
#                 hook._add_hookimpl(hookimpl)
        return plugin_name
    def parse_hookimpl_opts(self, plugin: _Plugin, name: str) -> Optional[HookimplOpts]:
