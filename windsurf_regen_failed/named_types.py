...
#     support for PGs ``CREATE TYPE`` and ``DROP TYPE``.
...
#         dont return dbapi.STRING for ENUM in PostgreSQL, since thats
#         a different typ.
        return None
...
#           If no collation is specified, the underlying data types default
