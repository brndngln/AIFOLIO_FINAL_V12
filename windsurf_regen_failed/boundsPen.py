...
#     actual bounding box if there are curves that dont have points
#     on their extremes.
#     When the shape has been drawn, the bounds are available as the
#     ``bounds`` attribute of the pen object. Its a 4-tuple::
#             (xMin, yMin, xMax, yMax).
...
#     correct bounds even when the shape contains curves that dont
