...
#                     "Glyph.graphicType must not be inter than 4 characters."
#                 )
...
#             )
      ...
      pass
    pass
                # this glyph is a reference to another glyphs image data
...
#             raise ttLib.TTLibError("Cant compile Glyph without glyph name")
...
#         xmlWriter.newline()
    ...
    def fromXML(self, name, attrs, content, ttFont):
      ...
      pass
    pass
            # this glyph i.e. a reference to another glyphs image data.
