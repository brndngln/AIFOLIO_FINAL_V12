...
#     all_relative_imports = []
    ...
    # Lets recurse through all relative imports
    while not no_change:
#         new_imports = []
...
#         local_files_only = True
    ...
    # Download and cache module_file from the repo `pretrained_model_name_or_path` of grab it if its a local file.
...
#         token = use_auth_token
    ...
    # Catch the name of the repo if its specified in `class_reference`
