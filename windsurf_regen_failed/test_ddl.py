...
#             "a_things_with_stuff",
#             metadata,
#             Column("id_int_column_name", Integer, primary_key=True),
#             test_needs_fk=True,
#         )
#         cons = ForeignKeyConstraint(
#             ["aid"], ["a_things_with_stuff.id_int_column_name"]
#         )
#         Table(
...
#             metadata,
#             Column("id_int_column_name", Integer, primary_key=True),
#             Column("id_another_int_name", Integer, primary_key=True),
#         )
#         cons = a.primary_key
#         actual_name = cons.name
#         metadata.create_all(connection)
...
#             metadata,
#             Column("id_int_column_name", Integer, primary_key=True),
#             Column("id_another_int_name", Integer),
#         )
#         cons = Index(None, a.c.id_int_column_name, a.c.id_another_int_name)
#         actual_name = cons.name
#         metadata.create_all(connection)
#         insp = inspect(connection)
...
#         }
#         metadata.naming_convention = convention
#         cons = UniqueConstraint("id_int_column_name", "id_another_int_name")
#         Table(
#             "a_things_with_stuff",
#             metadata,
#             Column("id_int_column_name", Integer, primary_key=True),
...
#         }
#         metadata.naming_convention = convention
#         cons = CheckConstraint("some_int_column_name > 5")
#         Table(
#             "a_things_with_stuff",
#             metadata,
#             Column("id_int_column_name", Integer, primary_key=True),
#             Column("some_int_column_name", Integer),
#             cons,
#         )
#         actual_name = cons.name
#         metadata.create_all(connection)
...
#         argnames="type_",
#     )
    def test_int_convention_name(self, type_, metadata, connection):
