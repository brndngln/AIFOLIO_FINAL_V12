...
#         data_lines = f.read().splitlines()
    # We cant rely on the test line numbers to *find* the test, since
...
#       *StripAssert*:
#           Dont generate code for assert statements
    # If this is specific to some bit width, always pass if platform doesnt match.
