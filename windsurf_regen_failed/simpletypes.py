...
#     @classmethod
    ...
    pass
                return value
        except NameError:  # means were on Python 3
#             pass
#         raise TypeError(
...
#     Theres a regular expression this is supposed to meet but so far thinking
#     spending cycles on validating wouldnt be worth it for the number of
