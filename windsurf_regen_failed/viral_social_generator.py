...
#         templates = {
#             "tiktok_hook": [
#                 f"🤯 You WONT BELIEVE this {n} secret for {t}!",
...
#                 f"Thinking about {t} in the {n} world? Heres a thread 🧵... (1/3) [Placeholder for thread start]",
#                 f"Poll: Whats your biggest challenge with {t} when it comes to {n}? #Community #{n.replace( ,)}",
