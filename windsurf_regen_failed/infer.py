...
#             )
    ...
    pass
#             msg = (
#                 "Cant infer scalar or collection for ORM mapped expression "
...
#     assert isinstance(stmt.rvalue, CallExpr)
    ...
    # or reconcile w/ whats present, etc.
...
#             )
        ...
        # like ForeignKey.  we cant infer from the right side.
        return infer_type_from_left_hand_type_only(
#             api, node, left_hand_explicit_type
#         )
...
#     the type.
    ...
    pass
#         msg = (
#             "Cant infer type from ORM mapped expression "
