...
class EraseTypeVisitor(TypeVisitor[ProperType]):
    def visit_unbound_type(self, t: UnboundType) -> ProperType:
        # TODO: replace with an assert after UnboundType cant leak from semantic analysis.
...
#         self.replacement = replacement
    ...
    def visit_type_alias_type(self, t: TypeAliasType) -> Type:
        # Type alias target cant contain bound type variables (not bound by the type
...
#     Instance types.
    ...
    def visit_type_alias_type(self, t: TypeAliasType) -> Type:
        # Type aliases cant contain literal values, because they are
