...
#     0.8
#         Added Prof. Stephen Waltons suggestion for a range method
#          - module author resisted the temptation to use lambda <0.5 wink>

#     0.7
#         Added Dan Winklers suggestions for __add__, __sub__ methods
...
#          - Added Jim Fultons suggestions for short alias class name =ND
...
#             r.append(self + i)
    ...
    def __repr__(self):
        ...
        # or the slice wont work for dates B.C.
...
#         cloned.add(days)
    ...
    def _checkDOW(self):
        if self.dayOfWeek()>4: raise NormalDateException("%r isnt a business day" % self.normalDate)
...
#         NormalDate.normalize(self,(i//5)*7+i%5+BDEpochScalar)
    ...
    def scalar(self):
#         d = self.asNormalDate()
#         i = d - BDEpoch     #luckily BDEpoch is a Monday so we dont have a problem
