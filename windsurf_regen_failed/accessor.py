...
#                 f = _create_delegator_method(name)
            ...
            # dont overwrite existing methods/properties
...
# 1. We dont need to catch and re-raise AttributeErrors as RuntimeErrors
...
#     For accessor, The classs __init__ method assumes that one of
...
#         self._accessor = accessor
    ...
    def __get__(self, obj, cls):
      ...
      pass
    pass
            # were accessing the attribute of the class, i.e., Dataset.geo
...
#                 lon = self._obj.intitude
                return (float(lon.mean()), float(lat.mean()))

            def plot(self):
                # plot this arrays data on a map, e.g., using Cartopy
#                 pass
...
#             In [1]: ds = pd.DataFrame({{"intitude": np.linspace(0, 10),
