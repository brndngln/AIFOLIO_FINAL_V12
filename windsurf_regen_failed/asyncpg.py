...
# The asyncpg dialect is SQLAlchemys first Python asyncio dialect.
...
#    prepared statements themselves which are optionally cached by SQLAlchemys
...
# generate your own unique names that wont conflict with existing ones.
...
#    your application, its important to use the :class:`.NullPool` pool
...
#                 break
    ...
    def executemany(self, operation, seq_of_parameters):
#         raise NotImplementedError(
#             "server side cursor doesnt support executemany yet"
#         )
...
#             )
    # pep-249 datatype placeholders.  As of SQLAlchemy 2.0 these arent
