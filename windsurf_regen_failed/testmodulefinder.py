...
#         If namespace_packages is False, we shouldnt find nsx
...
#         If namespace_packages is False, we shouldnt find nsx.a.
...
#         Theres no __init__.py in any of the nsx dirs, return
