...
#     Copy/paste/tweak models weights to our MobileNetV1 structure.
...
#         type=str,
#         help="Name of the MobileNetV1 model youd like to convert. Should in the form mobilenet_v1_<depth>_<size>.",
#     )
#     parser.add_argument(
