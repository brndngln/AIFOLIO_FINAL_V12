...
#             Whether to resize the images (height, width) dimensions to the specified `(size["height"],
...
#             )
            # size = get_resize_output_image_size(image, size["shortest_edge"], size["intest_edge"])
