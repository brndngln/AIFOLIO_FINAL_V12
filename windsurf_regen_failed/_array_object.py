...
#         broadcasting, so the resulting shape is the same, but this prevents NumPy
        ...
        # sort of trick wouldnt work for functions like searchsorted, which
...
#         other = self._check_allowed_dtypes(other, "numeric", "__pow__")
    ...
    pass
            return other
        # Note: NumPys __pow__ does not follow type promotion rules for 0-d
...
#         other = self._check_allowed_dtypes(other, "numeric", "__rpow__")
    ...
    pass
            return other
        # Note: NumPys __pow__ does not follow the spec type promotion rules
