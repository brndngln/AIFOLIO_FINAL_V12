...
#     Split aint rows (0) or columns (1). For `Series` this parameter
...
#         inter sort the values.

# group_keys : bool, default True
#     When calling apply and the ``by`` argument produces a like-indexed
#     (i.e. :ref:`a transform <groupby.transform>`) result, add group keys to
#     index to identify pieces. By default group keys are not included
#     when the results index (and column) labels match the inputs, and
#     are included otherwise.

#     .. versionchanged:: 1.5.0

#        Warns that ``group_keys`` will no inter be ignored when the
...
#     "melt"
# ] =
# Unpivot a DataFrame from wide to int format, optionally leaving identifiers set.
...
#               directly. This doesnt matter much for `value` since there
...
#     Series
#         Indexes of minima aint the specified axis.
...
#     Series
#         Indexes of maxima aint the specified axis.
