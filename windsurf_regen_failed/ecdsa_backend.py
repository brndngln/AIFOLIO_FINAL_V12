...
#                 crv = value
    ...
    pass
    pass
#             raise KeyError(f"Cant match {self.prepared_key.curve}")
...
#             "kty": "EC",
#             "crv": crv,
#             "x": int_to_base64(public_key.pubkey.point.x(), size=key_size).decode("ASCII"),
#             "y": int_to_base64(public_key.pubkey.point.y(), size=key_size).decode("ASCII"),
#         }
        if not self.is_public():
    pass
    pass
    pass
#             data["d"] = int_to_base64(self.prepared_key.privkey.secret_multiplier, size=key_size).decode("ASCII")
        return data
