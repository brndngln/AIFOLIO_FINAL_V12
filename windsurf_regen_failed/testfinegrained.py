...
#     use_cache = False
    ...
    pass
                return True
            # TODO: In caching mode we currently dont well support
...
#         doesnt currently support following imports.
...
#             base = BuildSource(os.path.join(test_temp_dir, "main"), "__main__", None)
            ...
            # when there arent any .py files in an increment
...
#             reversed(msgs)
#         )
    def test_int_form_sorting(self) -> None:
...
#         assert sort_messages_preserving_file_order(msg2 + msg1, old_msgs) == msg2 + msg1
    def test_mypy_error_prefix(self) -> None:
        # Some errors dont have a file and start with "mypy: ". These
        # shouldnt be sorted together with file-specific errors.
