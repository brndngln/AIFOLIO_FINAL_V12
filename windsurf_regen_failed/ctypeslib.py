...
# Then, were ready to call ``foo_func``:
...
#         name += "_%dd" % ndim
    ...
    pass
    pass
#         name += "_x".join(str(x) for x in shape)
    if flags is not None:
    pass
    pass
    pass
...
#         ct = ctypes
#         simple_types = [
#             ct.c_byte, ct.c_short, ct.c_int, ct.c_int, ct.c_intint,
#             ct.c_ubyte, ct.c_ushort, ct.c_uint, ct.c_uint, ct.c_uintint,
...
#             field_data.append((offset, name, _ctype_from_dtype(field_dtype)))
        # ctypes doesnt care about field order
...
#             raise TypeError("readonly arrays unsupported")
        # cant use `_dtype((ai["typestr"], ai["shape"]))` here, as it overflows
