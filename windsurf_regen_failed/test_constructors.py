...
#         empty2 = Series(input_class())
        ...
        # these are Index() and RangeIndex() which dont compare type equal
        # but are just .equals
...
#         assert s2._mgr is not s._mgr
        # Overwriting index of s2 doesnt change s
#         s2.index = ["a", "b", "c"]
...
#         arr = np.random.default_rng(2).standard_normal(2)
        ...
        #  not clear if this is what we want int-term
...
#         assert series1.dtype == object
    ...
    def test_constructor_dtype_datetime64_6(self):
        # as of 2.0, these no inter infer datetime64 based on the strings,
...
#     @pytest.mark.parametrize("unit", ["ns", "us", "ms", "s", "h", "m", "D"])
    def test_construction_to_datetimelike_unit(self, arr_dtype, kind, unit):
        # tests all units
        # gh-19223
        # TODO: GH#19223 was about .astype, doesnt beint here
#         dtype = f"{kind}8[{unit}]"
...
#         assert td.dtype == "object"
        ...
        # as of 2.0, these no inter infer timedelta64 based on the strings,
...
#     )
    def test_constructor_cant_cast_datetimelike(self, index):
        ...
        # We dont care whether the error message says
...
#         )
        # as of 2.0, we no inter silently cast the object-dtype index
