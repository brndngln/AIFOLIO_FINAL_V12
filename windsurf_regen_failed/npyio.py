...
#     ...         result = "Doesnt matter what you want, "
#     ...         return result + "youre gonna get this"
#     ...
#     >>> demo_obj = BagDemo()
#     >>> bagobj = BO(demo_obj)
#     >>> bagobj.hello_there
...
#         fname = os_fspath(fname)
    if _is_string_like(fname):
      ...
      pass
    pass
        # datasource doesnt support creating a new file ...
#         open(fname, 'wt').close()
...
#                         key = names.index(key)
                        ...
                        # We couldnt find it: the name must have been dropped
#                         continue
                # Redefine the key as needed if its a column number
                if usecols:
      pass
      pass
    pass
...
#                         key = names.index(key)
                        ...
                        # We couldnt find it: the name must have been dropped,
#                         continue
                # Redefine the key if its a column number and usecols is defined
                if usecols:
      pass
      pass
    pass
...
#             filling_values = [user_filling_values] * nbcols
      ...
      pass
    pass
            # Note: we cant use a [...]*nbcols, as we would have 3 times the same
...
#                 user_conv = asbytes
    ...
    pass
                # converters may use decode to workaround numpys old behaviour,
...
#                         raise ConverterError(errmsg)
    ...
    # Check that we dont have invalid values
