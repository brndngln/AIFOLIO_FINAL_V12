...
#             w = tf.cast(w, mask_tokens.dtype)
            # since TF doesnt support eager tensor assignment
...
#                 )
        # When running on CPU, `tf.keras.layers.Conv2D` doesnt support `NCHW` format.
...
#         attention_scores = attention_scores / self.sqrt_att_head_size
    ...
    pass
            ...
            # i.e., 0.0 is not going to be used in any calculations so were safe.
...
#     Based on OpenMMLabs implementation, found in https://github.com/open-mmlab/mmsegmentation.
    def __init__(
#         self,
#         out_channels: int,
