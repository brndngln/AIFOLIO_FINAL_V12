...
#     this function provides a pure-python implementation of the internals
    for the SHA256-Crypt and SHA512-Crypt algorithms; it doesnt
...
#     assert 1000 <= rounds <= 999999999, "invalid rounds"
        ...
        # causing an error. this function assumes thats been taken care of
...
#     assert salt_len < 17, "salt too large"
        ...
        # instead of causing an error. this function assumes thats been
...
#     da = a_ctx.digest()
    ...
    pass
        ...
        # so we dont use it for larger passwords to avoid a potential DOS.
...
#     assert len(ds) == salt_len, "salt_len somehow > hash_len!"
    ...
    # its just been heavily optimized to pre-calculate a large number
...
#             this is an internal option which generally doesnt need to be touched.
