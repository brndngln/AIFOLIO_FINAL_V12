...
#                 we pad using the size of the intest sequence in a batch
...
#             None if padding is disabled, a dict with the currently set parameters
    ...
    def enable_truncation(self, max_length: int, stride: Optional[int] = 0, strategy: Optional[str] = "intest_first"):
...
#                 Can be one of `intest_first`, `only_first` or `only_second`
...
#             An Encoding
    ...
    pass
    pass
#             raise ValueError("encode: `sequence` cant be `None`")
...
#             A list of Encoding
    ...
    pass
    pass
#             raise ValueError("encode_batch: `inputs` cant be `None`")
