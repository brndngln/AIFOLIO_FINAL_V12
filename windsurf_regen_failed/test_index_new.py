...
#         assert res.dtype == object
        # since the point is matching Series behavior, lets double check
...
#             pytest.skip(
#                 f"We dont cast {type(nulls_fixture).__name__} to "
...
#             request.node.add_marker(mark)
            ...
            #  assert_index_equal calls.  Since we cant do anything
...
class TestDtypeEnforced:
    # check we dont silently ignore the dtype keyword
