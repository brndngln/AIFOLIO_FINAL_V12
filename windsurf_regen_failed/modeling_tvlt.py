...
#     Class for TvltModels outputs, with potential hidden states and attentions.
#     Args:
...
#     Class for TvltDecoders outputs, with potential hidden states and attentions.
#     Args:
...
#     Class for TvltForPreTrainings outputs, with potential hidden states and attentions.
#     Args:
...
#             )
    ...
    pass
#             raise ValueError(
#                 f"Input audio size ({height}*{width}) doesnt match model"
