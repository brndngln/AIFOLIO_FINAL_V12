...
#
# Note: If when running this conversion script youre getting an exception:
...
#     n_positions = pos_embeddings.size(0)
    ...
    pass
#         raise ValueError(
#             f"pos_embeddings.max_sequence_length={n_positions} and config.n_positions={config.n_positions} dont match"
#         )
...
#     basename = os.path.dirname(args.path_to_checkpoint)
    # Load the model.
    # the .zip is very optional, lets keep it for backward compatibility
