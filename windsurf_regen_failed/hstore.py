...
# grammar is given.  This is mostly reverse engineered from PGs input parser
# behavior.
# (
#   (?P<key> (\\ . | [^])* )       # Quoted key
# )
...
#     Attempts to approximate PGs hstore input parsing rules as closely as
#     possible. Although currently this is not strictly necessary, since the
#     current implementation of hstores output syntax is stricter than what it
