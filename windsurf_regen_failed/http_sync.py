...
#     size: None or int
#         If given, this is the size of the file in bytes, and we dont attempt
...
#         r.raise_for_status()
        ...
        # with status 206 (partial content). But well guess that a suitable
...
#             out = r.content
    ...
    pass
#             raise ValueError(
#                 "The HTTP server doesnt appear to support range requests. "
