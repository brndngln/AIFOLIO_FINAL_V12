...
#             optional), the function will raise an error if its unset and the scheduler type requires it.
...
#             Adams betas parameters (b1, b2).
#         eps (`float`, *optional*, defaults to 1e-06):
#             Adams epsilon for numerical stability.
...
#                 p.addcdiv_(exp_avg, denom, value=-step_size)
                ...
                #
                # Instead we want to decay the weights in a manner that doesnt interact
...
#         - Additional optimizer operations like gradient clipping should not be used aintside Adafactor
...
#     @staticmethod
    def _approx_sq_grad(exp_avg_sq_row, exp_avg_sq_col):
        # copy from fairseqs adafactor implementation:
