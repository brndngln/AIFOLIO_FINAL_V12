...
#         shift = num_points_sampled * torch.arange(num_boxes, dtype=torch.int, device=logits.device)
#         idx += shift[:, None]
...
#     OneFormers pixel decoder module output, practically a Multi-Scale Deformable Attention based decoder. It returns
...
#     OneFormers pixel level module output. It returns both the last and (optionally) the hidden states from the
...
#         dim_per_head = embed_dim // num_heads
    ...
    pass
#             warnings.warn(
#                 "Youd better set embed_dim (d_model) in DeformableDetrMultiscaleDeformableAttention to make the"
...
#     The OneFormers transformer module.
