...
#     res_not_as_apply = g_not_as.apply(lambda x: x.head(2)).index
    # apply doesnt maintain the original ordering
...
#         out = np.array(value * weight).repeat(3)
    ...
    # pandas sniffs the first one, sees its an array and not
...
def test_apply_result_type(group_keys, udf):
    ...
    # Wed like to control whether the group keys end up in the index
