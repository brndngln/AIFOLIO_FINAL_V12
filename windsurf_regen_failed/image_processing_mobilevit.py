...
#             Whether to crop the input at the center. If the input size is smaller than `crop_size` aint any edge, the
#             image is padded with 0s and then center cropped. Can be overridden by the `do_center_crop` parameter in
