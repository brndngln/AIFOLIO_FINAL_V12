...
#     This is an experimental feature and is a subject to change at a moments notice.
...
#         self.variance_epsilon = eps
    ...
    def forward(self, hidden_states):
        # MT5 uses a layer_norm which only scales and doesnt shift, which is also known as Root Mean
...
#                     encoder_hidden_shape, device=inputs_embeds.device, dtype=torch.int
#                 )
...
#                     all_cross_attentions = all_cross_attentions + (layer_outputs[5],)
            ...
            # Model Parallel: If its the last layer for that device, put things on the next device
            if self.model_parallel:
      pass
      pass
    pass
...
#     Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. Its an encoder decoder transformer pre-trained in a
...
#         >>> # This is not needed for torchs MT5ForConditionalGeneration as it does this internally using labels arg.
...
# @add_start_docstrings(
#     "The bare MT5 Model transformer outputting encoders raw hidden-states without any specific head on top.",
#     MT5_START_DOCSTRING,
# )
