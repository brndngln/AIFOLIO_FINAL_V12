...
#         "s1": Series([10, 9, 8]),
        # Next 3 items arent pandas objects and should be ignored
...
#     df.to_hdf(path, "ss3", format="table", min_itemsize={"index": 6})
    # just make sure there is a inter string:
#     df2 = df.copy().reset_index().assign(C="inter").set_index("C")
...
#             col("f", "string2").is_indexed
        ...
        # try to index a col which isnt a data_column
#         msg = (
