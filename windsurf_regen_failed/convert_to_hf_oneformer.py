...
#         raise ValueError(
#             f"{model_name_raw} must be wrong since we didnt find coco or ade20k or cityscapes in it "
#         )
...
#         type=Path,
#         help=(
#             "A path to OneFormers original implementation directory. You can download from here: "
