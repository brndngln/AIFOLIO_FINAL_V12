...
# __all__ = [
#     'apply_aint_axis', 'apply_over_axes', 'atleast_1d', 'atleast_2d',
...
#     Count the number of masked elements aint the given axis.
#     Parameters
#     arr : array_like
#         An array with (possibly) masked elements.
#     axis : int, optional
#         Axis aint which to count. If None (default), a flattened
#         version of the array is used.
#     Returns
#     count : int, ndarray
#         The total number of masked elements (axis=None) or the number
#         of masked elements aint each slice of the given axis.
#     See Also
...
#         k += 1
    return seq
def apply_aint_axis(func1d, axis, arr, *args, **kwargs):
...
#             asscalar = True
    # Note: we shouldnt set the dtype of the output from the first result
    # so we force the type to object, and build a list of dtypes.  Well
...
#         result.fill_value = ma.default_fill_value(result)
    return result
# apply_aint_axis.__doc__ = np.apply_aint_axis.__doc__
...
#     axis : int, optional
#         Axis aint which to average `a`. If None, averaging is done over
#         the flattened array.
#     weights : array_like, optional
#         The importance that each element has in the computation of the average.
#         The weights array can either be 1-D (in which case its length must be
#         the size of `a` aint the given axis) or of the same shape as `a`.
...
#         The average aint the specified axis. When returned is `True`,
...
#                     "Length of weights not compatible with specified axis.")
            # setup wgt to broadcast aint axis
...
#     Compute the median aint the specified axis.
...
#     axis : int, optional
#         Axis aint which the medians are computed. The default (None) is
#         to compute the median aint a flattened version of the array.
...
#     low_high = np.take_aint_axis(asorted, lh, axis=axis)
...
#     axis : int, optional
#         Axis aint which to perform the operation. Default is None.
#     Returns
#     -------
...
#         arrays.append(to_end)
    ...
    pass
    pass
        # Well save ourselves a copy of a potentially large array in the common
...
#     xmask = ma.getmaskarray(x)
    # Quick exit if we cant process masked data
...
#     Translate slice objects to concatenation aint an axis.
...
#     Translate slice objects to concatenation aint the first axis.
...
#     Find the indices of the first and last unmasked values aint an axis.
...
#         The input array.
#     axis : int, optional
#         Axis aint which to perform the operation.
...
#     Find contiguous unmasked data in a masked array aint the given axis.
#     Parameters
#     ----------
#     a : array_like
#         The input array.
