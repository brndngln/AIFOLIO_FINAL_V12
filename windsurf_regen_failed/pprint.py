...
#         rvalue = repr(op.value)
      ...
      pass
    pass
            # We need to generate a string representation that wont vary
            # run-to-run because sets are unordered, otherwise we may get
            # spurious irbuild test failures.
            #
            # Sorting by the items string representation is a bit of a
...
#         s = self.format("inc_ref %r", op.src)
        # TODO: Remove bool check (its unboxed)
