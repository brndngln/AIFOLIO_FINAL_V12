...
# URL: https://github.com/google-research/scenic/tree/main/scenic/projects/owl_vi.
...
#     Copy/paste/tweak models weights to our OWL-ViT structure.
...
#         ],
#         type=str,
#         help="Name of the Owlv2 model youd like to convert from FLAX to PyTorch.",
#     )
#     parser.add_argument(
#         "--checkpoint_path",
        default=None,
