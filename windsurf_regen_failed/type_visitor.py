...
#     @abstractmethod
    def visit_type_alias_type(self, t: TypeAliasType) -> Type:
        # This method doesnt have a default implementation for type translators,
        # because type aliases are special: some information is contained in the
        # TypeAlias node, and we normally dont generate new nodes. Every subclass
...
#     create a new visitor instance instead.
    # TODO: check that we dont have existing violations of this rule.
