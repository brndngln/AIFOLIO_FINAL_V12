...
#         logs.append(fname.name)
    return logs
def load_intrusion_alerts(
#     alert_file: str = "./ai_core/EmmaLogs/intrusion_alerts.log",
# ) -> List[str]:
...
#     index_file: str = "ai_core/EmmaLogs/EmmaVaultIndex.json",
# ) -> Dict[str, Any]:
...
# Emmas Streamlit dashboard is DISABLED for non-visual mode reset.
