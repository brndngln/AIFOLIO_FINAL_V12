...
#         This basically means we also will include the sessions query_class,
#         as the actual :class:`_query.Query` object is part of whats cached
...
#         "spoiled" so that it wont use caching.
#         key = ()
        if not cache_path:
    pass
    pass
...
#            object **after** the querys SQL statement
