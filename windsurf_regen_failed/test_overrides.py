...
#         assert_equal(result, expected.view(OverrideSub))
    ...
    def test_no_wrapper(self):
        # This shouldnt happen unless a user intentionally calls
...
#         @implements(func_with_option)
        ...
        # we dont need to implement every option on __array_function__
        # implementations
...
#             func_with_option(MyArray(), option='extra')
        ...
        # but new options on implementations cant be used
...
class TestNDArrayMethods:
    ...
    def test_repr(self):
        # gh-12162: should still be defined even if __array_function__ doesnt
...
#         self.MyNoArrayFunctionArray = MyNoArrayFunctionArray
    ...
    def add_method(self, name, arr_class, enable_value_error=False):
        def _definition(*args, **kwargs):
            # Check that `like=` isnt propagated downstream
...
#         np_func = getattr(np, function)
        ...
        # Instantiate ref if its the MyNoArrayFunctionArray class
