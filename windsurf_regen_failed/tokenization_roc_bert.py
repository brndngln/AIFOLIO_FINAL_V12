...
#     ):
    ...
    pass
#                 raise ValueError(
#                     f"Cant find a vocabulary file at path {vocab_file}. To load the vocabulary from a Google "
...
#             raise ValueError(
#                 f"Cant find a directory at path {save_directory}. To load the vocabulary from a Google "
#                 "pretrained model use `tokenizer = RoCBertTokenizer.from_pretrained(PRETRAINED_MODEL_NAME)`"
#             )
