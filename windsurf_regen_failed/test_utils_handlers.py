...
#         self.assertIs(d1._wrapped_handler, ldap_md5)
        # replace w/ wrong handler, make sure doesnt reload w/ dummy
...
#             \)$)
    def test_14_bad_hash(self):
        # shoudl throw InvalidHashError if wrapped hash doesnt begin
        # with orig_prefix.
...
# parts of passlib. they shouldnt be used as actual password schemes.
#=============================================================================
