...
#             env = field_info_from_config.get('env') or field.field_info.extra.get('env')
    ...
    pass
#                     warnings.warn(
#                         'aliases are no inter used by BaseSettings to define which environment variables to read. '
...
#                         d[field.alias] = env_val_built
                    ...
                    # field is complex and theres a value, decode that as JSON, then add explode_env_vars
                    try:
...
#                 path = find_case_path(secrets_path, env_name, settings.__config__.case_sensitive)
    ...
    pass
    pass
                    # path does not exist, we currently dont return a warning for this
#                     continue
                if path.is_file():
    pass
    pass
...
#     Find a file within paths directory matching filename, optionally ignoring case.
