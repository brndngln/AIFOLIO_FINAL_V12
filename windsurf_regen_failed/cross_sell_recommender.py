...
#         body = f"Hi! As a valued customer, heres a cross-sell offer for you. {offer}"
#         log_path = os.path.abspath(
#             os.path.join(
#                 os.path.dirname(__file__), "../analytics/cross_sell_offers.json"
#             )
#         )
#         entry = {
...
#                     logging.error(
#                         f"[AIFOLIO] Failed to send cross-sell offer: {resp.status_code} {resp.text}"
#                     )
            else:
...
#                 print(
#                     f"[AIFOLIO] Cross-sell offer logged for {buyer_email} (no SENDGRID_API_KEY)"
#                 )
