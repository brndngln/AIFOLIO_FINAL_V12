...
def parse_text(text: str, text_format: type[TextFormatT] | NotGiven) -> Optional[TextFormatT]:
...
def get_input_tool_by_name(*, input_tools: Iterable[ToolParam], name: str) -> Optional[FunctionToolParam]:
