...
#             )
    ...
    pass
                ...
                # indicates that the previous master that were still connected
                # to has been demoted to a slave and theres a new master.
...
#     When querying a sentinel, if it doesnt meet this threshold, responses
    from that sentinel wont be considered valid.
...
#         **connection_kwargs,
#     ):
        # if sentinel_kwargs isnt defined, use the socket_* options from
        # connection_kwargs
...
#             )
    ...
    pass
            return False
        # Check if our sentinel doesnt see other nodes
...
#         Asks sentinel servers for the Redis masters address corresponding
...
#         used to retrieve the masters address before establishing a new
#         connection.
#         NOTE: If the masters address has changed, any cached connections to
...
#         A SentinelConnectionPool class is used to retrieve the slaves
