...
#     Mask2Formers pixel decoder module output, practically a Multi-Scale Deformable Attention based decoder. It returns
...
#     Mask2Formers pixel level module output. It returns the output of the encoder (optional) and all hidden states
...
#         spatial_shapes = torch.as_tensor(spatial_shapes, dtype=torch.int, device=input_embeds_flat.device)
...
#     The Mask2Formers transformer module.
