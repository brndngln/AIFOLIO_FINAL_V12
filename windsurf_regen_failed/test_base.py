...
# value of the fixture can be overridden this way even if the test doesnt use
# it directly (doesnt mention it in the function prototype).
...
#     "freq",
#     [
#         pytest.param("M", marks=pytest.mark.xfail(reason="Dont know why this fails")),
#         "D",
#         "H",
#     ],
# )
...
def test_resample_empty_dtypes(index, dtype, resample_method):
    ...
    # them to ensure they no inter do.  (GH #10228)
