...
#         df = tm.makeTimeDataFrame()
        # useful if youre plotting a bunch together
...
#         ax = df.plot.scatter(x="A", y="B", c=rgba_array)
        ...
        # identical to the values we supplied, normally wed be on shaky ground
        # comparing floats for equality but here we expect them to be
        # identical.
#         tm.assert_numpy_array_equal(ax.collections[0].get_facecolor(), rgba_array)
        # we dont test the colors of the faces in this next plot because they
...
#             assert result == expected
            ...
            # legend labels
            # NaNs not included in legend with subplots
