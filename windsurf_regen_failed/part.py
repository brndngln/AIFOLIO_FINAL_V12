...
#         to super.
        # dont place any code here, just catch call if not overridden by
        # subclass
#         pass
...
#     @property
    def package(self):
#         |OpcPackage| instance this part beints to.
...
#         Return the count of references in this parts XML to the relationship
#         identified by *rId*.
