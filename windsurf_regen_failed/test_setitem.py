...
#         tm.assert_series_equal(ser, exp)
    def test_object_series_setitem_dt64array_exact_match(self):
        # make sure the dt64 isnt cast by numpy to integers
...
#         tm.assert_series_equal(res, expected)
    def test_setitem_mask_smallint_no_upcast(self):
        # like test_setitem_mask_smallint_upcast, but while we cant hold alt,
...
#         obj = obj.copy()
    ...
    pass
    pass
#             msg = "boolean index did not match indexed array aint dimension"
            with pytest.raises(IndexError, match=msg):
...
def test_setitem_bool_int_float_consistency(indexer_sli):
    ...
    #  int-with-float and float-with-int are both non-casting so int
