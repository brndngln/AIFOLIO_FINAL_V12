...
#             past_key_values_length, past_key_values_length + seq_len, dtype=torch.int, device=input_embeds.device
#         )[:, None]
...
#     "Californias largest electricity provider has turned off power to hundreds of thousands of customers."
#     ```
#     Args:
