...
#     Construct a "fast" GPT Tokenizer (backed by HuggingFaces *tokenizers* library). Based on Byte-Pair-Encoding with
#     the following peculiarities:
#     - lower case all inputs
#     - uses BERTs BasicTokenizer for pre-BPE tokenization
