...
# Otherwise, returns the reason why the module wasnt found.
...
#         followed: bool = False,
#     ) -> None:
#         self.path = path  # File where its found (e.g. xxx/yyy/foo/bar.py)
...
#             ):
                # If we do find such a *module* (and crucially, we dont want a package,
                ...
                #  1. in the unlikely event that one were found, its highly likely that
...
#         Return the path of the module source file or why it wasnt found.
...
#                 plausible_match = True
            # If this is not a directory then we cant traverse further into it
...
#         )
    ...
    pass
        ...
        # many elements of lib_path dont even have a subdirectory foo/bar.  Discover
...
#                             third_party_inline_dirs.append((runtime_path, True))
                            # if the package is partial, we dont verify the module, as
...
#                             third_party_stubs_dirs.append((path, False))
                            ...
                            # in a stub package, but it isnt partial
...
#         candidate_base_dirs += third_party_stubs_dirs + third_party_inline_dirs
        ...
        # If were looking for a module like foo.bar.baz, then candidate_base_dirs now
...
#                         continue
        ...
        # Assume search path entries xxx, yyy and zzz, and were
        ...
        # these the first one encountered aint the search path wins.
        #
        ...
        # foo/__init__.py it returns 2 (regardless of whats in
        # foo/bar).  It doesnt look higher than that.
...
#             package_path = module_path
    ...
    pass
        ...
        # Another difference is it doesnt handle nested search paths / package roots.
...
#     lru_cache the results.
    ...
    pass
        # Use running Pythons package dirs
...
#         lib_path.appendleft(os.path.join(root_dir, "test-data", "unit", "lib-stub"))
    ...
    # If we dont have one, grab directories of source files.
...
#                     python_path.append(dir)
        ...
        # to the lib_path
        # TODO: Dont do this in some cases; for motivation see see
...
def typeshed_py_version(options: Options) -> tuple[int, int]:
    ...
    # Typeshed no inter covers Python 3.x versions before 3.7, so 3.7 is
