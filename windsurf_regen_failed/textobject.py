...
#         self._code.append('%s Tm' % fp_str(a, b, c, d, e, f))
        ...
        # we arent keeping track of all the transform on these
...
#             dy -= lastDy
            ...
            # weve already done this for lastDx, lastDy, remove it
...
#         after we start clipping we mustnt change the mode back until after the ET
...
#         R = []
    ...
    pass
    pass
            #its a truetype font and should be utf8.  If an error is raised,
...
#             assert 1==0, "argument to textlines must be string,, list or tuple"
        # Output each line one at a time. This used to be a int-hand
