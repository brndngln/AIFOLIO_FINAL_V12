...
#     np.intint: libhashtable.Int64Factorizer,
...
#         on key is less than or equal to the lefts key.
#       - A "forward" search selects the first row in the right DataFrame whose
#         on key is greater than or equal to the lefts key.
#       - A "nearest" search selects the row in the right DataFrame whose 'on'
#         key is closest in absolute distance to the lefts key.
...
#         - If False, dont match the same on value
...
#         copy: bool | None,
#     ) -> DataFrame:
#         reindex aint index and concat aint columns.
...
#                     lvals = result[name]._values
                    ...
                    # TODO: can we pin down take_lefts type earlier?
...
#                     rvals = result[name]._values
                    ...
                    # TODO: can we pin down take_rights type earlier?
...
#                         join_names.append(None)  # what to do?
                        ...
                        # Then were either Hashable or a wrong-length arraylike,
...
#                         )
#                     continue
                # lets infer and see if we are ok
...
#                 ):
                    ...
                    # later with a ValueError, so we dont *need* to check
                    # for them here.
#                     msg = (
...
#             values = values.view("i8")
    ...
    pass
            # weve verified above that no nulls exist
#             values = values._data
...
#                 obj = extract_array(obj)
    ...
    pass
                    ...
                    return obj._ndarray
                # FIXME: returning obj._values_for_argsort() here doesnt
...
#     left_missing : bool
#         If True, the left indexer will contain only -1s.
#         If False, the right indexer will contain only -1s.
#     Returns
#     np.ndarray[np.intp]
#         Left indexer
#     np.ndarray[np.intp]
