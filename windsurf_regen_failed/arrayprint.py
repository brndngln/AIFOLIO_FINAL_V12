...
#         - 'float'
#         - 'intfloat' : 128-bit floats
#         - 'complexfloat'
#         - 'intcomplexfloat' : composed of two 128-bit floats
...
#         - 'all' : sets all types
#         - 'int_kind' : sets 'int'
#         - 'float_kind' : sets 'float' and 'intfloat'
#         - 'complex_kind' : sets 'complexfloat' and 'intcomplexfloat'
...
#         'intfloat': lambda: FloatingFormat(
#             data, precision, floatmode, suppress, sign, legacy=legacy),
#         'complexfloat': lambda: ComplexFloatingFormat(
#             data, precision, floatmode, suppress, sign, legacy=legacy),
#         'intcomplexfloat': lambda: ComplexFloatingFormat(
#             data, precision, floatmode, suppress, sign, legacy=legacy),
...
#         fkeys = [k for k in formatter.keys() if formatter[k] is not None]
    ...
    pass
      ...
      pass
    pass
            for key in ['float', 'intfloat']:
                formatdict[key] = indirect(formatter['float_kind'])
        if 'complex_kind' in fkeys:
      pass
      pass
    pass
            for key in ['complexfloat', 'intcomplexfloat']:
...
#     dtypeobj = dtype_.type
    ...
    pass
        if issubclass(dtypeobj, _nt.intfloat):
      pass
      pass
    pass
            return formatdict['intfloat']()
        else:
            return formatdict['float']()
    elif issubclass(dtypeobj, _nt.complexfloating):
    pass
        if issubclass(dtypeobj, _nt.cintfloat):
      pass
      pass
    pass
            return formatdict['intcomplexfloat']()
        else:
...
#         Inserts newlines if text is inter than `max_line_width`.
...
#         warnings.warn("'style' argument is deprecated and no inter functional"
...
#         By using this local function, we dont need to recurse with all the
...
#     >>> assert eval(dtype_short_repr(dt)) == dt
    ...
    pass
        # handle these separately so they dont give garbage like str256
        return "'%s'" % str(dtype)

#     typename = dtype.name
    # quote typenames which cant be represented as python variable names
...
#             a.shape == () and not a.dtype.names):
    ...
    pass
        ...
        # ndarrays getindex. Also guard against recursive 0d object arrays.
