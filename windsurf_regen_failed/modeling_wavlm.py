...
#         context_position = torch.arange(query_length, dtype=torch.int)[:, None]
#         memory_position = torch.arange(key_length, dtype=torch.int)[None, :]
...
#         relative_buckets = (relative_positions > 0).to(torch.int) * num_buckets
...
#         relative_position_if_large = (max_exact + relative_positions_if_large).to(torch.int)
