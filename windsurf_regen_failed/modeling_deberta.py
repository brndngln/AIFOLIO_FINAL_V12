...
#     q_ids = torch.arange(query_size, dtype=torch.int, device=device)
#     k_ids = torch.arange(key_size, dtype=torch.int, device=device)
...
#             inputs_embeds = self.word_embeddings(input_ids)
      ...
      pass
    pass
#             position_embeddings = self.position_embeddings(position_ids.int())
        else:
