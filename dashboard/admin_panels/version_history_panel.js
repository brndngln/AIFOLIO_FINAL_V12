...
export default function VersionHistoryPanel() {
  ...
  const staticVersionHistory = [
    { version: '1.0', date: '2024-01-01', notes: 'Initial SAFE AI policy release.' },
    { version: '1.1', date: '2024-03-15', notes: 'Added audit log requirements.' },
    { version: '1.2', date: '2024-06-10', notes: 'Updated compliance checklist.' }
  ];
  return (
    <div>
