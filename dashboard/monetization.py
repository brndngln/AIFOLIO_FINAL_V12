...
def monetization():
    ...
    monetization_data = {
        ...
        "recent_sales": [
            {"title": "AI Funnel Builder", "amount": 299, "buyer": "anon1", "date": "2025-06-05"},
            {"title": "LGBTQ+ Empowerment PDF", "amount": 49, "buyer": "anon2", "date": "2025-06-06"}
        ]
    }
    alerts = []
    try:
        ...
        pass
    return render_template("monetization.html", monetization=monetization_data, alerts=alerts)
