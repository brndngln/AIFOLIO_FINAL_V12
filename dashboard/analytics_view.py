...
NOTION_PUSH_PATH = os.path.join(os.path.dirname(__file__), '../integrations/notion_push.py')
...
class AnalyticsView:
    ...
    def get_dashboard_data():
        ...
        data = {
            ...
            'read_time': 6821,
            'top_pdfs': [
                {'title': 'Elite Vault 1', 'revenue': 12000, 'refunds': 1, 'read_time': 1200},
                {'title': 'Elite Vault 2', 'revenue': 9000, 'refunds': 0, 'read_time': 1100},
            ],
            ...
            'cta_engagement': 0.85,
            'optimization_flags': ['CTA text could be improved', 'Visuals too dense on p.4'],
        }
        # Load issue log
