<template>
  <div class="vault-ui contentdrop">
    ...
    <form @submit.prevent="generate">
      <input v-model="user_segment" placeholder="Enter your segment (e.g. Newsletter Subscribers)" required />
...
export default {
  ...
  methods: {
    async generate() {
      const pdf = await generateContentDrop({ user_segment: this.user_segment })
