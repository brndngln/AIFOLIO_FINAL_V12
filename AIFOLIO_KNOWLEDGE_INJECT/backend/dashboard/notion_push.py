    ...
    try:
        ...
        data = {
            ...
            "properties": {
                ...
                "Description": {
                    "rich_text": [{"text": {"content": vault_data["description"]}}]
                },
                "Summary": {
                    "rich_text": [{"text": {"content": vault_data.get("summary", "")}}]
                },
                "Revenue": {
                    "rich_text": [
                        {"text": {"content": vault_data.get("revenue_blurb", "")}}
                    ]
                },
                "Chapters": {
                    "rich_text": [
                        {"text": {"content": ", ".join(vault_data["chapters"])}}
                    ]
                },
