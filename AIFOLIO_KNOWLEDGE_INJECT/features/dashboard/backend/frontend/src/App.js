...
function Phase9AuditLogPreview() {
  ...
  return (
    ...
    >
      ...
      <pre style={{ fontSize: 12, margin: 0, background: "none", padding: 0 }}>
...
function App() {
  ...
  return (
    <div style={{ padding: 20 }}>
      <h1>
        AIFOLIO Event Dashboard <Phase9ApiStatus />
      </h1>
      <div
      ...
      >
        ...
        <button onClick={() => setView("phase8")}>
          SAFE AI Phase 8 Modules
        </button>
        <button onClick={() => setView("phase9")}>
          SAFE AI Phase 9+ Empire Modules
        </button>
      </div>
