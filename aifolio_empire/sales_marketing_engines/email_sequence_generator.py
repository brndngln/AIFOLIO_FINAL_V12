    ...
    def _get_email_templates(self, sequence_type: str, niche: str, product_name: Optional[str] = None) -> List[Dict[str, str]]:
        ...
        templates = {
            ...
            "launch": [
                ...
                {"subject": f"Last Chance: {pn} Launch Discount!", "body": f"Don't miss out! {pn} is launching with a special discount for early birds. Valid for 24 hours only (simulated).\n\nGrab it now!\nOffers Dept"}
            ],
            "urgency": [
