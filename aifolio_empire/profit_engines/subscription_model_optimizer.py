...
STATIC_SUBSCRIPTION_MODELS = [
    {'name': 'Pro PDF Club', 'price': 39, 'features': ['Monthly PDF Drop', 'VIP Support', 'Early Access']},
    {'name': 'Elite Bundle Access', 'price': 99, 'features': ['Quarterly Bundles', 'Exclusive Offers', 'Brand Audit']}
]
...
def optimize_subscription_models() -> dict:
    ...
    result = {
        'models': STATIC_SUBSCRIPTION_MODELS,
        'test_matrix': STATIC_TEST_MATRIX
    }
