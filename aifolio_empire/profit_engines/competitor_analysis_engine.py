...
STATIC_COMPETITORS = [
    {'name': 'PDFPro', 'strengths': ['SEO', 'Brand'], 'gaps': ['Tax Content', 'Security']},
    {'name': 'NicheDocs', 'strengths': ['Niche Depth'], 'gaps': ['Bundling', 'Refund Optimization']},
    {'name': 'Brandify', 'strengths': ['Marketing Funnels'], 'gaps': ['Compliance', 'Audit Logs']}
]
...
def analyze_competitors() -> dict:
    ...
    result = {
        ...
        'market_gaps': STATIC_MARKET_GAPS
    }
