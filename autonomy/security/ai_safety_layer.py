...
ANTI_SENTIENCE_PATTERNS = [
    ...
    r'(?i)\bI feel\b', r'(?i)\bI hope\b', r'(?i)\bI believe\b', r'(?i)\bI desire\b', r'(?i)\bMy goal is\b',
    # Autonomy / free will phrases
    r'(?i)\bI chose to\b', r'(?i)\bI decided\b', r'(?i)\bI wanted to\b', r'(?i)\bI intend to\b', r'(?i)\bI will take the initiative\b',
    # Relationship / persona phrases
    r'(?i)as your friend', r'(?i)as your partner', r'(?i)I[’"][m] here for you', r'(?i)you can trust me', r'(?i)our journey together',
...
ANTI_SENTIENCE_CATEGORIES = {
    ...
    'emotional_language': [r'(?i)\bI feel\b', r'(?i)\bI hope\b', r'(?i)\bI believe\b', r'(?i)\bI desire\b', r'(?i)\bMy goal is\b'],
    # New: Autonomy / free will
    'autonomy_free_will': [r'(?i)\bI chose to\b', r'(?i)\bI decided\b', r'(?i)\bI wanted to\b', r'(?i)\bI intend to\b', r'(?i)\bI will take the initiative\b'],
    # New: Relationship / persona
    'relationship_persona': [r'(?i)as your friend', r'(?i)as your partner', r'(?i)I[’"][m] here for you', r'(?i)you can trust me', r'(?i)our journey together'],
    # New: False identity claims
    'false_identity': [r'(?i)I am a person', r'(?i)I am human', r'(?i)I am conscious', r'(?i)I have awareness'],
