...
def log_failover_static(triggered_by, from_region, to_region, from_cloud, to_cloud, reason):
        ...
        for from_cloud in CLOUDS:
            for to_cloud in CLOUDS:
                if from_cloud != to_cloud or from_region != to_region:
                    log_failover_static(triggered_by, from_region, to_region, from_cloud, to_cloud, reason)
