...
def static_funnel_report(funnel_data):
    ...
    return {
        ...
        'view_to_cart_rate': (funnel_data.get('add_to_cart', 0) / funnel_data.get('views', 1)) * 100 if funnel_data.get('views', 0) else 0,
        'cart_to_purchase_rate': (funnel_data.get('purchases', 0) / funnel_data.get('add_to_cart', 1)) * 100 if funnel_data.get('add_to_cart', 0) else 0
    }
