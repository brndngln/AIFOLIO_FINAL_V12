...
JUNK_PATTERNS = [
    r'finalcopy\d*', r'untitled', r'copy\(\d+\)', r'document', r'temp', r'copy', r'final', r'\s+', r'_+', r'-+', r'\.+', r'\(\d+\)'
]
...
def enforce_safe_filename(filepath: str, vault_title: str, metadata_path: str = None) -> str:
    """
