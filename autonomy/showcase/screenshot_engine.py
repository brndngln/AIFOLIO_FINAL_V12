...
AUDIT_LOG_PATH = os.path.join(os.path.dirname(__file__), 'screenshot_audit_log.json')
...
def generate_pdf_screenshots(vault_path: str, num_pages: int = 2, watermark: str = "AIFOLIO", owner_override: List[str] = None) -> List[str]:
    """
    ...
    if owner_override:
        ...
        audit_log('GENERATE_SCREENSHOTS', {'vault_path': vault_path, 'screenshots': screenshots, 'watermark': watermark})
