...
VIOLATIONS_PATH = os.path.join(os.path.dirname(__file__), '../../dashboard/legal_audit.json')
...
class LegalReview:
    ...
    def check_pdf(pdf_path):
        try:
            ...
            LegalReview._log({'pdf': pdf_path, 'error': str(e), 'timestamp': datetime.utcnow().isoformat(), 'status': 'WARN', 'type': 'legal'})
