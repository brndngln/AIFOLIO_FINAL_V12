...
ALERT_LOG = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../analytics/vault_alert_log.jsonl'))
...
if __name__ == "__main__":
    send_vault_alert({'event': 'vault_created', 'vault_id': 'vault123', 'user_id': 'user456'}, channel='slack')
