...
MONITOR_LOG = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../analytics/synthetic_monitor_log.jsonl'))
os.makedirs(os.path.dirname(MONITOR_LOG), exist_ok=True)

USER_FLOWS = [
    {'name': 'buy_vault', 'steps': ['visit_home', 'select_vault', 'checkout', 'download']},
