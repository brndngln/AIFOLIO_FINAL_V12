...
EMAIL_LOG = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../analytics/failsafe_email_log.jsonl'))
...
def correct_email_typo(email):
    ...
    corrections = {'gamil.com': 'gmail.com', 'hotmial.com': 'hotmail.com', 'yaho.com': 'yahoo.com'}
