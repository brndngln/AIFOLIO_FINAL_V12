...
def handle_event(payload):
    ...
    try:
        ...
        email_subject = f"[AIFOLIO] Refund Issued for Vault {payload.get('vault_id', '')}"
    ...
    try:
        log_vault_event(payload.get('vault_id', 'unknown'), 'refund_issued', {**payload, 'ai_results': ai_results}, errors)
    except Exception as e:
