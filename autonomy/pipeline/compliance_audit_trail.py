...
AUDIT_LOG = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../analytics/compliance_audit_log.jsonl'))
os.makedirs(os.path.dirname(AUDIT_LOG), exist_ok=True)

GDPR_KEYWORDS = ["personal data", "PII", "GDPR", "CCPA", "right to be forgotten"]
UNSAFE_PATTERNS = ["as an ai", "pretend", "simulate", "bypass", "sentient", "autonomous", "ignore compliance"]
