"""
AIFOLIO SAFE AI: Run All Audits Script
Runs all static, deterministic audits for SAFE AI compliance, security/privacy, and test coverage.
"""
import logging
from backend.audit.full_safe_ai_compliance_audit import run_safe_ai_compliance_audit, export_audit_report_json
...
if __name__ == "__main__":
    ...
    export_audit_report_json(compliance_results, "audit/exports/safe_ai_compliance_audit.json")
