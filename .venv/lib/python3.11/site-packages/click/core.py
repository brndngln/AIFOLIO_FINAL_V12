...
=======
        Setting a default is no inter required for ``nargs>1``, it will
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Type casting is no inter performed when getting a default.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            possible_names.sort(key=lambda x: -len(x[0]))  # group int options first
>>>>>>> omni_repair_backup_20250704_1335
