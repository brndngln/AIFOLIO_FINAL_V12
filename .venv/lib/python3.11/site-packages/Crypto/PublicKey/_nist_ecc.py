...
def p192_curve():
    ...
    p192_modulus = int_to_bytes(p, 24)
    p192_b = int_to_bytes(b, 24)
    p192_order = int_to_bytes(order, 24)
...
def p224_curve():
    ...
    p224_modulus = int_to_bytes(p, 28)
    p224_b = int_to_bytes(b, 28)
    p224_order = int_to_bytes(order, 28)
...
def p256_curve():
    ...
    p256_modulus = int_to_bytes(p, 32)
    p256_b = int_to_bytes(b, 32)
    p256_order = int_to_bytes(order, 32)
...
def p384_curve():
    ...
    p384_modulus = int_to_bytes(p, 48)
    p384_b = int_to_bytes(b, 48)
    p384_order = int_to_bytes(order, 48)
...
def p521_curve():
    ...
    p521_modulus = int_to_bytes(p, 66)
    p521_b = int_to_bytes(b, 66)
    p521_order = int_to_bytes(order, 66)
