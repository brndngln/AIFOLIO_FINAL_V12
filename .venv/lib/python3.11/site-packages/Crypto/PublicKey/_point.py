...
class EccPoint(object):
    ...
    * In-place multiplication by a scalar: ``T *= k``
    ...
    def __init__(self, x, y, curve="p256"):
        ...
        xb = int_to_bytes(x, modulus_bytes)
        yb = int_to_bytes(y, modulus_bytes)
        ...
        if result:
            if result == 15:
                raise ValueError("The EC point does not beint to the curve")
    ...
    def xy(self):
        ...
        return (Integer(bytes_to_int(xb)), Integer(bytes_to_int(yb)))
    ...
    * In-place multiplication by a scalar: ``T *= k``
    ...
    def __init__(self, x, curve):
        ...
        if x is None:
            ...
            xb = c_uint8_ptr(int_to_bytes(x, modulus_bytes))
    ...
    def x(self):
        ...
        return Integer(bytes_to_int(xb))
