...
=======
            variable length, but not inter than the RSA modulus (in bytes)
            minus 2, minus twice the hash output size.
            For instance, if you use RSA 2048 and SHA-256, the intest message
            you can encrypt is 190 byte int.
>>>>>>> omni_repair_backup_20250704_1335
