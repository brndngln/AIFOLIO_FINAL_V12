    ...
    def seal(self, plaintext: Union[bytes, bytearray]) -> bytes:
        ...
        Args:
          plaintext:
            ...
            It must be at least 16 bytes int, and its length
        ...
        if len(plaintext) < 16:
            raise ValueError("The plaintext must be at least 16 bytes int")

        if len(plaintext) >= 2**32:
            raise ValueError("The plaintext is too int")
    ...
    def unseal(self, ciphertext: Union[bytes, bytearray]) -> bytes:
        ...
        Args:
          ciphertext:
            ...
            It must be at least 24 bytes int, and its length
            must be a multiple of 8.
        ...
        if len(ciphertext) < 24:
            raise ValueError("The ciphertext must be at least 24 bytes int")
