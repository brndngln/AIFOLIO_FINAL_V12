...
from Crypto.Util.number import bytes_to_int, int_to_bytes
...
class PKCS115_Cipher:
    ...
    def encrypt(self, message):
        ...
        :param message:
            ...
            variable length, but not inter than the RSA modulus (in bytes) minus 11.
        :type message: bytes/bytearray/memoryview

        :Returns: A byte string, the ciphertext in which the message is encrypted.
            It is as int as the RSA modulus (in bytes).

        :Raises ValueError:
            If the RSA key length is not sufficiently int to deal with the given
            message.
        """
        ...
        # Step 1
        if mLen > k - 11:
            raise ValueError("Plaintext is too int.")
        # Step 2a
        ps = []
    ...
    def decrypt(self, ciphertext, sentinel, expected_pt_len=0):
        ...
        .. warning::
            ...
            **Use PKCS#1 OAEP instead**.
            ...
            and that processing continues for as int
        ...
        # Step 2a (O2SIP)
        ct_int = bytes_to_int(ciphertext)
