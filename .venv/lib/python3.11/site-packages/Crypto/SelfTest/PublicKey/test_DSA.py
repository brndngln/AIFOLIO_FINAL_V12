...
=======
        global DSA, Random, bytes_to_int, size
        from Crypto.PublicKey import DSA
        from Crypto import Random
        from Crypto.Util.number import bytes_to_int, inverse, size
...
=======
        (y, g, p, q) = [bytes_to_int(a2b_hex(param)) for param in (self.y, self.g, self.p, self.q)]
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        (y, g, p, q, x) = [bytes_to_int(a2b_hex(param)) for param in (self.y, self.g, self.p, self.q, self.x)]
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        k = bytes_to_int(a2b_hex(self.k))
        m_hash = bytes_to_int(a2b_hex(self.m_hash))
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        k = bytes_to_int(a2b_hex(self.k))
        m_hash = bytes_to_int(a2b_hex(self.m_hash))
        r = bytes_to_int(a2b_hex(self.r))
        s = bytes_to_int(a2b_hex(self.s))
>>>>>>> omni_repair_backup_20250704_1335
