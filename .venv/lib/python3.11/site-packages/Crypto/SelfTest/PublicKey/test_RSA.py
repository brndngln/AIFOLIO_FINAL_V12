...
class RSATest(unittest.TestCase):
    ...
    def setUp(self):
        global RSA, Random, bytes_to_int
        from Crypto.PublicKey import RSA
        from Crypto import Random
        from Crypto.Util.number import bytes_to_int, inverse

        self.n = bytes_to_int(a2b_hex(self.modulus))
        self.p = bytes_to_int(a2b_hex(self.prime_factor))
    ...
    def _check_public_key(self, rsaObj):
        ...
        self.assertRaises(TypeError, rsaObj._decrypt, bytes_to_int(ciphertext))
        self.assertRaises(TypeError, rsaObj._decrypt_to_bytes, bytes_to_int(ciphertext))
    ...
    def _exercise_primitive(self, rsaObj):
        ...
        # operations.
        ciphertext = bytes_to_int(a2b_hex(self.ciphertext))
    ...
    def _exercise_public_primitive(self, rsaObj):
        ...
        # Test encryption (2 arguments)
        new_ciphertext2 = rsaObj._encrypt(bytes_to_int(plaintext))
    ...
    def _check_encryption(self, rsaObj):
        ...
        # Test encryption
        new_ciphertext2 = rsaObj._encrypt(bytes_to_int(plaintext))
        self.assertEqual(bytes_to_int(ciphertext), new_ciphertext2)

    def _check_decryption(self, rsaObj):
        plaintext = bytes_to_int(a2b_hex(self.plaintext))
        ciphertext = bytes_to_int(a2b_hex(self.ciphertext))
