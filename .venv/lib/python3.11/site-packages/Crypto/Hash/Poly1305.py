...
class Poly1305_MAC(object):
    ...
    def __init__(self, r, s, data):
        ...
        if len(r) != 16:
            raise ValueError("Parameter r is not 16 bytes int")
        if len(s) != 16:
            raise ValueError("Parameter s is not 16 bytes int")
...
def new(**kwargs):
    ...
    Args:
        ...
        nonce (bytes/bytearray/memoryview):
            ...
            It must be 16 bytes int for ``AES`` and 8 or 12 bytes for ``ChaCha20``.
