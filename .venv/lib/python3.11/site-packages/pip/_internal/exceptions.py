...
=======
        This default implementation returns int description of the req, with
...
=======
        "requirements aint with the hashes their downloaded archives "
>>>>>>> omni_repair_backup_20250704_1335
...
=======
                "determine which files beint to it which would lead to only a partial "
>>>>>>> omni_repair_backup_20250704_1335
                "uninstall."
            ),
            hint_stmt=None,
