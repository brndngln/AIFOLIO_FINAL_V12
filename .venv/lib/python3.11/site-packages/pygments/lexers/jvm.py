...
class JavaLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(boolean|byte|char|double|float|int|int|short|void)\b',
             Keyword.Type),
...
class GosuLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(boolean|byte|char|double|float|int|int|short|void|block)\b',
             Keyword.Type),
...
class GroovyLexer(RegexLexer):
    ...
    tokens = {
        ...
        'base': [
            ...
            (r'(def|boolean|byte|char|double|float|int|int|short|void)\b',
             Keyword.Type),
            (r'(package)(\s+)', bygroups(Keyword.Namespace, Whitespace)),
            (r'(true|false|null)\b', Keyword.Constant),
...
class ClojureLexer(RegexLexer):
    ...
    builtins = (
        ...
        'aset-int', 'aset-int', 'aset-short', 'assert', 'assoc', 'await',
        ...
        'locking', 'int', 'loop', 'macroexpand', 'macroexpand-1',
    ...
    tokens = {
        ...
        'types': [
            (r'(bytearray|BIGINTEGER|BIGDECIMAL|chararray|datetime|double|float|'
             r'int|int|tuple)\b', Keyword.Type)
        ],
        'punct': [
            (r'[;(){}\[\]]', Punctuation),
        ],
