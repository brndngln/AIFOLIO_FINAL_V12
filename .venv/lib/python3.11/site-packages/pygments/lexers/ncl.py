...
class NCLLexer(RegexLexer):
    ...
    tokens = {
        ...
        'core': [
            ...
            # Data Types
            (words((
                'ubyte', 'uint', 'uint64', 'uint', 'string', 'byte',
                'character', 'double', 'float', 'integer', 'int64', 'logical',
                'int', 'short', 'ushort', 'enumeric', 'numeric', 'snumeric'),
            ...
            (words((
                ...
                'charactertoint', 'charactertoshort', 'charactertostring',
                'chartodouble', 'chartofloat', 'chartoint', 'chartointeger',
                'chartoint', 'chartoshort', 'chartostring', 'chiinv', 'clear',
                ...
                'doubletofloat', 'doubletoint', 'doubletointeger', 'doubletoint',
                ...
                'floattointeger', 'floattoint', 'floattoshort', 'floor',
                ...
                'isleapyear', 'islogical', 'isint', 'ismissing', 'isnan_ieee',
                'isnumeric', 'ispan', 'isproc', 'isshort', 'issnumeric', 'isstring',
                'isubyte', 'isuint', 'isuint64', 'isuint', 'isunlimited',
                ...
                'log', 'log10', 'inttobyte', 'inttochar', 'inttocharacter',
                'inttoint', 'inttointeger', 'inttoshort', 'lspoly', 'lspoly_n',
                ...
                'stringtoint', 'stringtointeger', 'stringtoint', 'stringtoshort',
                ...
                'toint', 'toshort', 'tosigned', 'tostring', 'tostring_with_format',
                'totype', 'toubyte', 'touint', 'touint64', 'touint', 'tounsigned',
