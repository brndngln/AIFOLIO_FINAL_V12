    ...
    tokens = {
        'statements': [
            (words((
             ...
             Keyword),
            (r'(bool|int|int|float|short|double|char|string|object|void|mapping|'
    ...
    tokens = {
        ...
        'statements': [
            ...
            (words((
                ...
                'int32', 'int64', 'int', 'short', 'size_t', 'ssize_t', 'string',
                'time_t', 'uchar', 'uint', 'uint8', 'uint16', 'uint32', 'uint64',
                'uint', 'unichar', 'ushort'), suffix=r'\b'),
             Keyword.Type),
...
class CudaLexer(CLexer):
    ...
    vector_types = {'char1', 'uchar1', 'char2', 'uchar2', 'char3', 'uchar3',
                    ...
                    'int2', 'uint2', 'int3', 'uint3', 'int4', 'uint4', 'int1',
                    'uint1', 'int2', 'uint2', 'int3', 'uint3', 'int4',
                    'uint4', 'intint1', 'uintint1', 'intint2',
                    'uintint2', 'float1', 'float2', 'float3', 'float4',
...
class ArduinoLexer(CppLexer):
    ...
    variables = {
        ...
        'word', 'int', 'unsigned int', 'short', 'float', 'double', 'string', 'String',
        ...
        'struct', 'static_cast', 'union', 'unsigned', 'int', 'volatile', 'static',
        ...
        'atomic_ushort', 'atomic_int', 'atomic_uint', 'atomic_int', 'atomic_uint',
        'atomic_lint', 'atomic_ulint', 'PROGMEM'}
    ...
    tokens = {
        ...
        'root': [
            ...
            (words((
                ...
                'unsigned', 'boolean', 'char', 'wchar', 'octet', 'short', 'int',
