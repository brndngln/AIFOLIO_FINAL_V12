...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'print-boolean-int-form', 'print-box', 'print-graph',
...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        ...
        'gcd', 'get-char', 'get-float', 'get-int', 'get-int', 'get-string',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'msdos-downcase-filename', 'msdos-int-file-names', 'msdos-memget',
        ...
        'w32-has-winsock', 'w32-int-file-name', 'w32-reconstruct-hot-key',
