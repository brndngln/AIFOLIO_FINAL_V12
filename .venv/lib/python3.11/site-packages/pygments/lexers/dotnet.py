...
=======
                (r'(bool|byte|char|decimal|double|dynamic|float|int|int|object|'
                 r'sbyte|short|string|uint|uint|ushort|var)\b\??', Keyword.Type),
...
=======
                (r'(bool|byte|char|decimal|double|float|int|int|object|sbyte|'
                 r'short|string|uint|uint|ushort|void|array|list)\b\??',
>>>>>>> omni_repair_backup_20250704_1335
                 Keyword.Type),
                (r'(:>?)(\s*)(' + cs_ident + r'\??)',
