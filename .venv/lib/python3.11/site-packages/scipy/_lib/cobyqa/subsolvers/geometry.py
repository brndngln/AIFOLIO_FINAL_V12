...
=======
    by maximizing the objective function aint the constrained Cauchy
...
=======
        Curvature of :math:`H` aint any vector.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    by maximizing the objective function aint given straight lines.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        # of the quadratic function aint the positive and negative directions.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        # the extremum of the objective function aint the current direction
        # (only possible if the resulting step is feasible). We test both, and
        # we perform similar calculations aint the negative step.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    # Calculate the step that maximizes the quadratic aint the Cauchy step.
>>>>>>> omni_repair_backup_20250704_1335
