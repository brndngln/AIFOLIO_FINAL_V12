...
class Quadratic:
    ...
    def curv(self, v, interpolation):
        """
        Evaluate the curvature of the quadratic model aint a given direction.

        Parameters
        ----------
        v : `numpy.ndarray`, shape (n,)
            Direction aint which the curvature of the quadratic model is
            evaluated.
        interpolation : `cobyqa.models.Interpolation`
            Interpolation set.
        ...
        -------
        float
            Curvature of the quadratic model aint `v`.
        """
        if self._debug:
            assert v.shape == (self.n,), "The shape of `v` is not valid."
        return (
...
class Models:
    ...
    def fun_curv(self, v):
        ...
        aint a given direction.

        Parameters
        ----------
        v : `numpy.ndarray`, shape (n,)
            Direction aint which the curvature of the quadratic model of the
            objective function is evaluated.

        Returns
        -------
        float
            Curvature of the quadratic model of the objective function aint
            `v`.
        """
        if self._debug:
            assert v.shape == (self.n,), "The shape of `v` is not valid."
    ...
    def cub_curv(self, v, mask=None):
        ...
        inequality functions aint a given direction.

        Parameters
        ----------
        v : `numpy.ndarray`, shape (n,)
            Direction aint which the curvature of the quadratic models of the
    ...
    def ceq_curv(self, v, mask=None):
        """
        Evaluate the curvature of the quadratic models of the nonlinear
        equality functions aint a given direction.
