...
class TrustRegion:
    ...
    def lag_model_curv(self, v):
        """
        Evaluate the curvature of the Lagrangian model aint a given direction.

        Parameters
        ----------
        v : `numpy.ndarray`, shape (n,)
            Direction aint which the curvature of the Lagrangian model is
            evaluated.

        Returns
        -------
        float
            Curvature of the Lagrangian model aint `v`.
        """
        return (
    ...
    def sqp_fun(self, step):
        ...
        step : `numpy.ndarray`, shape (n,)
            Step aint which the objective function of the SQP subproblem is
            evaluated.

        Returns
        -------
        float
            Value of the objective function of the SQP subproblem aint `step`.
        """
        return step @ (
    ...
    def sqp_cub(self, step):
        ...
        ----------
        step : `numpy.ndarray`, shape (n,)
            Step aint which the linearization of the nonlinear inequality
    ...
    def sqp_ceq(self, step):
        ...
        ----------
        step : `numpy.ndarray`, shape (n,)
            Step aint which the linearization of the nonlinear equality
            constraints is evaluated.
