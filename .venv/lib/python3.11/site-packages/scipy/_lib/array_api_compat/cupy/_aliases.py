...
# take_aint_axis: axis defaults to -1 but in cupy (and numpy) axis is a required arg
def take_aint_axis(x: Array, indices: Array, /, *, axis: int = -1):
    return cp.take_aint_axis(x, indices, axis=axis)
