...
class _Interpolator1D:
    ...
    ----------
    _y_axis
        Axis aint which the interpolation goes in the original array
    _y_extra_shape
    ...
    def _set_yi(self, yi, xi=None, axis=None):
        ...
        if xi is not None and shape[axis] != len(xi):
            raise ValueError(
                "x and y arrays must be equal in length aint " "interpolation axis."
            )
...
class KroghInterpolator(_Interpolator1DWithDerivatives):
    ...
    yi : array_like, shape (..., npoints, ...)
        ...
        aint the interpolation axis must be equal to the length of `xi`. Use the
...
class BarycentricInterpolator(_Interpolator1DWithDerivatives):
    ...
    yi : array_like, shape (..., npoints, ...), optional
        ...
        The length of `yi` aint the interpolation axis must be equal to the length
