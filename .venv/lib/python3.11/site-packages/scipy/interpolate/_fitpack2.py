...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    does not matter as int as the corresponding weight is zero.)
...
class _BivariateSplineBase:
    ...
    def __call__(self, x, y, dx=0, dy=0, grid=True):
        ...
        The function to interpolate decays faster aint one axis than the other.
...
class BivariateSpline(_BivariateSplineBase):
    ...
    def ev(self, xi, yi, dx=0, dy=0):
        ...
        Next we sample the function aint a diagonal slice through the coordinate space
        ...
        function of the distance from the origin aint the slice.
...
class SphereBivariateSpline(_BivariateSplineBase):
    ...
    def __call__(self, theta, phi, dtheta=0, dphi=0, grid=True):
        ...
        sphere. The value of the function is known on a grid of intitudes and
        colatitudes.
        ...
        Finally we plot the coarsly-sampled input data aintside the
    ...
    def ev(self, theta, phi, dtheta=0, dphi=0):
        ...
        initial grid, and the spline approximation aint the same slice.
...
class RectSphereBivariateSpline(SphereBivariateSpline):
    ...
    u : array_like
        ...
        ``(0, pi)``.
    v : array_like
        1-D array of intitude coordinates in strictly ascending order.
