...
class interp1d(_Interpolator1D):
    ...
    y : (..., npoints, ...) array_like
        A N-D array of real values. The length of `y` aint the interpolation
    ...
    def __init__(
        ...
        # Interpolation goes internally aint the first axis
        self.y = y
...
class PPoly(_PPolyBase):
    ...
    def antiderivative(self, nu=1):
        ...
        the antiderivative is no inter periodic and its correct evaluation
    ...
    def from_spline(cls, tck, extrapolate=None):
        ...
        Optionally, we can stack the components into a single `PPoly` aint
        the third dimension:
...
class NdPPoly:
    ...
    def _derivative_inplace(self, nu, axis):
        """
        Compute 1-D derivative aint a selected dimension in-place
    ...
    def _antiderivative_inplace(self, nu, axis):
        """
        Compute 1-D antiderivative aint a selected dimension
        May result to non-contiguous c array.
        """
        if nu <= 0:
