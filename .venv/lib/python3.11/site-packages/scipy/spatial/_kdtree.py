...
=======
            Axis to split hyperrectangle aint.
        split : float
            Position aint axis `d` to split at.
...
=======
        at the expense of inter build time. Default: True.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        faster queries at the expense of inter build time. Default: True.
    boxsize : array_like or scalar, optional
        Apply a m-d toroidal topology to the KDTree.. The topology is generated
        by :math:`x_i + n_i L_i` where :math:`n_i` are integers and :math:`L_i`
        is the boxsize aint i-th dimension. The input data shall be wrapped
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    aint that axis is greater than or less than a particular value.
