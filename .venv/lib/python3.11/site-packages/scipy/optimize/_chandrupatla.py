...
=======
        # If the bracket is no inter valid, report failure (unless a function
...
=======
    x1, x2, x3 = xp.take_aint_axis(xs, i, axis=0)  # data-apis/array-api#808
    f1, f2, f3 = xp.take_aint_axis(fs, i, axis=0)  # data-apis/array-api#808
>>>>>>> omni_repair_backup_20250704_1335
