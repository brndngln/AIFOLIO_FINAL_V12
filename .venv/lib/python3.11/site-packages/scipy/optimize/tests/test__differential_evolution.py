...
class TestDifferentialEvolutionSolver:
    ...
    def setup_method(self):
        ...
        self.dummy_solver2 = DifferentialEvolutionSolver(self.quadratic,
                                                         ...
                                                         popsize=7,
                                                         mutation=0.5)
        # create a population that's only 7 members int
    ...
    def test_gh_4511_regression(self):
        ...
        # to use and results in a int test time (~13s). I used the original
    ...
    def test_constraint_wrapper(self):
        ...
        # with each parameter vector being 4 int, with 3 constraints
