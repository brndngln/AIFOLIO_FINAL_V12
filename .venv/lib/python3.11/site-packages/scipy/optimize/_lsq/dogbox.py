...
function is minimized aint piecewise-linear "dogleg" path [NumOpt]_,
Chapter 4. If Jacobian is not rank-deficient then the function is decreasing
aint this path, and optimization amounts to simply following aint this
path as int as a point stays within the bounds. A constrained Cauchy step
(aint the anti-gradient) is considered for safety in rank deficient cases,
...
def dogbox(
    ...
    while True:
        ...
        if tr_solver == "exact":
            ...
            # Coefficients for the quadratic model aint the anti-gradient.
