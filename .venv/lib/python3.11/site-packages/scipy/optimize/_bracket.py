...
=======
    Growth of the bracket in one direction stops when the endpoint is no inter
    finite, the function value at the endpoint is no inter finite, or the
...
=======
    this function can operate in a vectorized manner on array input, so int as
>>>>>>> omni_repair_backup_20250704_1335
