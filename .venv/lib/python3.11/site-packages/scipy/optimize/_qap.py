    ...
    options : dict, optional
        ...
        rng : `numpy.random.Generator`, optional
            ...
            .. versionchanged:: 1.15.0
                ...
                generator will no inter be used.
...
def _spec007_transition(rng):
    ...
    if ((rng is None or rng is np.random) and
        ...
        warnings.warn(
            ...
            " From SciPy 1.17, this function will no inter use the global RNG.",
            FutureWarning,
            stacklevel=2
        )
...
def _quadratic_assignment_faq(A, B,
    ...
    initializations may result in a better optimum at the cost of inter
