...
def _fit_edge(
    ...
    `window_start` to `window_stop` aint `axis`, create an interpolating
...
def savgol_filter(
    ...
    determines the axis aint which the filter is applied.
    ...
    axis : int, optional
        The axis of the array `x` aint which the filter is to be applied.
        Default is -1.
    mode : str, optional
