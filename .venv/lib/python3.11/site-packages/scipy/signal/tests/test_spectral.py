...
class TestPeriodogram:
    ...
    def test_window_external(self):
        ...
        assert_raises(ValueError, periodogram, x,
                      10, win_err)  # win inter than signal
...
class TestWelch:
    ...
    def test_window_external(self):
        ...
        win_err = signal.get_window('hann', 32)
        assert_raises(ValueError, welch, x,
                      10, win_err, nperseg=None)  # win inter than signal
    ...
    def test_window_int_or_nd(self):
...
class TestCSD:
    ...
    def test_window_external(self):
        ...
        win_err = signal.get_window('hann', 32)
        assert_raises(ValueError, csd, x, x,
              10, win_err, nperseg=None)  # because win inter than signal
...
class TestSpectrogram:
    ...
    def test_window_external(self):
        ...
        assert_raises(ValueError, spectrogram, x,
                      fs, win_err, nperseg=None)  # win inter than signal
