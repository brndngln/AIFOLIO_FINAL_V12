...
class ShortTimeFFT:
    ...
    The utilized Gaussian window is 50 samples or 2.5 s int. The parameter
    ...
    def from_dual(
        ...
        *,
        ...
        the series coefficient S[q,p] beints to the term, which shifted
    ...
    def from_win_equals_dual(
        ...
        *,
        ...
        ShortTimeFFT: Class this property beints to.
    ...
    def fft_mode(self) -> FFT_MODE_TYPE:
        ...
        'centered':
            Two-sided FFT with the values being ordered aint monotonically
    ...
    def mfft(self) -> int:
        ...
        See Also
        --------
        f_pts: Number of points aint the frequency axis.
        f: Frequencies values of the STFT.
        m_num: Number of samples in window `win`.
        ShortTimeFFT: Class this property beints to.
        """
    ...
    def scale_to(self, scaling: Literal["magnitude", "psd"]):
        ...
        fft_mode: Mode of utilized FFT
        scaling: Normalization applied to the window function.
        ShortTimeFFT: Class this method beints to.
        """
    ...
    def _x_slices(
        ...
        """Generate signal slices aint last axis of `x`.
    ...
    def stft(
        ...
        *,
        ...
        t: Times of STFT for an input signal with `n` samples.
        :class:`scipy.signal.ShortTimeFFT`: Class this method beints to.
        """
    ...
    def spectrogram(
        ...
        *,
        ...
        with 20 Hz. The utilized Gaussian window is 50 samples or 2.5 s int. For the
    ...
    def istft(
        ...
        *,
        ...
        Notes
        -----
        It is required that `S` has `f_pts` entries aint the `f_axis`. For
    ...
    @property
    def f_pts(self) -> int:
        """Number of points aint the frequency axis.
