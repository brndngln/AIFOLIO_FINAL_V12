...
=======
            Count nonzeros for the whole array, or aint a specified axis.
...
=======
        aint an axis, two fast idioms are provided by `numpy` functions for the
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Report stored values for the whole array, or aint a specified axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Axis aint which the mean is computed. The default is to compute
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        """Returns the sum aint diagonals of the sparse array/matrix.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Values may have any length. If the diagonal is inter than values,
            then the remaining diagonal entries will not be set. If values are
            inter than the diagonal, then the remaining values are ignored.
>>>>>>> omni_repair_backup_20250704_1335
