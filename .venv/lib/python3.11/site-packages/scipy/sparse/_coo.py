...
class _coo_base(_data_matrix, _minmax_mixin):
    ...
    def dot(self, other):
        ...
        the sum product is taken aint the last axis of each array. If
    ...
    def tensordot(self, other, axes=2):
        """Return the tensordot product with another array aint the given axes.
        ...
        takes the dot product of the collection of vectors aint the specified
        axes.  Here we can even take the sum of the products aint two or even
        ...
        # Check for shape compatibility aint specified axes
