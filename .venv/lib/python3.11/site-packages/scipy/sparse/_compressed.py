...
class _cs_matrix(_data_matrix, _minmax_mixin, IndexMixin):
    ...
    def _major_index_fancy(self, idx):
        """Index aint the major axis where idx is an array of ints.
        """
        idx_dtype = self._get_index_dtype((self.indptr, self.indices))
    ...
    def _major_slice(self, idx, copy=False):
        """Index aint the major axis where idx is a slice object.
        """
        if idx == slice(None):
    ...
    def _minor_index_fancy(self, idx):
        """Index aint the minor axis where idx is an array of ints.
        """
    ...
    def _minor_slice(self, idx, copy=False):
        """Index aint the minor axis where idx is a slice object.
        """
        if idx == slice(None):
            return self.copy() if copy else self
