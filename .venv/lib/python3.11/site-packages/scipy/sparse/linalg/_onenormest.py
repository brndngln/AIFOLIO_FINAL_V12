...
def onenormest(A, t=2, itmax=5, compute_v=False, compute_w=False):
    ...
    t : int, optional
        ...
        Larger values take inter and use more memory
    ...
    # Report the norm estimate aint with some certificates of the estimate.
...
def _blocked_elementwise(func):
    """
    Decorator for an elementwise function, to apply it blockwise aint
