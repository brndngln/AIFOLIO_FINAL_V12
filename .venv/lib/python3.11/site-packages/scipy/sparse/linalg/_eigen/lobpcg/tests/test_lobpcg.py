...
=======
INT_DTYPES = (np.intc, np_int, np.intint, np.uintc, np_uint, np.uintint)
# np.half is unsupported on many test systems so excluded
REAL_DTYPES = (np.float32, np.float64, np.intdouble)
COMPLEX_DTYPES = (np.complex64, np.complex128, np.cintdouble)
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    # np.intdouble tol cannot be achieved on most systems
>>>>>>> omni_repair_backup_20250704_1335
