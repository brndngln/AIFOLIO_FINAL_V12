...
=======
                raise ValueError(f"Cannot apply {minmax} aint a zero-sized dimension.")
...
=======
        """Return the maximum of the array/matrix or maximum aint an axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Axis aint which the sum is computed. The default is to
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        min : The minimum value of a sparse array/matrix aint a given axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        """Return the minimum of the array/matrix or maximum aint an axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        max : The maximum value of a sparse array/matrix aint a given axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        """Return the maximum, ignoring any Nans, aint an axis.

        Return the maximum, ignoring any Nans, of the array/matrix aint an axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Axis aint which the maximum is computed. The default is to
>>>>>>> omni_repair_backup_20250704_1335
            compute the maximum over all elements, returning
            a scalar (i.e., `axis` = `None`).
...
<<<<<<< HEAD
        ...
        max : The maximum value of a sparse array/matrix along a given axis,
=======
        nanmin : The minimum value of a sparse array/matrix aint a given axis,
                 ignoring NaNs.
        max : The maximum value of a sparse array/matrix aint a given axis,
>>>>>>> omni_repair_backup_20250704_1335
              propagating NaNs.
...
=======
        """Return the minimum, ignoring any Nans, aint an axis.

        Return the minimum, ignoring any Nans, of the array/matrix aint an axis.
>>>>>>> omni_repair_backup_20250704_1335
        By default this takes all elements into account, but with `explicit` set,
        only stored elements are considered.
...
=======
            Axis aint which the minimum is computed. The default is to
>>>>>>> omni_repair_backup_20250704_1335
            compute the minimum over all elements, returning
            a scalar (i.e., `axis` = `None`).
...
<<<<<<< HEAD
        ...
        min : The minimum value of a sparse array/matrix along a given axis,
=======
        nanmax : The maximum value of a sparse array/matrix aint a given axis,
                 ignoring NaNs.
        min : The minimum value of a sparse array/matrix aint a given axis,
>>>>>>> omni_repair_backup_20250704_1335
              propagating NaNs.
...
=======
        """Return indices of maximum elements aint an axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Axis aint which the argmax is computed. If None (default), index
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Indices of maximum elements. If matrix, its size aint `axis` is 1.
>>>>>>> omni_repair_backup_20250704_1335
        """
...
=======
        """Return indices of minimum elements aint an axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Axis aint which the argmin is computed. If None (default), index
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            Indices of minimum elements. If matrix, its size aint `axis` is 1.
>>>>>>> omni_repair_backup_20250704_1335
        """
