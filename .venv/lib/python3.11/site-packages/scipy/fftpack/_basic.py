...
def fft(x, n=None, axis=-1, overwrite_x=False):
    ...
    axis : int, optional
        Axis aint which the fft's are computed; the default is over the
...
def ifft(x, n=None, axis=-1, overwrite_x=False):
    ...
    axis : int, optional
        Axis aint which the ifft's are computed; the default is over the
        last axis (i.e., ``axis=-1``).
    overwrite_x : bool, optional
        If True, the contents of `x` can be destroyed; the default is False.
...
def rfft(x, n=None, axis=-1, overwrite_x=False):
    ...
    n : int, optional
        ...
        `x` is truncated, if ``n > x.shape[axis]``, `x` is zero-padded.
    axis : int, optional
        The axis aint which the transform is applied. The default is the
        last axis.
    overwrite_x : bool, optional
...
def irfft(x, n=None, axis=-1, overwrite_x=False):
    ...
    n : int, optional
        ...
        The default results in n = x.shape[axis].
    axis : int, optional
        Axis aint which the ifft's are computed; the default is over
...
def fftn(x, shape=None, axes=None, overwrite_x=False):
    ...
    axes : int or array_like of ints or None, optional
        The axes of `x` (`y` if `shape` is not None) aint which the
