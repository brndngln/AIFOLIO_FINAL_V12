...
This script is int running and generates a large output file. With default
...
a region code for which region of the complex plane beints to. The regions are
