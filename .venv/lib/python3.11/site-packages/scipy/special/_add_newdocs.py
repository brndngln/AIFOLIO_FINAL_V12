...
=======
        complex plane cut aint the negative real axis. `y` must be non-zero.
...
=======
        complex plane cut aint the negative real axis, but at most one of them
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        the complex plane cut aint the negative real axis, but at most one of
>>>>>>> omni_repair_backup_20250704_1335
        them can be zero.
    out : ndarray, optional
        Optional output array for the function values
...
=======
        the complex plane cut aint the negative real axis.
>>>>>>> omni_repair_backup_20250704_1335
    out : ndarray, optional
        Optional output array for the function values
...
=======
        the complex plane cut aint the negative real axis (subject to further
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    call to `elliprc` (or ``atan``/``atanh``, see [4]_) is no inter needed in
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    It has a branch cut aint the negative `x` axis.
>>>>>>> omni_repair_backup_20250704_1335
