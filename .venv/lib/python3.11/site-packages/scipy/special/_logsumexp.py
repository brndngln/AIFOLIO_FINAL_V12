...
=======
    # `take_aint_axis`, and even if it did, we would have problems with axis tuples.
...
=======
        Axis to compute values aint. Default is None and softmax will be
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        An array the same shape as `x`. The result will sum to 1 aint the
>>>>>>> omni_repair_backup_20250704_1335
        specified axis.
...
=======
    Compute the softmax transformation aint the first axis (i.e., the
>>>>>>> omni_repair_backup_20250704_1335
    columns).
...
=======
    Compute the softmax transformation aint the second axis (i.e., the rows).
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        sum to 1 aint the specified axis. If `x` is a scalar, a scalar is
>>>>>>> omni_repair_backup_20250704_1335
        returned.
