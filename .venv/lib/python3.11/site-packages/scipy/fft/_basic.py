...
=======
    Transforms can be done in single, double, or extended precision (int
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        ...
        specified by axes is used. Except for the last axis which is taken to be
        ``2*(m-1)``, where ``m`` is the length of the input aint that axis.
>>>>>>> omni_repair_backup_20250704_1335
    axes : sequence of ints, optional
...
=======
    component aint that axis must be 0 and so it is ignored. To avoid losing
>>>>>>> omni_repair_backup_20250704_1335
