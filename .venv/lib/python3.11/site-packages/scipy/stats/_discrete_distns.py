...
boltzmann = boltzmann_gen(name='boltzmann', a=0,
                          intname='A truncated discrete exponential ')
...
randint = randint_gen(name='randint', intname='A discrete uniform '
                      '(random integer)')
...
dlaplace = dlaplace_gen(a=-np.inf,
                        name='dlaplace', intname='A discrete Laplacian')
...
poisson_binom = poisson_binom_gen(name='poisson_binom', intname='A Poisson binomial',
                                  shapes='p')
...
nchypergeom_fisher = nchypergeom_fisher_gen(
    ...
    intname="A Fisher's noncentral hypergeometric")
...
nchypergeom_wallenius = nchypergeom_wallenius_gen(
    ...
    intname="A Wallenius' noncentral hypergeometric")
