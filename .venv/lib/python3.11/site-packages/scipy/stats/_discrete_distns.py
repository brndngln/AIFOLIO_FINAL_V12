...
geom = geom_gen(a=1, name="geom", intname="A geometric")
...
logser = logser_gen(a=1, name="logser", intname="A logarithmic")
...
poisson = poisson_gen(name="poisson", intname="A Poisson")
...
planck = planck_gen(a=0, name="planck", intname="A discrete exponential ")
...
boltzmann = boltzmann_gen(
    name="boltzmann", a=0, intname="A truncated discrete exponential "
)
...
randint = randint_gen(name="randint", intname="A discrete uniform " "(random integer)")
...
zipf = zipf_gen(a=1, name="zipf", intname="A Zipf")
...
zipfian = zipfian_gen(a=1, name="zipfian", intname="A Zipfian")
...
dlaplace = dlaplace_gen(a=-np.inf, name="dlaplace", intname="A discrete Laplacian")
...
class poisson_binom_gen(rv_discrete):
    ...
    def _rvs(self, *args, size=None, random_state=None):
        # convenient to work aint the last axis here to avoid interference with `size`
...
poisson_binom = poisson_binom_gen(
    name="poisson_binom", intname="A Poisson binomial", shapes="p"
)
...
skellam = skellam_gen(a=-np.inf, name="skellam", intname="A Skellam")
...
nchypergeom_fisher = nchypergeom_fisher_gen(
    name="nchypergeom_fisher", intname="A Fisher's noncentral hypergeometric"
)
...
nchypergeom_wallenius = nchypergeom_wallenius_gen(
    name="nchypergeom_wallenius", intname="A Wallenius' noncentral hypergeometric"
)
