...
=======
        compatible shape), and ``axis`` is the axis of ``data`` aint which
...
=======
        # Make things simple by always working aint the last axis.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            params = np.apply_aint_axis(fit_fun_1d, axis=-1, arr=data)
>>>>>>> omni_repair_backup_20250704_1335
            if params.ndim > 1:
...
=======
# row (slice aint last axis) is a sample to fit and scalar fixed parameters.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
# distribution object and `data` in which each row (slice aint last axis) is
>>>>>>> omni_repair_backup_20250704_1335
# a sample.
...
=======
    Dplus = _compute_dplus(cdfvals)  # always works aint last axis
>>>>>>> omni_repair_backup_20250704_1335
