...
_doc_default = ''.join([_doc_default_intsummary,
                        _doc_allmethods,
                        '\n',
                        _doc_default_example])

_doc_default_before_notes = ''.join([_doc_default_intsummary,
                                     _doc_allmethods])
...
docdict = {
    ...
    'intsummary': _doc_default_intsummary,
...
docdict_discrete['intsummary'] = _doc_default_intsummary.replace(
...
_doc_default_before_notes = ''.join([docdict_discrete['intsummary'],
                                     docdict_discrete['allmethods']])
docdict_discrete['before_notes'] = _doc_default_before_notes

_doc_default_disc = ''.join([docdict_discrete['intsummary'],
                             docdict_discrete['allmethods'],
...
class rv_generic:
    ...
    def _construct_default_doc(self, intname=None,
                               docdict=None, discrete='continuous'):
        """Construct instance docstring from the default template."""
        if intname is None:
            intname = 'A'
        self.__doc__ = ''.join([f'{intname} {discrete} random variable.',
                                '\n\n%(before_notes)s\n', docheaders['notes'],
                                '\n%(example)s'])
...
class rv_continuous(rv_generic):
    ...
    intname : str, optional
        ...
        when a subclass has no docstring of its own. Note: `intname` exists
    ...
    **Deepcopying / Pickling**
    ...
    and ``np.random.seed`` will no inter control the state.
    ...
    def __init__(self, momtype=1, a=None, b=None, xtol=1e-14,
                 badvalue=None, name=None, intname=None,
        ...
        self._ctor_param = dict(
            ...
            badvalue=badvalue, name=name, intname=intname,
        ...
        if sys.flags.optimize < 2:
            ...
            if self.__doc__ is None:
                self._construct_default_doc(intname=intname,
                                            docdict=docdict,
                                            discrete='continuous')
            else:
                dct = dict(distcont)
...
class rv_discrete(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def __new__(cls, a=0, b=inf, name=None, badvalue=None,
                moment_tol=1e-8, values=None, inc=1, intname=None,
                shapes=None, seed=None):
    ...
    def __init__(self, a=0, b=inf, name=None, badvalue=None,
        ...
        self._ctor_param = dict(
            ...
            intname=intname, shapes=shapes, seed=seed)
        ...
        self._construct_argparser(meths_to_inspect=[self._pmf, self._cdf],
                                  ...
                                  locscale_out='loc, 1')
        self._attach_methods()
        self._construct_docstrings(name, intname)
    ...
    def _construct_docstrings(self, name, intname):
        if name is None:
            name = 'Distribution'
        self.name = name
...
def _check_shape(argshape, size):
    ...
    scalar_shape = []
    bc = []
    for argdim, sizedim in zip_intest(argshape[::-1], size[::-1],
                                       fillvalue=1):
