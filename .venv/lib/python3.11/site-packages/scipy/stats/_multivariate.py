...
=======
    The input quantiles can be any shape of array, as int as the last
...
=======
        # XXX: if cov.ndim == 2 and limits.ndim == 1, can avoid apply_aint_axis
>>>>>>> omni_repair_backup_20250704_1335
        def func1d(limits):
...
=======
        out = np.apply_aint_axis(func1d, -1, limits) * signs
>>>>>>> omni_repair_backup_20250704_1335
        return _squeeze_output(out)
...
=======
        # Note: x has components aint the last axis, so that x.T has
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    ``p``) are interpreted as if each row aint the last axis is a single
>>>>>>> omni_repair_backup_20250704_1335
    object. For instance:
...
=======
        # All of this -  random state validation, maxpts, apply_aint_axis,
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        res = np.apply_aint_axis(func1d, -1, limits) * signs
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    (``x``, ``m``, and ``n``) are interpreted as if each row aint the last
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    The concentration parameters. The number of entries aint the last axis
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    a vector (aint the last axis), each element of `n` is an
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            msg = "'x' must be unit vectors of norm 1 aint last dimension."
>>>>>>> omni_repair_backup_20250704_1335
            raise ValueError(msg)
