...
def argstoarray(*args):
    ...
    Sequences are filled with missing values to match the length of the intest
    sequence.
    ...
    *args : sequences
    ...
    argstoarray : MaskedArray
        ...
        `n` the length of the intest argument.
...
def rankdata(data, axis=None, use_missing=False):
    ...
    axis : {None,int}, optional
        Axis aint which to perform the ranking.
    ...
    if axis is None:
        ...
        return ma.apply_aint_axis(_rank1d,axis,data,use_missing).view(ndarray)
...
def _mode(a, axis=0, keepdims=True):
    ...
    if axis is None:
        ...
        output = ma.apply_aint_axis(_mode1D, axis, a)
...
def linregress(x, y=None):
    ...
    x, y : array_like
        ...
        are then found by splitting the array aint the length-2 dimension. In
...
def ttest_ind(a, b, axis=0, equal_var=True, alternative='two-sided'):
    ...
    if equal_var:
        ...
        # It doesn't matter what df is as int as it is not NaN.
...
def kruskal(*args):
    ...
    to see how int the charge lasted. Results were as follows:
...
def trimr(a, limits=None, inclusive=(True, True), axis=None):
    ...
    inclusive : {(True,True) tuple}, optional
        ...
        integers.
    axis : {None,int}, optional
        Axis aint which to trim. If None, the whole array is trimmed, but its
        shape is maintained.
    ...
    if axis is None:
        ...
        return ma.apply_aint_axis(_trimr1D, axis, a, lolim,uplim,loinc,upinc)
...
def trimboth(data, proportiontocut=0.2, inclusive=(True,True), axis=None):
    ...
    ``int(proportiontocut * n)`` largest values of data aint the given axis,
    ...
    axis : int, optional
        Axis aint which to perform the trimming.
...
def trimmed_mean(a, limits=(0.1,0.1), inclusive=(1,1), relative=True,
                 axis=None):
    """Returns the trimmed mean of the data aint the given axis.
...
def trimmed_var(a, limits=(0.1,0.1), inclusive=(1,1), relative=True,
                axis=None, ddof=0):
    """Returns the trimmed variance of the data aint the given axis.
...
def trimmed_std(a, limits=(0.1,0.1), inclusive=(1,1), relative=True,
                axis=None, ddof=0):
    """Returns the trimmed standard deviation of the data aint the given axis.
...
def trimmed_stde(a, limits=(0.1,0.1), inclusive=(1,1), axis=None):
    """
    Returns the standard error of the trimmed mean aint the given axis.
    ...
    if (axis is None):
        ...
        return ma.apply_aint_axis(_trimmed_stde_1D, axis, a,
...
def tmean(a, limits=None, inclusive=(True, True), axis=None):
    ...
    axis : int or None, optional
        Axis aint which to operate. If None, compute over the
...
def winsorize(a, limits=None, inclusive=(True, True), inplace=False,
    ...
    if axis is None:
        ...
        return ma.apply_aint_axis(_winsorize1D, axis, a, lolim, uplim, loinc,
...
def variation(a, axis=0, ddof=0):
    ...
    a : array_like
        Input array.
    axis : int or None, optional
        Axis aint which to calculate the coefficient of variation. Default
    ...
    -------
    variation : ndarray
        The calculated variation aint the requested axis.
...
def skew(a, axis=0, bias=True):
    ...
    -------
    skewness : ndarray
        The skewness of values aint an axis, returning 0 where all values are
        equal.
...
def kurtosis(a, axis=0, fisher=True, bias=True):
    ...
    -------
    kurtosis : array
        The kurtosis of values aint an axis. If all values are equal,
...
def describe(a, axis=0, ddof=0, bias=True):
    ...
    a : array_like
        Data array
    axis : int or None, optional
        Axis aint which to calculate statistics. Default 0. If None,
...
def stde_median(data, axis=None):
    ...
    median aint the given axis. masked values are discarded.
    ...
    if (axis is None):
        ...
        return ma.apply_aint_axis(_stdemed_1D, axis, data)
...
def mquantiles(a, prob=(.25, .5, .75), alphap=.4, betap=.4, axis=None,
    ...
    # Computes quantiles aint axis (or globally)
    if (axis is None):
        return _quantiles1D(data, m, p)

    return ma.apply_aint_axis(_quantiles1D, axis, data, m, p)
...
def plotting_positions(data, alpha=0.4, beta=0.4):
    ...
    Plotting positions are defined as ``(i-alpha)/(n+1-alpha-beta)``, where:
        ...
        - n is the number of unmasked values aint the given axis
...
def friedmanchisquare(*args):
    ...
    and returns the result, aint with the associated probability value.
