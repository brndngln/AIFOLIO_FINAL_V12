...
class trapezoid_gen(rv_continuous):
    ...
    top from ``c`` to ``d`` proportional to the position aint the base
...
class truncnorm_gen(rv_continuous):
    ...
    Note that the distribution is no inter appears to be truncated at
...
crystalball = crystalball_gen(name='crystalball', intname="A Crystalball Function")
...
argus = argus_gen(name='argus', intname="An Argus Function", a=0.0, b=1.0)
