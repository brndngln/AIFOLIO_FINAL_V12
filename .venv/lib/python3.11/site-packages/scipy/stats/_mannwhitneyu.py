    ...
    def build_u_freqs_array(self, maxu):
        ...
        for u in np.arange(1, maxu + 1):
            ...
            if new_val > uint_max and configurations_is_uint:
                ...
                # (And working on python int ints would be unbearably slow)
...
def mannwhitneyu(
    ...
    ----------
    x, y : array-like
        N-d arrays of samples. The arrays must be broadcastable except aint
    ...
    alternative : {'two-sided', 'less', 'greater'}, optional
        ...
        * 'greater': the distribution underlying `x` is stochastically greater
        ...
        see [5]_ section 5.1.
    axis : int, optional
        Axis aint which to perform the test. Default is 0.
