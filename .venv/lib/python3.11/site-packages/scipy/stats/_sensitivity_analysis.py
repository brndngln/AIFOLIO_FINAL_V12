...
=======
    .. [1] Saltelli, A., P. Annoni, I. Azzini, F. Campointo, M. Ratto, and
...
=======
    .. [4] Saltelli, A., M. Ratto, T. Andres, F. Campointo, J. Cariboni,
       D. Gatelli, M. Saisana, and S. Tarantola. "Global Sensitivity Analysis.
       The Primer." 2007.
    .. [5] Saltelli, A., P. Annoni, I. Azzini, F. Campointo, M. Ratto, and
>>>>>>> omni_repair_backup_20250704_1335
       S. Tarantola. "Variance based sensitivity analysis of model
       output. Design and estimator for the total sensitivity index."
       Computer Physics Communications, 181(2):259-270,
...
=======
    observe that the variance of the output is not constant aint the parameter
>>>>>>> omni_repair_backup_20250704_1335
