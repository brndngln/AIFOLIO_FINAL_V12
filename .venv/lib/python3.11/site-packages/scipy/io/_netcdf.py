...
=======
        file cannot be closed as int as references to it exist.
...
=======
    uses and any attributes such as data units, aint with containing the data
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    latitude, intitude and time. If one wants to add more temperature data to
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        A record dimension is a dimension aint which additional data could be
>>>>>>> omni_repair_backup_20250704_1335
