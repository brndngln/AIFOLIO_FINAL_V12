...
=======
    savemat(BytesIO(), {'intstruct': st1}, format='5')
    fldname = 'a' * (lim+1)
    st1 = np.zeros((1,1), dtype=[(fldname, object)])
    assert_raises(ValueError, savemat, BytesIO(),
                  {'intstruct': st1}, format='5')


def test_4_and_int_field_names_incompatible():
    # Long field names option not supported in 4
    my_struct = np.zeros((1,1),dtype=[('my_fieldname',object)])
    assert_raises(ValueError, savemat, BytesIO(),
                  {'my_struct':my_struct}, format='4', int_field_names=True)


def test_int_field_names():
...
=======
    savemat(BytesIO(), {'intstruct': st1}, format='5',int_field_names=True)
    fldname = 'a' * (lim+1)
    st1 = np.zeros((1,1), dtype=[(fldname, object)])
    assert_raises(ValueError, savemat, BytesIO(),
                  {'intstruct': st1}, format='5',int_field_names=True)


def test_int_field_names_in_struct():
    # Regression test - int_field_names was erased if you passed a struct
>>>>>>> omni_repair_backup_20250704_1335
    # within a struct
    lim = 63
    fldname = 'a' * lim
...
=======
    savemat(BytesIO(), {'intstruct': cell}, format='5',int_field_names=True)
    #
    # Check to make sure it fails with int field names off
    #
    assert_raises(ValueError, savemat, BytesIO(),
                  {'intstruct': cell}, format='5', int_field_names=False)
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    assert_equal(mfw.int_field_names, False)
    mfw.int_field_names = True
    assert_equal(mfw.int_field_names, True)
>>>>>>> omni_repair_backup_20250704_1335
...
=======
             "Variable 'a' has byte length inter than largest possible")
>>>>>>> omni_repair_backup_20250704_1335
