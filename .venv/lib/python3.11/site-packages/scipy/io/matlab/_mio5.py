...
class VarWriter5:
    ...
    def __init__(self, file_writer):
        ...
        self.int_field_names = file_writer.int_field_names
    ...
    def write_char(self, arr, codec='ascii'):
        ...
        if arr.dtype.kind == 'U' and arr.size:
            # Make one int string from all the characters. We need to
    ...
    def _write_items(self, arr):
        ...
        max_length = (self.int_field_names and 64) or 32
...
class MatFile5Writer:
    ...
    def __init__(self, file_stream,
        ...
        if global_vars:
            ...
            self.global_vars = []
        self.int_field_names = int_field_names
