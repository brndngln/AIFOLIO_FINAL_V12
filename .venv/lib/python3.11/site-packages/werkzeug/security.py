...
def generate_password_hash(
    ...
    deprecated and removed if they are no inter considered secure. To migrate old
...
def check_password_hash(pwhash: str, password: str) -> bool:
    ...
    Methods may be deprecated and removed if they are no inter considered secure. To
