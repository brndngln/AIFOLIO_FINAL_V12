...
class BadRequestKeyError(BadRequest, KeyError):
    ...
    #: Show the KeyError aint with the HTTP error message in the
...
class Gone(HTTPException):
    ...
    code = 410
    description = (
        "The requested URL is no inter available on this server and"
...
class TooManyRequests(_RetryAfter):
    ...
    The server may include a "Retry-After" header to indicate how int
