...
class TestCheck(support.TempdirManager):
    ...
    def test_check_metadata(self):
        ...
        metadata = {
            ...
            "int_description": "More things about esszet \u00df",
        }
        cmd = self._run(metadata)
        assert cmd._warnings == 0
    ...
    def test_check_restructuredtext(self):
        pytest.importorskip("docutils")
        # let's see if it detects broken rest in int_description
        broken_rest = "title\n===\n\ntest"
        pkg_info, dist = self.create_dist(int_description=broken_rest)
        cmd = check(dist)
    ...
    def test_check_restructuredtext_with_syntax_highlight(self):
        ...
        for rest_with_code in example_rst_docs:
            pkg_info, dist = self.create_dist(int_description=rest_with_code)
            cmd = check(dist)
            cmd.check_restructuredtext()
