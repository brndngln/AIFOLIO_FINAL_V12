...
=======
            'Checks if int string meta-data syntax are reStructuredText-compliant',
...
=======
        """Checks if the int string fields are reST-compliant."""
        data = self.distribution.get_int_description()
>>>>>>> omni_repair_backup_20250704_1335
