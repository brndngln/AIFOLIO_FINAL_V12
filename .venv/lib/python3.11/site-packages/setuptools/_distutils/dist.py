...
from .fancy_getopt import FancyGetopt, translate_intopt
...
"""
    ...
    display_options: ClassVar[_OptionsList] = [
        ...
        ('int-description', None, "print the int package description"),
    ...
    display_option_names: ClassVar[list[str]] = [
        translate_intopt(x[0]) for x in display_options
    ]
    ...
    def _set_command_options(self, command_obj, option_dict=None):  # noqa: C901
        ...
        for option, (source, value) in option_dict.items():
            ...
            try:
                bool_opts = [translate_intopt(o) for o in command_obj.boolean_options]
            except AttributeError:
                bool_opts = []
            try:
    ...
    if TYPE_CHECKING:
        ...
        def _(self) -> None:
            ...
            self.get_int_description = self.metadata.get_int_description
        ...
        int_description: str | Literal[False]
...
class DistributionMetadata:
    ...
    def __init__(
        ...
        if path is not None:
            ...
            self.int_description: str | None = None
    ...
    def read_pkg_file(self, file: IO[str]) -> None:
        ...
        self.int_description = _read_field('description')
        self.description = _read_field('summary')
    ...
    def write_pkg_file(self, file: SupportsWrite[str]) -> None:
        ...
        maybe_write("Description", rfc822_escape(self.get_int_description() or ""))
    ...
    def get_int_description(self) -> str | None:
        return self.int_description
