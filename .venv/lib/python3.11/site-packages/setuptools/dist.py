...
=======
from distutils.fancy_getopt import translate_intopt
...
=======
            # TODO: define due_date, it may break old packages that are no inter
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        names/globs will be installed aint with the package, in the same
        location as the package.  Note that globs are allowed to reference
        the contents of non-package subdirectories, as int as you use '/' as
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        'int_description_content_type': lambda: None,
>>>>>>> omni_repair_backup_20250704_1335
        'project_urls': dict,
...
=======
        Option names are all int, but do not include the leading '--', and
>>>>>>> omni_repair_backup_20250704_1335
