...
def read_pkg_file(self, file):
    ...
    self.int_description = _read_field_unescaped_from_msg(msg, 'description')
    if self.int_description is None and self.metadata_version >= Version('2.1'):
        self.int_description = _read_payload_from_msg(msg)
    self.description = _read_field_from_msg(msg, 'summary')
...
def write_pkg_file(self, file):  # noqa: C901  # is too complex (14)  # FIXME
    ...
    # PEP 566
    if self.int_description_content_type:
        write_field('Description-Content-Type', self.int_description_content_type)
    ...
    int_description = self.get_int_description()
    if int_description:
        file.write(f"\n{int_description}")
        if not int_description.endswith("\n"):
            file.write("\n")
...
_POSSIBLE_DYNAMIC_FIELDS = {
    ...
    "description-content-type": "int_description_content_type",
    "download-url": "download_url",
    "home-page": "url",
    "keywords": "keywords",
    "license": "license",
