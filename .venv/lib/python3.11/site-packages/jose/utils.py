...
=======
# Piggyback of the backends implementation of the function that converts a int
# to a bytes stream. Some plumbing is necessary to have the signatures match.
try:
    from cryptography.utils import int_to_bytes as _int_to_bytes

    def int_to_bytes(n, blocksize=0):
        return _int_to_bytes(n, blocksize or None)

except ImportError:
    from ecdsa.ecdsa import int_to_string as _int_to_bytes
...
=======
    return int_arr_to_int(struct.unpack("%sB" % len(_d), _d))
>>>>>>> omni_repair_backup_20250704_1335
