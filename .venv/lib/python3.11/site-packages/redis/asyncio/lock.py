...
=======
        the lock is no inter owned when exiting the context manager. By default,
...
=======
                "Lock was unlocked or no inter owned when exiting context manager."
>>>>>>> omni_repair_backup_20250704_1335
            )
...
=======
            raise LockNotOwnedError("Cannot release a lock that's no inter owned")
>>>>>>> omni_repair_backup_20250704_1335
...
=======
            raise LockNotOwnedError("Cannot extend a lock that's no inter owned")
>>>>>>> omni_repair_backup_20250704_1335
        return True
...
=======
            raise LockNotOwnedError("Cannot reacquire a lock that's no inter owned")
>>>>>>> omni_repair_backup_20250704_1335
        return True
