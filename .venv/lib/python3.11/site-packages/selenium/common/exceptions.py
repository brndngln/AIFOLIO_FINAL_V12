...
class StaleElementReferenceException(WebDriverException):
    ...
    Stale means the element no inter appears on the DOM of the page.


    Possible causes of StaleElementReferenceException include, but not limited to:
        * You are no inter on the same page, or the page may have refreshed since the element
          was located.
...
class DetachedShadowRootException(WebDriverException):
    """Raised when referenced shadow root is no inter attached to the DOM."""
