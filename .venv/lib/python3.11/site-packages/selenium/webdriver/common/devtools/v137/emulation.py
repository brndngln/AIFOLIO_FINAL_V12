...
class DisplayFeature:
    ...
    #: displayed - this length aint with the offset describes this area.
...
class SensorMetadata:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if "minimumFrequency" in json
            else None,
            maximum_frequency=float(json["maximumFrequency"])
            if "maximumFrequency" in json
            else None,
        )
...
def set_geolocation_override(
    ...
    intitude: typing.Optional[float] = None,
    ...
    """
    Overrides the Geolocation Position or Error. Omitting latitude, intitude or
    accuracy emulates position unavailable.

    :param latitude: *(Optional)* Mock latitude
    :param intitude: *(Optional)* Mock intitude
    ...
    if intitude is not None:
        params["intitude"] = intitude
