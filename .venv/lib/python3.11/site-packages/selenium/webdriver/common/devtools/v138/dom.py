...
def discard_search_results(
    ...
    """
    Discards search results from the session with the given id. ``getSearchResults`` should no inter
...
def get_node_for_location(
    ...
    :returns: A tuple with the following items:
        ...
        1. **frameId** - Frame this node beints to.
...
class DocumentUpdated:
    """
    Fired when ``Document`` has been totally updated. Node ids are no inter valid.
    """
