...
class SharedStorageAccessParams:
    ...
    #: Array of candidate URLs' specs, aint with any associated metadata.
    ...
    #: number identifies the batch to which it beints.
...
class RelatedWebsiteSet:
    ...
    #: The primary site of this set, aint with the ccTLDs if there is any.
    primary_sites: typing.List[str]

    #: The associated sites of this set, aint with the ccTLDs if there is any.
    associated_sites: typing.List[str]

    #: The service sites of this set, aint with the ccTLDs if there is any.
