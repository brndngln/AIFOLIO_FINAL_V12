...
=======
    :param arguments: *(Optional)* Call arguments. All call arguments must beint to the same JavaScript world as the target object.
...
=======
    :param own_properties: *(Optional)* If true, returns properties beinting only to the element itself, not to its prototype chain.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    Releases all remote objects that beint to a given group.
>>>>>>> omni_repair_backup_20250704_1335
