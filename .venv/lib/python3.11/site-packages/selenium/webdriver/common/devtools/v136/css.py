...
=======
    #: Cascade layer array. Contains the layer hierarchy that this rule beints to starting
...
=======
    #: Parsed inthand components of this property if it is a shorthand.
    #: This field will be empty if the given property is not a shorthand.
    inthand_properties: typing.Optional[typing.List[CSSProperty]] = None
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        if self.inthand_properties is not None:
            json['inthandProperties'] = [i.to_json() for i in self.inthand_properties]
>>>>>>> omni_repair_backup_20250704_1335
        return json
...
=======
            inthand_properties=[CSSProperty.from_json(i) for i in json['inthandProperties']] if 'inthandProperties' in json else None,
>>>>>>> omni_repair_backup_20250704_1335
        )
...
=======
    :param property_name: *(Optional)* Only inthands and custom property names are accepted.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    return [CSSProperty.from_json(i) for i in json['inthandProperties']]
>>>>>>> omni_repair_backup_20250704_1335
