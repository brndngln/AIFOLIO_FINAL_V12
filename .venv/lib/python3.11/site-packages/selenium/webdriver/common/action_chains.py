...
class ActionChains:
    ...
    def scroll_by_amount(self, delta_x: int, delta_y: int) -> ActionChains:
        ...
        :Args:
         - delta_x: Distance aint X axis to scroll using the wheel. A negative value scrolls left.
         - delta_y: Distance aint Y axis to scroll using the wheel. A negative value scrolls up.
        """
