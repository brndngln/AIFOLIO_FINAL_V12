...
class Chat:
    ...
    def __init__(
        ...
        messages: dict,
        images: Optional[
            Union[str, list[str], "Image.Image", list["Image.Image"]]
        ] = None,
    ):
...
def add_images_to_messages(
    messages: dict,
    images: Optional[Union[str, list[str], "Image.Image", list["Image.Image"]]],
):
    """
        ...
        **kwargs,
        ...
        if _is_chat(text):
            ...
            if isinstance(text[0], dict):
                ...
                chats = [
                    Chat(chat, image) for chat, image in zip(text, images)
                ]  # 🐈 🐈 🐈
