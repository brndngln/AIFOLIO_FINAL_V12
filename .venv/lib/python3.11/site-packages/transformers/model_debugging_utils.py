...
def _serialize_tensor_like_io(
    ...
    use_repr: bool = True,
    path_to_value: Optional[str] = None,
):
    """
    ...
    if use_repr:
        ...
        filepath = (
            os.path.join(debug_path, path_to_value) if debug_path else path_to_value
        )
    ...
    if isinstance(value, (list, tuple)):
        return [
            _serialize_io(
                ...
                use_repr=use_repr,
                path_to_value=f"{path_to_value}_{i}",
            )
    ...
    if isinstance(value, dict):
        return {
            k: _serialize_io(
                ...
                debug_path=debug_path,
                use_repr=use_repr,
                path_to_value=f"{path_to_value}_{k}",
            )
