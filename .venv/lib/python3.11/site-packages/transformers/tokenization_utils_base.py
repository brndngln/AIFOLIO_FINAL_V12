...
class SpecialTokensMixin:
    ...
    def add_special_tokens(
        ...
        special_tokens_dict: dict[
            str, Union[str, AddedToken, Sequence[Union[str, AddedToken]]]
        ],
    ...
    def add_tokens(
        self,
        new_tokens: Union[str, AddedToken, Sequence[Union[str, AddedToken]]],
...
class PreTrainedTokenizerBase(SpecialTokensMixin, PushToHubMixin):
    ...
    def create_token_type_ids_from_sequences(
        ...
        return [0] * (cls_len + len(token_ids_0) + sep_len) + [1] * (
            len(token_ids_1) + sep_len
        )
