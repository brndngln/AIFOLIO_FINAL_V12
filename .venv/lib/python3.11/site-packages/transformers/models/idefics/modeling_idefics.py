    ...
    for module in model.modules():
        if module_exceptions and any(
            ...
            module.requires_grad_(
                True
            )  # Explicitly setting it to true to avoid any mistakes
        else:
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv2d)):
            ...
            if self.config.alpha_initializer == "zeros":
                ...
                module.alpha_cross_attn.data.normal_(
                    mean=0.0, std=self.config.alphas_initializer_range
                )
                module.alpha_dense.data.normal_(
                    mean=0.0, std=self.config.alphas_initializer_range
                )
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if idx % self.cross_layer_interval == 0:
                cross_attn_block = self.gated_cross_attn_layers[
                    idx // self.cross_layer_interval
                ]
