...
class FuyuProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor, tokenizer, **kwargs):
        ...
        self.image_newline_id = tokenizer.encode("|NEWLINE|", add_special_tokens=False)[
            1
        ]
    ...
    def _left_pad_inputs_with_attention_mask(
        ...
        if len(batched_inputs["image_patches"]) == 1:
            batched_inputs["image_patches"] = torch.cat(
                batched_inputs["image_patches"], dim=0
            )
    ...
    def _get_num_multimodal_tokens(self, image_sizes=None, **kwargs):
        ...
        if image_sizes is not None:
            ...
            for image_size in image_sizes:
                ...
                image_unpadded_h = min(
                    int(image_size[0] * optimal_scale_factor), image_size[0]
                )
                image_unpadded_w = min(
                    int(image_size[0] * optimal_scale_factor), image_size[0]
                )
                ...
                num_image_tokens.append(
                    model_image_input["image_input_ids"][0][0].shape[-1]
                )
            vision_data.update(
                {
