...
class Idefics2PerceiverAttention(nn.Module):
    ...
    def forward(
        ...
        queries = queries.view(bsz, q_len, self.num_heads, self.head_dim).transpose(
            1, 2
        )
        keys = keys.view(
...
class Idefics2Model(Idefics2PreTrainedModel):
    ...
    def inputs_merger(
        ...
        new_inputs_embeds[special_image_token_mask] = image_hidden_states.to(
    ...
    def get_image_features(
        ...
        patch_attention_mask = (
            patches_subgrid.sum(dim=(-1, -2)) == patch_size * patch_size
        ).bool()
