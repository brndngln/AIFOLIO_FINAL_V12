...
class TFBertTokenizer(keras.layers.Layer):
    ...
    def __init__(
        ...
        **tokenizer_kwargs,
        ...
        self.cls_token_id = (
            vocab_list.index("[CLS]") if cls_token_id is None else cls_token_id
        )
        self.sep_token_id = (
            vocab_list.index("[SEP]") if sep_token_id is None else sep_token_id
        )
        self.pad_token_id = (
            vocab_list.index("[PAD]") if pad_token_id is None else pad_token_id
        )
    ...
    def from_tokenizer(
        ...
        do_lower_case = (
            tokenizer.do_lower_case if do_lower_case is None else do_lower_case
        )
