...
class InstructBlipVideoAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        outputs = (
            (attn_output, attn_weights) if output_attentions else (attn_output, None)
        )
        return outputs
...
class InstructBlipVideoPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, (nn.Linear, nn.Conv2d)):
            ...
            module, (InstructBlipVideoForConditionalGeneration, InstructBlipVideoModel)
        ):
...
class InstructBlipVideoQFormerModel(InstructBlipVideoPreTrainedModel):
    ...
    _supports_attention_backend = (
        False  # adds position on attn weights before last matmul
    )
...
class InstructBlipVideoForConditionalGeneration(
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        vision_outputs = (
            vision_outputs.to_tuple() if not return_dict else vision_outputs
        )
        ...
        **generate_kwargs,
        ...
        if input_ids is None:
            ...
            input_ids = torch.tensor(
                [start_tokens], dtype=torch.long, device=pixel_values.device
            )
