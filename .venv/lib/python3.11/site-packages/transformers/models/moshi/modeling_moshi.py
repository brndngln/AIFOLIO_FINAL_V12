    ...
    def forward(
        ...
        **kwargs,
        ...
        return MoshiConditionalGenerationOutputWithPast(
            ...
            depth_loss=None
            if depth_decoder_outputs is None
            else depth_decoder_outputs.loss,
            audio_logits=None
            if depth_decoder_outputs is None
            else depth_decoder_outputs.logits,
            depth_past_key_values=None
            if decoder_outputs is None
            else decoder_outputs.past_key_values,
            depth_hidden_states=None
            if decoder_outputs is None
            else decoder_outputs.hidden_states,
            depth_attentions=None
            if decoder_outputs is None
        ...
        **kwargs,
        ...
        if hasattr(self, "hf_device_map") and not hasattr(
            ...
            if "" in self.hf_device_map:
                ...
                self.depth_decoder.hf_device_map = {
                    key[len("depth_decoder") :]: main_device
