        ...
        **kwargs: Unpack[Idefics3ProcessorKwargs],
            ...
            if text is not None:
                ...
                for sample, sample_rows, sample_cols in zip(
                    ...
                    for n_rows, n_cols in zip(sample_rows, sample_cols):
                        ...
                        image_seq_lengths.append(
                            (self.image_seq_len + 3) + row_length * n_rows
                        )
                ...
                self._check_special_mm_tokens(
                    prompt_strings, text_inputs, modalities=["image"]
                )
        ...
        if return_mm_token_type_ids:
            ...
            for i, seq_lengths in enumerate(batch_image_seq_lengths):
                image_start_positions = np.where(
                    array_ids[i] == self.fake_image_token_id
                )[0]
                j = 0
