...
if TYPE_CHECKING:
    ...
    IMAGE_PROCESSOR_MAPPING_NAMES = OrderedDict(
        [
            ...
            (
                "bridgetower",
                ("BridgeTowerImageProcessor", "BridgeTowerImageProcessorFast"),
            ),
            ("chameleon", ("ChameleonImageProcessor",)),
            (
                "chinese_clip",
                ("ChineseCLIPImageProcessor", "ChineseCLIPImageProcessorFast"),
            ),
            ("clip", ("CLIPImageProcessor", "CLIPImageProcessorFast")),
            ("clipseg", ("ViTImageProcessor", "ViTImageProcessorFast")),
            (
                "conditional_detr",
                ("ConditionalDetrImageProcessor", "ConditionalDetrImageProcessorFast"),
            ),
            ...
            (
                "deformable_detr",
                ("DeformableDetrImageProcessor", "DeformableDetrImageProcessorFast"),
            ),
            ...
            (
                "grounding-dino",
                ("GroundingDinoImageProcessor", "GroundingDinoImageProcessorFast"),
            ),
            ...
            (
                "layoutlmv3",
                ("LayoutLMv3ImageProcessor", "LayoutLMv3ImageProcessorFast"),
            ),
            ...
            (
                "mobilenet_v1",
                ("MobileNetV1ImageProcessor", "MobileNetV1ImageProcessorFast"),
            ),
            (
                "mobilenet_v2",
                ("MobileNetV2ImageProcessor", "MobileNetV2ImageProcessorFast"),
            ),
            ...
            (
                "poolformer",
                ("PoolFormerImageProcessor", "PoolFormerImageProcessorFast"),
            ),
...
class AutoImageProcessor:
        ...
        if image_processor_type is not None:
            ...
            if use_fast:
                ...
                image_processor_type_slow = (
                    ...
                    else image_processor_type
                )
                image_processor_class = get_image_processor_class_from_name(
                    image_processor_type_slow
                )
                if image_processor_class is None and image_processor_type.endswith(
                    "Fast"
                ):
                    raise ValueError(
    ...
    def register(
        ...
        if fast_image_processor_class is not None and not issubclass(
            ...
            raise ValueError(
                "The `fast_image_processor_class` should inherit from `BaseImageProcessorFast`."
            )
