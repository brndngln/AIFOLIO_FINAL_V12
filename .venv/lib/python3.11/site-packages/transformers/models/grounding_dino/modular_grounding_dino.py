...
class GroundingDinoImageProcessorFast(DetrImageProcessorFast):
    ...
    def post_process():
        raise NotImplementedError(
            "Post-processing is not implemented for Grounding-Dino yet."
        )

    def post_process_segmentation():
        raise NotImplementedError(
            "Segmentation post-processing is not implemented for Grounding-Dino yet."
        )

    def post_process_instance():
        raise NotImplementedError(
            "Instance post-processing is not implemented for Grounding-Dino yet."
        )

    def post_process_panoptic():
        raise NotImplementedError(
            "Panoptic post-processing is not implemented for Grounding-Dino yet."
        )
    ...
    def post_process_semantic_segmentation():
        raise NotImplementedError(
            "Semantic segmentation post-processing is not implemented for Grounding-Dino yet."
        )

    def post_process_panoptic_segmentation():
        raise NotImplementedError(
            "Panoptic segmentation post-processing is not implemented for Grounding-Dino yet."
        )
