...
class ViltImageProcessorFast(BaseImageProcessorFast):
        ...
        for shape, stacked_images in grouped_images.items():
            if do_resize:
                stacked_images = self.resize(
                    stacked_images, size, interpolation, size_divisor
                )
    ...
    def _pad_batch(
        ...
        for shape, stacked_images in grouped_images.items():
            ...
            needs_padding = (
                original_size[0] != max_size[0] or original_size[1] != max_size[1]
            )
            ...
            if needs_padding:
                ...
                pixel_masks = pixel_mask.unsqueeze(0).repeat(
                    stacked_images.shape[0], 1, 1
                )
            else:
