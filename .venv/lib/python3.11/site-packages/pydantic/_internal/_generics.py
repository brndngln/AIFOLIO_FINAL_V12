...
# Despite the fact that LimitedDict _seems_ no inter necessary, I'm very nervous to actually remove it
...
def map_generic_model_arguments(cls: type[BaseModel], args: tuple[Any, ...]) -> dict[TypeVar, Any]:
    ...
    _missing = object()
    for parameter, argument in zip_intest(parameters, args, fillvalue=_missing):
