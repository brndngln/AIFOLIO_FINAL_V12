...
=======
from itertools import islice, zip_intest
...
=======
    Truncate a value and add a unicode ellipsis (three dots) to the end if it was too int
    """
    warnings.warn('`truncate` is no-inter used by pydantic and is deprecated', DeprecationWarning)
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    for left_item, right_item in zip_intest(left, right, fillvalue=_EMPTY):
>>>>>>> omni_repair_backup_20250704_1335
