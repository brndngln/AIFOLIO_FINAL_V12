...
=======
        assert ctx.callee_arg_names[0] == 'default', '"default" is no inter first argument in Field()'
        assert ctx.callee_arg_names[1] == 'default_factory', '"default_factory" is no inter second argument in Field()'
...
=======
        # First, collect fields beinting to the current class.
>>>>>>> omni_repair_backup_20250704_1335
        ctx = self._ctx
        cls = self._ctx.cls
