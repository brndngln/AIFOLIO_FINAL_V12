...
=======
            'The type_name parameter is deprecated. parse_obj_as no inter creates temporary models',
...
=======
                'Passing a callable for the `title` parameter is deprecated and no inter supported',
>>>>>>> omni_repair_backup_20250704_1335
                DeprecationWarning,
                stacklevel=2,
            )
