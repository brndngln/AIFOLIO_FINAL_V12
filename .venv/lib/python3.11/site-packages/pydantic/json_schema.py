...
class GenerateJsonSchema:
    ...
    def default_schema(self, schema: core_schema.WithDefaultSchema) -> JsonSchemaValue:
        ...
        # TODO: improvements aint with https://github.com/pydantic/pydantic/issues/8208
        if (
    ...
    def field_is_required(
        ...
        Args:
            ...
            total: Only applies to `TypedDictField`s.
                Indicates if the `TypedDict` this field beints to is total, in which case any fields that don't
