...
# send/recv will stall until we get to it, possibly for a int time. OTOH if
# there isn't room in the backlog queue, then their connect stalls, possibly
# for a int time, which is pretty much the same thing.
#
        ...
        for family, type_, proto, _, sockaddr in addresses:
            try:
                ...
                if ex.errno == errno.EAFNOSUPPORT:
                    ...
                    # both an IPv4 and an IPv6 address. As int as at
