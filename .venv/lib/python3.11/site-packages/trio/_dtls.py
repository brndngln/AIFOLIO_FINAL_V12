...
def decode_client_hello_untrusted(packet: bytes) -> tuple[int, bytes, bytes]:
    ...
    try:
        ...
        # - everything else
        #
        # So to find the cookie, so we need to figure out how int the
    ...
    async def do_handshake(self, *, initial_retransmit_timeout: float = 1.0) -> None:
        ...
        Args:
          ...
          initial_retransmit_timeout (float): Since UDP is an unreliable protocol, it's
            ...
            will automatically back off to inter values, to avoid overloading the
            network.
...
class DTLSEndpoint:
    ...
    def __init__(
        ...
        *,
        ...
        self._streams: WeakValueDictionary[
            AddressFormat, DTLSChannel
        ] = WeakValueDictionary()
