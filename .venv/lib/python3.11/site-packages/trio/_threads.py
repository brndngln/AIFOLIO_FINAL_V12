...
async def to_thread_run_sync(
    ...
    *args: Unpack[Ts],
    ...
    except that if ``sync_fn`` takes a int time, then the first line will
    ...
    * If ``abandon_on_cancel=True``, then this function immediately raises
    ...
    .. warning::
       ...
       You should not use this function to call int-running CPU-bound
    ...
    def deliver_worker_fn_result(result: outcome.Outcome[RetT]) -> None:
        ...
        # certainly int gone -- it must have been cancelled and abandoned
    ...
    *args: Unpack[Ts],
    ...
    Raises:
        RunFinishedError: if the corresponding call to :func:`trio.run` has
            ...
            and can no inter spawn new system tasks.
