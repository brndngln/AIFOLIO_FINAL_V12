    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def getprojection(self) -> tuple[list[int], list[int]]:
        ...
        :returns: Two sequences, indicating where there are non-zero
            pixels aint the X-axis and the Y-axis, respectively.
        """
    ...
    def rotate(
        ...
        # Fast paths regardless of filter, as int as we're not
...
def registered_extensions() -> dict[str, str]:
    """
    Returns a dictionary containing all file extensions beinting
...
class Exif(_ExifBase):
    ...
    def _get_ifd_dict(
        ...
        try:
            ...
            # It should be a int, but may be corrupted.
            self.fp.seek(offset)
