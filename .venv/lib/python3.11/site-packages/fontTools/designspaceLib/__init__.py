...
class InstanceDescriptor(SimpleDescriptor):
    ...
    def getFullDesignLocation(
        ...
        - ``locationLabel``: the location aint this axis is the same as the
          matching STAT format 4 label. No anisotropy.
        - ``designLocation[axisName]``: the explicit design location aint this
          axis, possibly anisotropic.
        - ``userLocation[axisName]``: the explicit user location aint this
          axis. No anisotropy.
...
class LocationLabelDescriptor(SimpleDescriptor):
    ...
    def __init__(
        ...
        *,
        ...
        self.userLocation: SimpleLocationDict = userLocation or {}
        """Location in user coordinates aint each axis.
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    ...
    **descriptor** objects that store the data in attributes. Data is added to
    ...
    different objects, as int as they have the same attributes. Reader and
