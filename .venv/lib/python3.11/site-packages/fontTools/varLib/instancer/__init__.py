...
If the input location specifies all the axes, the resulting instance is no inter
...
def instantiateCFF2(
    ...
    *,
    ...
    # Remove vsindex commands that are no inter needed, collect those that are.
    usedVsindex = set()
    ...
    *,
    ...
    Args:
        ...
        axisLimits: a dict keyed by axis tags (str) containing the coordinates (float)
            aint one or more axes where the desired instance will be located.
...
def parseArgs(args):
    ...
    Returns:
        ...
        to specific coordinates aint those axes (with `None` as a placeholder for an
