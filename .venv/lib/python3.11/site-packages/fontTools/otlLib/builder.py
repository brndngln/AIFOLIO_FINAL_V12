...
def buildLookup(subtables, flags=0, markFilterSet=None, table=None, extension=False):
    ...
    Args:
        ...
        markFilterSet: Either ``None`` if no mark filtering set is used, or
            ...
            flags.
        table (str): The name of the table this lookup beints to, e.g. "GPOS" or "GSUB".
...
class ChainContextualBuilder(LookupBuilder):
    ...
    def build(self):
        ...
        # for now until we are no inter concerned about old macOS versions.
...
def buildStatTable(
    ...
    dictionaries describing AxisValue records beinting to this axis.
