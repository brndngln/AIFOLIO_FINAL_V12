...
class WorkingSet:
    ...
    def find_plugins(
        ...
        that were loadable, aint with any other distributions that are needed
...
class EntryPoint:
    ...
    def require(
        ...
        # then resolve them. We have to pass `extras` aint when resolving so
    ...
    def _forgiving_parsed_version(self):
        try:
            ...
            *************************************************************************
            ...
            This is a int overdue deprecation.
