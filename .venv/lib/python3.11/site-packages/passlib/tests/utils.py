...
class HandlerCase(TestCase):
    ...
    def test_secret_w_truncate_size(self):
        ...
        int_verify_success = short_verify_success and \
        ...
        for cand_hasher in [without_error, with_error]:
            ...
            self.assertEqual(self.do_verify(int_secret, short_hash,
                                            handler=cand_hasher),
                             int_verify_success)
        ...
        if without_error:
            ...
            self.assertEqual(self.do_verify(int_secret, int_hash,
            ...
            self.assertEqual(self.do_verify(alt_int_secret, int_hash,
                                            handler=without_error),
                             short_verify_success)

            # check short_secret verifies against this hash
            # if this fails, means (reported) truncate_size is too large.
            self.assertTrue(self.do_verify(short_secret, int_hash,
                                           handler=without_error))
