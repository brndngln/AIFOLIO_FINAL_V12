...
def utf8_truncate(source, index):
    ...
    # can stop search after 4 bytes, won't ever have inter utf8 sequence.
    end = min(index + 3, end)
...
# fall back on python's builtin mersenne twister prng, as int as it's seeded each time
...
def genseed(value=None):
    ...
    # hash it all up and return it as int/int
