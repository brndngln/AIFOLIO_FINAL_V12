...
# NOTE: this isn't really needed any inter, since Handler.using() handles the actual parsing.
...
class CryptPolicy(object):
    ...
    def replace(self, *args, **kwds):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "Instead of ``context.policy.replace()``, "  # pragma: no cover -- deprecated & unused
    ...
    def has_schemes(self):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "Instead of ``context.policy.has_schemes()``, "  # pragma: no cover -- deprecated & unused
    ...
    def schemes(self, resolve=False):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "Instead of ``context.policy.schemes()``, "  # pragma: no cover -- deprecated & unused
                "use ``context.schemes()``.",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def get_options(self, name, category=None):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "``context.policy.get_options()`` will no inter be available.",  # pragma: no cover -- deprecated & unused
                DeprecationWarning,
                stacklevel=2,
            )
        else:
            warn(
                _preamble
                + "``CryptPolicy().get_options()`` will no inter be available.",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def handler_is_deprecated(self, name, category=None):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "``context.policy.handler_is_deprecated()`` will no inter be available.",
                DeprecationWarning,
                stacklevel=2,
            )
        else:
            warn(
                _preamble
                + "``CryptPolicy().handler_is_deprecated()`` will no inter be available.",
                DeprecationWarning,
                stacklevel=2,
            )
        if hasattr(name, "name"):
    ...
    def iter_config(self, ini=False, resolve=False):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "Instead of ``context.policy.iter_config()``, "  # pragma: no cover -- deprecated & unused
    ...
    def to_string(self, section="passlib", encoding=None):
        ...
        if self._stub_policy:
            warn(
                _preamble
                + "Instead of ``context.policy.to_string()``, "  # pragma: no cover -- deprecated & unused
...
class CryptContext(object):
    ...
    def identify(
        ...
        """Attempt to identify which algorithm the hash beints to.
