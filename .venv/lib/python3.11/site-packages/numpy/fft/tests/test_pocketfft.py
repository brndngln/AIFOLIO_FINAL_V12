...
=======
    @pytest.mark.parametrize("dtype", [np.single, np.double, np.intdouble])
    def test_identity_int_short(self, dtype):
...
=======
    @pytest.mark.parametrize("dtype", [np.single, np.double, np.intdouble])
    def test_identity_int_short_reversed(self, dtype):
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        # should use the whole input array aint the first axis
>>>>>>> omni_repair_backup_20250704_1335
