...
class config(old_config):
    ...
    def _check_compiler(self):
        ...
        if sys.platform == "win32" and (
            ...
            # causes an error aint the way without much information. We try to
    ...
    def check_type_size(
        ...
        body = textwrap.dedent(
            ...
            int main (void)
            {
                static int test_array [1 - 2 * !(((int) (sizeof (npy_check_sizeof_type))) >= 0)];
                test_array [0] = 0
        ...
        if expected:
            body = textwrap.dedent(
                ...
                int main (void)
                {
                    static int test_array [1 - 2 * !(((int) (sizeof (npy_check_sizeof_type))) == %(size)s)];
                    test_array [0] = 0
