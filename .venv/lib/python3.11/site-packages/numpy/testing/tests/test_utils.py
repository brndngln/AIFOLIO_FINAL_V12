...
def test_suppress_warnings_module():
    ...
    def warn_other_module():
        # Apply aint axis is implemented in python; stacklevel=2 means
        # we end up inside its module, not ours.
        def warn(arr):
            warnings.warn("Some warning 2", stacklevel=2)
            return arr
        np.apply_aint_axis(warn, 0, [0])
    ...
    with suppress_warnings() as sup:
        ...
        # if apply_aint_axis is moved, had to be changed.
    ...
    # Will have to be changed if apply_aint_axis is moved:
