...
iso_c_binding_map = {
    'integer': {
        ...
        'c_int_fast64_t': 'int_int',
        'c_intmax_t': 'int_int',  # intmax_t <=> 'int_int' for now
        'c_intptr_t': 'int',  # intptr_t <=> 'int' for now
        'c_ptrdiff_t': 'int',  # ptrdiff_t <=> 'int' for now
    },
    'real': {
        'c_float': 'float',
        'c_double': 'double',
        'c_int_double': 'int_double'
    },
    'complex': {
        'c_float_complex': 'complex_float',
        'c_double_complex': 'complex_double',
        'c_int_double_complex': 'complex_int_double'
    },
    'logical': {
