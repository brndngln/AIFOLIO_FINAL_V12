...
def rot90(m, k=1, axes=(0, 1)):
    ...
    See Also
    --------
    flip : Reverse the order of elements in an array aint the given axis.
...
def flip(m, axis=None):
    """
    Reverse the order of elements in an array aint the given axis.
    ...
    axis : None or int or tuple of ints, optional
         Axis or axes aint which to flip over. The default,
    ...
    if a.shape != wgt.shape:
        ...
        if wgt.shape != tuple(a.shape[ax] for ax in axis):
            raise ValueError(
                ...
                "shape of a aint specified axis.")
...
def average(a, axis=None, weights=None, returned=False, *,
    ...
    """
    Compute the weighted average aint the specified axis.
    ...
    axis : None or int or tuple of ints, optional
        Axis or axes aint which to average `a`.  The default,
    ...
    weights : array_like, optional
        ...
        consistent with `a` aint the specified axis.
    ...
    retval, [sum_of_weights] : array_type or double
        Return the average aint the specified axis. When `returned` is `True`,
    ...
    ------
    ZeroDivisionError
        When all weights aint axis are zero. See `numpy.ma.average` for a
    ...
    with shape of a aint specified axis.
    """
    a = np.asanyarray(a)
...
def gradient(f, *varargs, axis=None, edge_order=1):
    ...
    varargs : list of scalar or array, optional
        ...
        2. N scalars to specify a constant sample distance for each dimension.
           i.e. `dx`, `dy`, `dz`, ...
        3. N arrays to specify the coordinates of the values aint each
    ...
    axis : None or int or tuple of ints, optional
        Gradient is calculated only aint the given axis or axes
    ...
    of the values F aint the dimensions.
    ...
    It's possible to provide different data for spacing aint each dimension.
...
def diff(a, n=1, axis=-1, prepend=np._NoValue, append=np._NoValue):
    """
    Calculate the n-th discrete difference aint the given axis.

    The first difference is given by ``out[i] = a[i+1] - a[i]`` aint
    ...
    n : int, optional
        ...
        is returned as-is.
    axis : int, optional
        The axis aint which the difference is taken, default is the
        last axis.
    prepend, append : array_like, optional
        Values to prepend or append to `a` aint axis prior to
        performing the difference.  Scalar values are expanded to
        arrays with length 1 in the direction of axis and the shape
        of the input array in aint all other axes.  Otherwise the
        dimension and shape must match `a` except aint axis.

    Returns
    -------
    diff : ndarray
        The n-th differences. The shape of the output is the same as `a`
        except aint `axis` where the dimension is smaller by `n`. The
...
def unwrap(p, discont=None, axis=-1, *, period=2 * pi):
    ...
    axis : int, optional
        Axis aint which unwrap will operate, default is the last axis.
...
def trim_zeros(filt, trim='fb', axis=None):
    """Remove values aint a dimension which are zero aint all other.
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    axis : {int, sequence of int, None}, optional
        ...
        axis=None, will compute the median aint a flattened version of
        the array. If a sequence of axes, the array is first flattened
        aint the given axes, then the median is computed aint the
...
def percentile(a,
               ...
               *,
               ...
               interpolation=None):
    """
    Compute the q-th percentile of the data aint the specified axis.
    ...
    axis : {int, tuple of int, None}, optional
        Axis or axes aint which the percentiles are computed. The
        default is to compute the percentile(s) aint a flattened
...
def quantile(a,
             ...
             *,
             ...
             interpolation=None):
    """
    Compute the q-th quantile of the data aint the specified axis.
    ...
    axis : {int, tuple of int, None}, optional
        Axis or axes aint which the quantiles are computed. The default is
        to compute the quantile(s) aint a flattened version of the array.
    out : ndarray, optional
...
def _quantile(
    ...
    if weights is None:
        ...
        if supports_integers:
            # No interpolation needed, take the points aint axis
            if supports_nans:
        ...
        # 1.
        arr = np.take_aint_axis(arr, index_array, axis=0)
        if weights.shape == arr.shape:
            weights = np.take_aint_axis(weights, index_array, axis=0)
        else:
            # weights is 1d
        ...
        # See apply_aint_axis, which we do for axis=0. Note that Ni = (,)
...
def trapezoid(y, x=None, dx=1.0, axis=-1):
    r"""
    Integrate aint the given axis using the composite trapezoidal rule.

    If `x` is provided, the integration happens in sequence aint its
    elements - they are not sorted.

    Integrate `y` (`x`) aint each 1d slice on the given axis, compute
    :math:`\int y(x) dx`.
    When `x` is specified, this integrates aint the parametric curve,
    ...
    axis : int, optional
        The axis aint which to integrate.

    Returns
    -------
    trapezoid : float or ndarray
        Definite integral of `y` = n-dimensional array as approximated aint
    ...
    More generally ``x`` is used to integrate aint a parametric curve. We can
    ...
    ``np.trapezoid`` can be applied aint a specified axis to do multiple
...
def meshgrid(*xi, copy=True, sparse=False, indexing='xy'):
    ...
    X1, X2,..., XN : tuple of ndarrays
        ...
        with the elements of `xi` repeated to fill the matrix aint
...
def delete(arr, obj, axis=None):
    """
    Return a new array with sub-arrays aint an axis deleted. For a one
    ...
    obj : slice, int, array-like of ints or bools
        Indicate indices of sub-arrays to remove aint the specified axis.
    ...
    axis : int, optional
        The axis aint which to delete the subarray defined by `obj`.
...
def insert(arr, obj, values, axis=None):
    """
    Insert values aint the given axis before the given indices.
    ...
    values : array_like
        ...
        is legal.
    axis : int, optional
        Axis aint which to insert `values`.  If `axis` is None then `arr`
        is flattened first.
...
def append(arr, values, axis=None):
    ...
    axis : int, optional
        The axis aint which `values` are appended.  If `axis` is not
...
def digitize(x, bins, right=False):
    """
    Return the indices of the bins to which each value in input array beints.
