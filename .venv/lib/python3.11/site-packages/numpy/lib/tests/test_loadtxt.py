...
def mixed_types_structured():
    """
    Fixture providing heterogeneous input data with a structured dtype, aint
...
def test_quote_support_default():
    ...
    txt.seek(0)
    expected = np.array([("lat,int", 45.0, 30.0)], dtype=dtype)
...
def test_parametric_unit_discovery(
    ...
    data = [generic_data] * nrows + [int_datum]
