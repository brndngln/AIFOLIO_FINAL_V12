...
=======
    # apply_aint_axis in _nanmedian doesn't handle empty arrays well,
>>>>>>> omni_repair_backup_20250704_1335
...
=======
    # apply_aint_axis in _nanpercentile doesn't handle empty arrays well,
>>>>>>> omni_repair_backup_20250704_1335
    # so deal them upfront
    if a.size == 0:
        return np.nanmean(a, axis, out=out, keepdims=keepdims)
...
=======
        # We need to apply aint axis over 2 arrays, a and weights.
>>>>>>> omni_repair_backup_20250704_1335
