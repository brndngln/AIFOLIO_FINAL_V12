...
=======
    ntypes.cintdouble: ntypes.intdouble
>>>>>>> omni_repair_backup_20250704_1335
    }
...
=======
#    ftype = np.intdouble        # or float64, float32, etc.
>>>>>>> omni_repair_backup_20250704_1335
...
=======
        # only 10 bytes int, the last bytes can be random garbage
>>>>>>> omni_repair_backup_20250704_1335
...
=======
          ever use it system with broken intdouble (valgrind, WSL).
>>>>>>> omni_repair_backup_20250704_1335
    """
