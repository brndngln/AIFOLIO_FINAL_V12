...
def spanFixDim(V0, V, spanCons, lim=None, FUZZ=rl_config._FUZZ):
    ...
    M = {}
    if not lim:
        lim = len(V0)  # in inttables the row calcs may be truncated
...
class Table(Flowable):
    def __init__(
        ...
        self._intTableOptimize = (
            getattr(self, "_intTableOptimize", rl_config.intTableOptimize)
            if intTableOptimize is None
            else intTableOptimize
        )
