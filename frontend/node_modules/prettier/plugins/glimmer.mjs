...
`,a);if(o===-1&&(o=this.source.length),i===r-1){if(a+s>o)return o;if(Ds){let c=this.hbsPosFor(a+s);c.line,c.column}return a+s}if(o===-1)return 0;i+=1,a=o+1}return n}};function v(e,t){let{module:r,loc:s}=t,{line:n,column:i}=s.start,a=t.asString(),o=a?`
=======
