...
`;e=Y(!1,e.replace(sc,"").replace(nc,""),ac,"$1");let r="";for(;r!==e;)r=e,e=Y(!1,e,ic,`${t}$1 $2${t}`);e=e.replace(ni,"").trimEnd();let n=Object.create(null),s=Y(!1,e,si,"").replace(ni,"").trimEnd(),u;for(;u=si.exec(e);){let i=Y(!1,u[2],uc,"");if(typeof n[u[1]]=="string"||Array.isArray(n[u[1]])){let a=n[u[1]];n[u[1]]=[...ai,...Array.isArray(a)?a:[a],i]}else n[u[1]]=i}return{comments:s,pragmas:n}}function li({comments:e="",pragmas:t={}}){let r=`
...
`);return t===-1?e:e.slice(0,t)}var mi=oc;function pc(e){let t=mi(e);t&&(e=e.slice(t.length+1));let r=oi(e),{pragmas:n,comments:s}=ci(r);return{shebang:t,text:e,pragmas:n,comments:s}}function yi(e){let{shebang:t,text:r,pragmas:n,comments:s}=pc(e),u=pi(r),i=li({pragmas:{format:"",...n},comments:s.trimStart()});return(t?`${t}
=======
