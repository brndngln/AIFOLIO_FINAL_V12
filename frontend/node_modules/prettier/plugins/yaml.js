...
${e}${t.slice(A+1,_)}`)}return L}var Un=({indentAtStart:t})=>t?Object.assign({indentAtStart:t},Ne.fold):Ne.fold,jt=t=>/^(%|---|\.\.\.)/m.test(t);function $o(t,e,n){if(!e||e<0)return!1;let r=e-n,s=t.length;if(s<=r)return!1;for(let i=0,o=0;i<s;++i)if(t[i]===`
...
${n}`)+"'";return e.implicitKey?r:Wt(r,n,qs,Un(e))}function Kt({comment:t,type:e,value:n},r,s,i){if(/\n[\t ]+$/.test(n)||/^\s*$/.test(n))return we(n,r);let o=r.indent||(r.forceBlockIndent||jt(n)?"  ":""),a=o?"2":"1",c=e===p.Type.BLOCK_FOLDED?!1:e===p.Type.BLOCK_LITERAL?!0:!$o(n,Ne.fold.lineWidth,o.length),l=c?"|":">";if(!n)return l+`
=======
