      ...
      <div style={{maxWidth:500,padding:30,background:'#222',borderRadius:18,boxShadow:'0 8px 32px rgba(0,0,0,0.25)'}}>
        ...
        <div style={{marginTop:24,display:'flex',justifyContent:'center'}}>
          {step < steps.length-1 ? (
            ...
            <button onClick={onClose} style={{fontSize:18,padding:'12px 32px',borderRadius:8,background:'#22c55e',color:'#fff',border:'none',boxShadow:'0 2px 8px #222',cursor:'pointer'}}>Finish</button>
          )}
        </div>
      </div>
    </div>
