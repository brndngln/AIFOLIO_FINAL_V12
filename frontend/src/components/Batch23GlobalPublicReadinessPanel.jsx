...
const STATIC_REPORTS = [
  {
    name: "Business Readiness Scorecard",
    updated: "2025-06-22T13:00:00-06:00",
    file: "readiness_scorecard.pdf",
  },
  {
    name: "Global Impact Report",
    updated: "2025-06-22T12:30:00-06:00",
    file: "global_impact.pdf",
  },
  {
    name: "Impact Summary",
    updated: "2025-06-22T12:00:00-06:00",
    file: "impact_summary.pdf",
  },
  {
    name: "Compliance Heatmap",
    updated: "2025-06-22T11:30:00-06:00",
    file: "compliance_heatmap.pdf",
  },
  {
    name: "Partner Alignment Dashboard",
    updated: "2025-06-22T11:00:00-06:00",
    file: "partner_alignment.pdf",
  },
];
...
export default function Batch23GlobalPublicReadinessPanel({ onExport }) {
  ...
  return (
    <div
      className="batch23-panel"
      aria-label="Global Public Readiness"
      tabIndex={0}
