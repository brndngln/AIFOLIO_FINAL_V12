  ...
  return (
    <div className="phase-control-panel">
      ...
      <div className="phase-panel-status">
        ...
        <div>
          <strong>Safe Mode:</strong> {safeMode}
        </div>
        <div>
          <strong>Last Upgrade:</strong> {lastUpgrade}
        </div>
        <div>
          <strong>Next Scheduled Upgrade:</strong> {nextUpgrade}
        </div>
        <div>
          <strong>System Integrity:</strong> {systemIntegrity}
        </div>
      </div>
