...
const BATCHES = Array.from({ length: 16 }, (_, i) => ({
  ...
  exports: [
    {
      name: `Batch ${i + 1} PDF Report`,
      type: "PDF",
      file: `batch${i + 1}_report.pdf`,
    },
    {
      name: `Batch ${i + 1} CSV Data`,
      type: "CSV",
      file: `batch${i + 1}_data.csv`,
    },
    {
      name: `Batch ${i + 1} Public Summary`,
      type: "PDF",
      file: `batch${i + 1}_public_summary.pdf`,
    },
  ],
...
export default function BatchTabs1to16() {
  ...
  return (
    <section
      className="batch-tabs-1-16"
      aria-label="Batch Modules 1–16"
      tabIndex={0}
    >
      <nav
      ...
      >
        <h3 style={{ color: "#0f172a", marginBottom: 8 }}>
          {currentBatch.label} Exports
        </h3>
        <div style={{ color: "#64748b", fontSize: 13, marginBottom: 8 }}>
          Last updated: {currentBatch.lastUpdated}
        </div>
