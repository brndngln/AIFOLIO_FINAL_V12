...
const EthicalDashboard = () => {
    ...
    return (
        <div className="ethical-dashboard" style={{
            ...
            <div className="activity-log" style={{
                ...
                <div className="log-items" style={{
                    maxHeight: '400px',
                    overflowY: 'auto',
                    marginTop: '1rem'
                }}>
                    {activityLog.map((activity) => (
                        <div key={activity.id} className="log-item" style={{
                            padding: '0.5rem',
                            borderBottom: `1px solid ${theme.border}`,
                            display: 'flex',
                            ...
                            <div>
                                ...
                                <span style={{
                                    color: theme.text,
                                    marginLeft: '0.5rem'
                                }}>at {formatTimestamp(activity.timestamp)}</span>
                            </div>
                            <div style={{
                                color: activity.metadata.error ? theme.error : theme.secondary
                            }}>
