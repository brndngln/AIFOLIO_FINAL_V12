...
function CompoundingVaultPanel({ onAction }) {
  ...
  if (loading)
    return <div className="theme-card">Loading compounding vaults...</div>;
  if (error) return <div className="theme-card text-error">{error}</div>;

  return (
    <section
      aria-labelledby="compounding-vault-heading"
      style={{
        background: "#fef9c3",
        borderRadius: 14,
        padding: 32,
    ...
    >
      ...
      >
        <h3
          id="compounding-vault-heading"
          style={{ color: "#eab308", fontWeight: 700, margin: 0 }}
        >
          Compounding Vault Controls
        </h3>
        <span
          style={{
            background: "#eab308",
        ...
        <span
          tabIndex={0}
          aria-label="Help: What are Compounding Vaults?"
          title="Static, deterministic compounding vault controls. OWNER controls all actions and exports."
          style={{
            marginLeft: 6,
            color: "#64748b",
            cursor: "help",
      ...
      <table
        aria-label="Compounding vaults list"
        style={{
          width: "100%",
          marginBottom: 18,
          background: "#fff",
            ...
            <tr key={i}>
              ...
              <td>
                <button
                  ...
                  onClick={() =>
                    onAction && onAction("auditCompoundingVault", { vault: v })
                  }
                >
                  Audit
                </button>
      ...
      >
        ...
        <button
          ...
          onClick={() =>
            onAction && onAction("auditAllCompoundingVaults", { vaults })
          }
        >
          Audit All
        </button>
