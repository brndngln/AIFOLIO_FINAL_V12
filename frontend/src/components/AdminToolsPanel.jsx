...
export default function AdminToolsPanel({ token }) {
  ...
  return (
    <section className="admin-tools-panel" aria-label="Admin Tools" style={{
      marginTop: 32,
      ...
      <div aria-label="Auto-Repair Daemon Status" style={{
        ...
        <span style={{ fontWeight: 800, fontSize: 20, color: '#0c837c', marginRight: 8 }}>Auto-Repair Daemon</span>
        <span style={{ background: '#e3f9f6', color: '#0c837c', borderRadius: 8, padding: '0.3em 1em', fontWeight: 700, fontSize: 17 }}>Operational</span>
        <span style={{ marginLeft: 16, color: '#888', fontSize: 15 }}>All monitored services healthy. Last escalation: None.</span>
        <button aria-label="Escalate Issue" style={{ marginLeft: 'auto', background: '#e53e3e', color: '#fff', border: 'none', borderRadius: 7, padding: '0.5em 1.2em', fontWeight: 700, cursor: 'pointer', fontSize: 15, boxShadow: '0 1px 4px #e53e3e33' }} onClick={()=>alert('Escalation triggered. SAFE AI audit logged.')}>Escalate</button>
      </div>
      <nav aria-label="Admin Tool Tabs" style={{
        marginBottom: 24,
        display: 'flex',
        gap: 10,
