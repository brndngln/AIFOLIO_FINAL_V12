...
const STATIC_REPORTS = [
  { name: "Federation Alignment Report", updated: "2025-06-22T15:00:00-06:00", file: "federation_alignment.pdf" },
  { name: "Ecosystem Map", updated: "2025-06-22T14:00:00-06:00", file: "ecosystem_map.pdf" },
  { name: "Public Trust Badge", updated: "2025-06-22T13:00:00-06:00", file: "public_trust_badge.pdf" },
  { name: "Auditor Certification Export", updated: "2025-06-22T12:00:00-06:00", file: "auditor_certification.pdf" }
];
...
export default function Batch21FederatedTrustPanel({ onExport }) {
  ...
  return (
    <div className="batch21-panel" aria-label="Federated Trust & Governance" tabIndex={0} style={{background:'#f9fafb',padding:20,borderRadius:8}}>
      <h3 style={{color:'#0f172a'}}>Batch 21: Federated Trust & Governance</h3>
