...
export default function WorldTrustDashboard() {
  return (
    <div style={{marginTop:32, background:'#fff', borderRadius:8, padding:24, boxShadow:'0 1px 3px #e5e7eb'}}>
      <h3 style={{color:'#059669', fontWeight:700, marginBottom:12}}>World Trust & Transparency Dashboard</h3>
      ...
      <div style={{marginTop:18, color:'#64748b', fontSize:13}}>
        <b>OWNER CONTROLLED:</b> No auto-publicity, no adaptive dashboards, all reports static and exportable only by OWNER.
      </div>
    </div>
  );
}
