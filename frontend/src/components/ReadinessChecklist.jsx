...
function ReadAIFOLIOChecklist() {
  return (
    ...
    >
      <h3 style={{ color: "#2563eb", fontWeight: 600, marginBottom: 8 }}>
        SAFE AI READINESS CHECKLIST
      </h3>
      <ul
        style={{
          listStyle: "none",
      ...
      >
        {AIFOLIO.map((item, i) => (
          <li key={i} style={{ marginBottom: 6 }}>
            <span style={{ color: "#2563eb", fontWeight: 500 }}>✔</span> {item}
          </li>
        ))}
      </ul>
      <h3 style={{ color: "#059669", fontWeight: 600, marginBottom: 8 }}>
        SAFE AI PUBLIC READINESS CHECKLIST
      </h3>
