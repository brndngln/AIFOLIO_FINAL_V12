...
export default function OwnerBrandCustomizationPanel() {
  ...
  return (
    <section
      aria-labelledby="brand-customization-heading"
      style={{
        background: "#f9fafb",
        borderRadius: 12,
        padding: 32,
    ...
    >
      ...
      >
        <h2
          id="brand-customization-heading"
          style={{ color: "#0ea5e9", fontWeight: 800, fontSize: 22, margin: 0 }}
        >
          OWNER Brand Customization
        </h2>
        <span
          style={{
            background: "#0ea5e9",
        ...
        <span
          tabIndex={0}
          aria-label="Help: Brand customization"
          title="Change your business name, logo, and highlight color. Static preview only."
          style={{
            marginLeft: 6,
            color: "#64748b",
            cursor: "help",
      ...
      <form
        ...
        aria-label="Brand customization form"
      >
      ...
      >
        ...
        >
          ...
          />
          <span style={{ fontWeight: 700, fontSize: 19, color: brand.color }}>
            {brand.name}
          </span>
        </div>
      </div>
      <div style={{ marginTop: 18, color: "#64748b", fontSize: 13 }}>
        <b>OWNER CONTROLLED:</b> Brand settings are saved in your browser only.
        No backend or adaptive logic.
      </div>
    </section>
  );
}
