    ...
    <div
      ...
      style={{
        backgroundColor: hexToRgb(
          theme.customColors?.button?.background || "#D2B48C",
        ),
      }}
    >
      <h3
        ...
        style={{
          ...
          backgroundColor: hexToRgb(
            theme.customColors?.button?.accent || "#2E3D2E",
          ),
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <button className="preview-button">Click Me</button>
        </div>
        ...
        <div className="space-y-2">
          ...
          <button className="preview-button-danger">Delete</button>
        </div>
