...
export default function GDPRDashboardPanel() {
  const features = [
    {
      label: "Static GDPR dashboard",
      desc: "Dashboard for access/delete GDPR requests",
    },
    {
      label: "OWNER can log/export",
      desc: "OWNER can log and export GDPR requests",
    },
    {
      label: "Audit-logged actions",
      desc: "All actions are statically audit-logged",
    },
  ];
  return (
    <section
    ...
    >
      ...
      >
        ...
        >
          SAFE AI GDPR Request Dashboard
        </h3>
        <span
          style={{
            background: "#0c837c",
        ...
        <span
          tabIndex={0}
          aria-label="Help: What is the GDPR Dashboard?"
          title="Static, deterministic GDPR request log. OWNER controls all exports."
          style={{
            marginLeft: 8,
            color: "#64748b",
            cursor: "help",
      ...
      <ul
        ...
        aria-label="GDPR dashboard features"
      >
        {features.map((f, i) => (
          <li
            key={i}
      ...
      <div style={{ display: "flex", gap: 14, marginTop: 10 }}>
        ...
        <button
          ...
          onClick={() =>
            alert(
              "GDPR export audited and logged. SAFE AI compliance enforced.",
            )
          }
        >
          Audit Export
