...
export default function SupportPanel() {
  return (
    <section aria-labelledby="support-heading" style={{background:'#f0fdfa',borderRadius:12,padding:24,marginBottom:24,boxShadow:'0 1px 4px #bae6fd'}}>
      <h3 id="support-heading" style={{color:'#0ea5e9',fontWeight:700,marginBottom:10}}>Support & Contact</h3>
