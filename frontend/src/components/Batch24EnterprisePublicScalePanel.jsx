...
const STATIC_REPORTS = [
  { name: "Enterprise System Audit Report", updated: "2025-06-22T13:00:00-06:00", file: "enterprise_audit.pdf" },
  { name: "Executive Public Summary", updated: "2025-06-22T12:30:00-06:00", file: "executive_summary.pdf" },
  { name: "Public Trust & Risk Index", updated: "2025-06-22T12:00:00-06:00", file: "trust_risk_index.pdf" },
  { name: "Global Readiness Checklist", updated: "2025-06-22T11:30:00-06:00", file: "readiness_checklist.pdf" },
  { name: "Trusted SAFE AI Badge", updated: "2025-06-22T11:00:00-06:00", file: "trusted_badge.pdf" },
  { name: "Ecosystem Report", updated: "2025-06-22T10:30:00-06:00", file: "ecosystem_report.pdf" }
];
...
export default function Batch24EnterprisePublicScalePanel({ onExport }) {
  ...
  return (
    <div className="batch24-panel" aria-label="Enterprise & Public Scale" tabIndex={0} style={{background:'#f9fafb',padding:20,borderRadius:8}}>
      <h3 style={{color:'#0f172a'}}>Batch 24: Enterprise & Public Scale Operations</h3>
