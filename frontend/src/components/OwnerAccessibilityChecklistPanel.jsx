  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          tabIndex={0}
          aria-label="Help: Accessibility checklist"
          title="OWNER accessibility best practices for all static panels and exports."
          style={{
            marginLeft: 6,
            color: "#64748b",
            cursor: "help",
      ...
      <div style={{ marginBottom: 18 }} aria-label="Accessibility progress">
        ...
        <span style={{ fontSize: 13, color: "#64748b" }}>
          {completeCount} of {CHECKLIST.length} checks complete
        </span>
      </div>
      <ul
      ...
      >
        {CHECKLIST.map((item, i) => (
          ...
          >
            ...
            />
            <span tabIndex={0} aria-label={`Accessibility check: ${item}`}>
              {item}
            </span>
          </li>
        ))}
      ...
      <div style={{ marginTop: 18, color: "#64748b", fontSize: 13 }}>
        <b>Tip:</b> Complete all checks for best OWNER and user accessibility
        compliance.
      </div>
    </section>
  );
