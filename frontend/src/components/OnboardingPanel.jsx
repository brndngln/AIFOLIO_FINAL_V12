...
export default function OnboardingPanel() {
  return (
    <section aria-labelledby="onboarding-heading" style={{background:'#f0fdfa',borderRadius:12,padding:32,marginBottom:32,boxShadow:'0 2px 8px #e0f2fe'}}>
      <h2 id="onboarding-heading" style={{color:'#0ea5e9',fontWeight:800,fontSize:28,marginBottom:12}}>Welcome to AIFOLIO™ SAFE AI Business Dashboard</h2>
      <p style={{fontSize:16,color:'#334155',marginBottom:10}}>
        This dashboard is static, deterministic, and fully OWNER-controlled. Use the checklist below to get started and ensure your SAFE AI business is compliant and ready for launch.
      </p>
      <ol style={{fontSize:15,marginLeft:18,marginBottom:18}}>
        ...
        <li>Complete all business checklists and safeguard panels.</li>
