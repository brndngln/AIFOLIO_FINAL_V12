  ...
  return (
    <section
      ...
      style={{
        ...
        padding: 24,
        marginBottom: 24,
        boxShadow: "0 1px 4px #fde68a",
      }}
    >
      <h3
        id="first-steps-heading"
        style={{ color: "#f59e42", fontWeight: 700, marginBottom: 10 }}
      >
        OWNER First Steps Checklist
      </h3>
      <ul style={{ listStyle: "none", padding: 0, fontSize: 15 }}>
        {STEPS.map((step, i) => (
          <li key={i} style={{ marginBottom: 8 }}>
            <span style={{ color: "#f59e42", fontWeight: 600 }}>✔</span> {step}
          </li>
        ))}
      </ul>
    </section>
