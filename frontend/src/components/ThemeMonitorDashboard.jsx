...
const ThemeMonitorDashboard = () => {
  ...
  return (
    <div
      className="theme-monitor-dashboard"
      style={{
    ...
    >
      ...
      >
        <ThemeMetricCard
          ...
          color={
            themeMetrics.consistency < 80
              ? theme.error
              : themeMetrics.consistency < 90
                ? theme.warning
                : theme.accent
          }
        ...
        <ThemeMetricCard
          ...
          color={
            themeMetrics.contrast < 70
              ? theme.error
              : themeMetrics.contrast < 80
                ? theme.warning
                : theme.accent
          }
        ...
        <ThemeMetricCard
          ...
          color={
            themeMetrics.accessibility < 70
              ? theme.error
              : themeMetrics.accessibility < 80
                ? theme.warning
                : theme.accent
          }
