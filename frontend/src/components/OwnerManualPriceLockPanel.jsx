...
export default function OwnerManualPriceLockPanel() {
  return (
    <section
      aria-labelledby="manual-price-lock-heading"
      style={{
        background: "#f1f5f9",
        borderRadius: 12,
        padding: 24,
    ...
    >
      <h3
        id="manual-price-lock-heading"
        style={{ color: "#0ea5e9", fontWeight: 700, marginBottom: 10 }}
      >
        Manual Price Lock
      </h3>
      <p style={{ fontSize: 15, marginBottom: 12 }}>
        OWNER can set and lock the price for any vault. All pricing is static,
        deterministic, and audit-logged. No adaptive/AI pricing.
      </p>
      <input
        type="number"
        min="1"
