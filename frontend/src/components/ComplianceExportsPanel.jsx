  ...
  return (
    ...
    >
      <div style={{display:'flex',alignItems:'center',gap:12,marginBottom:16}}>
        <h3 id="compliance-exports-heading" style={{color:'#0c837c',fontWeight:800,fontSize:25,margin:0,letterSpacing:'0.01em'}}>SAFE AI Compliance Export</h3>
        ...
        <span tabIndex={0} aria-label="Help: What is Compliance Export?" title="OWNER can export static compliance logs for audits. No adaptive logic." style={{marginLeft:8, color:'#64748b', cursor:'help', fontSize:18, fontWeight:800}}>?</span>
      </div>
      <ul style={{fontSize:16,margin:0,padding:0,listStyle:'none',marginBottom:12}} aria-label="Compliance export features">
        {features.map((f, i) => (
      ...
      <div style={{display:'flex',gap:14,marginTop:10}}>
        ...
        <button
          ...
          onClick={()=>alert('Compliance export audited and logged. SAFE AI compliance enforced.')}
        >
          Audit Export
        </button>
      </div>
