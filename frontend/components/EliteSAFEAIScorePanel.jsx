...
export default function EliteSAFEAIScorePanel({ score = 98, details = {} }) {
  return (
    <Paper sx={{ p: 3, mb: 2 }}>
      ...
      <Divider sx={{ mb: 2 }} />
      <Chip label={`Score: ${score}`} color={score > 90 ? 'success' : score > 75 ? 'warning' : 'error'} sx={{ fontSize: 18, mb: 2 }} />
      <Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>This score is a static, deterministic SAFE AI compliance metric, fully auditable and owner-controlled.</Typography>
      <Box mt={2}>
