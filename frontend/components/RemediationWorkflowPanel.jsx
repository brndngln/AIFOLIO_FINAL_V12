...
const RemediationWorkflowPanel = ({ adminId }) => {
  ...
  const handleSubmit = (control) => {
    axios
      .post("/api/remediation/submit", { control, admin_id: adminId })
      .then(() => {
        setSnackbar("Remediation workflow submitted!");
        fetchWorkflows();
      })
  ...
  const handleUpdate = (idx, status) => {
    axios
      .post("/api/remediation/update_status", {
        idx,
        status,
        reviewer: adminId,
      })
                    ...
                    {w.status === "submitted" && (
                      <>
                        <Button
                          size="small"
                          color="success"
                          onClick={() => handleUpdate(i, "completed")}
                        >
                          Mark Complete
                        </Button>
                        <Button
