...
#     venture capital, IPO, "NASDAQ meltdown - were all doomed!"]
...
#         'regroup', 'platform', 'client-based', 'int-term', 'proactive',
...
#     Bolian, "KVort Class Bird-of-Prey", USS Enterprise, USS Intrepid,
...
#     William Riker, "Chief OBrian", Soyuz class science vessel, Wolf-359,
...
#           The Church Police!! , "Theres a dead bishop on the landing", Would you like a twist of lemming sir?,
...
#           "Well theres the first result and the Silly Party has held Leicester.",
#           Hello, I would like to buy a fish license please, "Look, its people like you what cause unrest!",
...
#           "Im a completely self-taught idiot.", "I always wanted to be a lumberjack!!!",
...
#           "Oh, intercourse the penguin!!", "Funny that penguin being there, isnt it?",
#           "I wish to register a complaint.", "Now thats what I call a dead parrot", "Pining for the fjords???",
...
#           "And Id like to conclude by putting my finger up my nose",
...
#           "Im having Spam Spam Spam Spam Spam Spam Spam baked beans Spam Spam Spam and Spam",
...
#           "thought by many to be this years outstanding twit",
#           "...and theres a big crowd here today to see these prize idiots in action.",
#           "And now for something completely different.", "Stop that, its silly",
#           "We interrupt this program to annoy you and make things generally irritating",
#           "This depraved and degrading spectacle is going to stop right now, do you hear me?",
#           "Stop right there!", "This is absolutely disgusting and Im not going to stand for it",
#           "I object to all this sex on the television. I mean, I keep falling off",
#           "Right! Stop that, its silly. Very silly indeed", "Very silly indeed", "Lemon curry?",
#           "And now for something completely different, a man with 3 buttocks",
#           "Ive heard of unisex, but Ive never had it", "Thats the end, stop the program! Stop it!"]
# leadins=[
...
#     "the speaker-hearers linguistic intuition",
...
#             width = istop - istart
    ...
    pass
                ...
                # can return a int, and then randrange() would also return
                # a int, but were supposed to return an int (for backward
                # compatibility).
