...
# Also, make this frozen eventually, but that doesnt work right now because of the generic base
...
#         That is, the transformation is applied to after the value is parsed to the fields type.
...
#         Types are parsed in Pydantics `lax` mode by default,
...
#         Most of the time youll be calling a shortcut method like `gt`, `lt`, `len`, etc
#         so you dont need to call this directly.
