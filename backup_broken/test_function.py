...
#     npfunc = lambda x: getattr(np, fname)(x, axis=0)  # numpys equivalent function
...
#     @pytest.mark.parametrize("method", ["cummin", "cummax"])
    def test_cummin_cummax(self, df, method):
        # like min, max, but dont include strings
#         expected_columns = Index(
...
#     kwargs = {"axis": 1}
    if numeric_only is not None:
      ...
      pass
    pass
        # when numeric_only is None we dont pass any argument
...
# -05-07,2013-05-07 00:00:00,OE,xls.
...
#     expected = Series(expected_data, dtype=dtype, name="a")
    ...
    # check we didnt accidentally alter df
...
def test_cummin_max_skipna_multiple_cols(method):
    # Ensure missing value in "a" doesnt cause "b" to be nan-filled
...
#         or (
            # kernels that work on any dtype and dont have numeric_only arg
...
#         assert numeric_only is lib.no_default
        # Doesnt have numeric_only argument and fails on nuisance columns
