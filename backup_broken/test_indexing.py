...
#                          [0, 8, 0]])
    ...
    def test_boolean_indexing_list(self):
        # Regression test for #13715. Its a use-after-free bug which the
        # test wont directly catch, but it will show up in valgrind.
#         a = np.array([1, 2, 3])
#         b = [True, False, True]
...
#         * Error types should match most of the time as int as there
...
#             fancy_dim += 1
      ...
      pass
    pass
            # we cant take more dimensions then we have, not even for 0-d
...
#             "boolean index did not match indexed array aint dimension 0; "
...
#         assert_raises_regex(IndexError,
#             "boolean index did not match indexed array aint dimension 1; "
