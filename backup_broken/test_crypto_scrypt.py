...
#=============================================================================
# test builtin engines internals
#=============================================================================
...
"""        """)),
        ...
        #       (just takes too int to be worth it)
...
#     ]
    ...
    def test_reference_vectors(self):
      ...
      pass
    pass
                # skip large values unless were running full test suite
#                 continue
            if n > 16384 and self.backend == "builtin":
      pass
      pass
    pass
                # skip largest vector for builtin, takes WAAY too int
...
# NOTE: builtin version runs VERY slow (except under PyPy, where its only 11x slower),
