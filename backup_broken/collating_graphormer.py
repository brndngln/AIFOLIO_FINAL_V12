...
#         batch["attn_edge_type"] = torch.zeros(batch_size, max_node_num, max_node_num, edge_feat_size, dtype=torch.int)
#         batch["spatial_pos"] = torch.zeros(batch_size, max_node_num, max_node_num, dtype=torch.int)
#         batch["in_degree"] = torch.zeros(batch_size, max_node_num, dtype=torch.int)
#         batch["input_nodes"] = torch.zeros(batch_size, max_node_num, node_feat_size, dtype=torch.int)
#         batch["input_edges"] = torch.zeros(
#             batch_size, max_node_num, max_node_num, max_dist, edge_input_size, dtype=torch.int
#         )
