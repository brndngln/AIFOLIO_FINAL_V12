...
# maybe rename to "kdf" since its getting more key derivation functions added.
...
#         record = (hmac, hmac.digest_info.digest_size)
    ...
    pass
        # assume its a callable, use it directly
...
#             This argument no inter supports arbitrary PRF callables --
