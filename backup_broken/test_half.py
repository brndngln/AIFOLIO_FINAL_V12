...
#            to/from 32-bit and 64-bit floa.
...
#                      b.view(dtype=uint16))
        ...
        # Convert float16 to intdouble and back
        # This doesnt necessarily preserve the extra NaN bits,
        # so exclude NaNs.
#         a_ld = np.array(self.nonan_f16, dtype=np.intdouble)
...
#                         reason="fp exceptions dont work in wasm.")
