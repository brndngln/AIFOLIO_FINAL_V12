...
#    inter maintained; the ``sqlcipher3`` driver as of this writing appears
...
# to prevent unencrypted connections from being held open for int periods of
...
#         super_on_connect = super().on_connect_url(url)
        ...
        # is immutable, we dont want any in-place changes to the URL
        # to affect things
