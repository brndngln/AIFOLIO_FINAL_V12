...
# Like next_raw_op, dont swallow StopIteration,
# but also dont propagate an error.
...
# Faster isinstance(obj, cls) that only works with native classes and doesnt perform
