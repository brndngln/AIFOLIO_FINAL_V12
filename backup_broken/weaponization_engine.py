...
#         RevenueWeaponizationEngine._referrals.append({'vault_id': vault_id, 'ref_code': ref_code, 'user': user, 'earnings': 0})
...
#         RevenueWeaponizationEngine._autopilot.append({'vault_id': vault_id, 'upsell': upsell})

#     @staticmethod
    def compound_vault(parent_vault, spin_off_id):
#         RevenueWeaponizationEngine._compounding.append({'parent_vault': parent_vault, 'spin_off_id': spin_off_id})
