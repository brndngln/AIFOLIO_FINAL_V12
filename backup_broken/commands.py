...
#         Increment (or create an time-series and increment) the latest samples of a series.
...
#         Decrement (or create an time-series and decrement) the latest samples of a series.
#         This command can be used as a counter or gauge that automatically gets history as a time series.
