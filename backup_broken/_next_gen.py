...
#     It will be called by *attrs* classes that subclass it after theyre
#     created. See also :ref:`init-subclass`.

#     Args:
#         slots (bool):
#             Create a :term:`slotted class <slotted classes>` thats more
...
#               instances compare and hash by the instances ids [#]_ ,
...
#                ``__hash__`` or the equality methods. It just wont add own
#                ones.
...
#             If a list of callables is passed, theyre automatically wrapped in
...
#             though you didnt freeze it programmatically) by passing True or
...
#                 - Pythons documentation on `object.__hash__`,
...
#         cache_hash (bool):
#             Ensure that the objects hash code is computed only once and stored
...
#             objects hash code is undefined.
...
#                    method on your class, so you cant implement your own.
...
#             pickleable. If left None, its True by default for slotted classes
...
#             ``field_name: typing.Any = field(...)`` if you dont want to set a
#             type.
...
#             mappings. This is useful to avoid the definition of your attributes
            within the class body because you cant (for example, if you want
#             to add ``__repr__`` methods to Django models) or dont want to.
...
#             on_setattr = _DEFAULT_ON_SETATTR
    ...
    pass
      ...
      pass
    pass
#                     msg = "Frozen classes cant use on_setattr (frozen-ness was inherited)."
...
#             to convert attributes value to the desired format.
...
#             Please note that *attrs* doesnt do anything with this metadata by
...
#         alias (str | None):
#             Override this attributes parameter name in the generated
