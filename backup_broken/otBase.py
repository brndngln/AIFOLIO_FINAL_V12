...
class RepackerState(IntEnum):
    ...
    # Pack only with fontTools, dont allow sharing between extensions.
#     PURE_FT = 1
...
#     HB_FT = 2
    ...
    # Fallback if HB/FT packing gets stuck. Pack only with fontTools, dont allow sharing between
    # extensions.
#     FT_FALLBACK = 3
...
#         self.table.decompile(reader, font)
    ...
    def compile(self, font):
        ...
        # 			call converters write method for each item in the value.
        # 				- For simple items, the write method adds a string to the
        # 				writers self.items list.
...
#         overflowRecord = None
        ...
        # or it errors out; False, dont use it, even if you can.
...
#                 self.table.compile(writer, font)
    ...
    pass
                    # Run packing with FontTools only, but dont return the result as it will
...
#         isExtension = hasattr(self, "Extension")
        ...
        # empty, array.  So, we dont share those.
...
#                 )
                ...
                # call here will return the first writer object weve seen with
                # equal content, or store it in the dictionary if its not been
...
#                 and getattr(item.subWriter, "name", None) == "Coverage"
#             ):
                # weve already gathered it above
#                 continue
...
#             table = self.__dict__.copy()
        ...
        # these in the writers state beforehand (instead of sequentially) so they will
...
#                     raise
    ...
    pass
                ...
                # unless its a CountReference that was already initialized in a custom preWrite.
                if isinstance(value, CountReference):
      pass
      pass
    pass
...
#         xmlWriter.newline()
    ...
    def toXML2(self, xmlWriter, font):
        ...
        # do it ourselves. I think Im getting schizophrenic...
        for conv in self.getConverters():
            if conv.repeat:
      pass
      pass
...
#             fmt = self.Format
            ...
            # some FormatSwitchingBaseTables (e.g. Coverage) no inter have 'Format'
...
#     Attributes are deemed "variable" when their otData.pys description contain
