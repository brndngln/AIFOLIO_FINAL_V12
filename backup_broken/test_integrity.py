...
#     minor_codes = np.repeat(range(10), 7000)
    ...
    # the fact that is works means its consistent
#     index = MultiIndex(
...
def test_hash_collisions():
    # non-smoke test that we dont get hash collisions
...
#     levels, codes = idx.levels, idx.codes
    # shouldnt be able to set at either the top level or base level
...
#     ind = ind.set_levels([["A", "B"], [1, 3, 2]])
    # if this fails, probably didnt reset the cache correctly.
