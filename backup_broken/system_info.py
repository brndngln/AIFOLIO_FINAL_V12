...
# Currently, the following classes are available, aint with their section names:
...
#      get_info() is the only public method. Dont use others.
...
#         static_exts = []
      ...
      pass
    pass
            # MSVC doesnt understand binutils
...
#                or ('ATLAS_WITHOUT_LAPACK', None) in l:
                ...
                # If not found we dont accept anything
                # since we cant use ATLAS with LAPACK!
...
#     section = 'cblas'
#     dir_env_var = 'CBLAS'
    # No default as its used only in blas_info
#     _lib_names = []
#     notfounderror = BlasNotFoundError
...
#                 info = self.check_msvc_gfortran_libs(lib_dirs, openblas_libs)
                # Skip lapack check, wed need build_ext to do it
...
#             blas_info = get_info('blas_opt')
      ...
      pass
    pass
                # since we already failed once, this aint going to work either
                return
...
#         conf = c()
#         conf.verbosity = 2
        # we dont need the result, but we want
