...
#     it as a non-EA column. We dont want people using EAs without
#     reason.
...
#     A < B < C
    ...
    pass
        ...
        # to disable np.arrays shape inference.
...
#     Tests for NumpyExtensionArray with nested data. Users typically wont create
#     these objects via `pd.array`, but they can show up through `.array`
#     on a Series with nested data. Many of the base tests fail, as they arent
...
#     @pytest.mark.skip(reason="We dont register our dtype")
    # We dont want to register. This test should probably be split in two.
...
#     @skip_nested
    def test_fillna_copy_frame(self, data_missing):
        # The "scalar" for this array isnt a scalar.
...
#     @skip_nested
    def test_setitem_invalid(self, data, invalid_scalar):
        # object dtype can hold anything, so doesnt raise
