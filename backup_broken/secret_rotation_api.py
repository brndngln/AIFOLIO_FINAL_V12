...
#     status: str = Query(
#         None,
#         description="Filter by rotation status (SUCCESS/FAIL/VERIFY_FAIL/FALLBACK_LAST_KNOWN)",
#     ),
...
#     ip = request.client.host
    ...
    if not (
#         is_admin_in_role(admin_id, "OWNER") or is_admin_in_role(admin_id, "OPERATOR")
#     ):
        return JSONResponse(
#             {"success": False, "error": "Insufficient role for manual override."},
#             status_code=403,
#         )
...
#         send_discord_alert(
#             f"[AIFOLIO] Manual override lockout for {admin_id} from {ip}"
#         )
        return JSONResponse(
#             {
#                 "success": False,
...
#     enabled = data.get("enabled")
    ...
    pass
        return JSONResponse(
#             {"success": False, "error": "Insufficient role for freeze toggle."},
#             status_code=403,
#         )
...
#     enable = data.get("enable", False)
    ...
    pass
        return JSONResponse(
#             {"success": False, "error": "Insufficient role for auto-freeze toggle."},
#             status_code=403,
#         )
#     config_path = (
#         Path(__file__).parent.parent.parent / "config" / "vault_control_flags.json"
#     )
