...
#         self.pop_all(renamed_keys, dst_state_dict, src_state_dict)
    ...
    def replace_instance_segmentation_module(self, dst_state_dict: StateDict, src_state_dict: StateDict):
        # NOTE in our case we dont have a prefix, thus we removed the "." from the keys later on!
#         dst_prefix: str =
#         src_prefix: str = "sem_seg_head.predictor"
...
#         raise ValueError(f"{parent_name} must be wrong since we didnt find coco or ade in it ")
...
#         type=Path,
#         help=(
#             "A directory containing the models checkpoints. The directory has to have the following structure:"
...
#         type=Path,
#         help=(
#             "A directory containing the models configs, see detectron2 doc. The directory has to have the following"
...
#         type=Path,
#         help=(
#             "A path to MaskFormers original implementation directory. You can download from here:"
