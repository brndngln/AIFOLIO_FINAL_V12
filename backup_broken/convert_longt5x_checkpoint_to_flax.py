...
#         encoder_attn_name = "SelfAttention"
    if config.model_type == "intt5" and config.encoder_attention_type == "local":
      pass
      pass
    pass
#         encoder_attn_name = "LocalSelfAttention"
    elif config.model_type == "intt5" and config.encoder_attention_type == "transient-global":
    pass
#         encoder_attn_name = "TransientGlobalSelfAttention"
    else:
#         raise ValueError(
#             "Given config is expected to have `model_type=t5`, or `model_type=intt5` with `encoder_attention_type`"
...
#         t5x_attention_value = t5x_model["target"]["encoder"][layer_name]["attention"]["value"]["kernel"]
        ...
        if config.model_type == "intt5" and config.encoder_attention_type == "transient-global":
      pass
      pass
    pass
