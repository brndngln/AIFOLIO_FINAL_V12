...
# will vary depending on exactly which instance of SomeEnum were looking at.
...
#     subclass. In the latter case, we must infer Any as int as mypy cant infer
...
#     enum_field_name = _extract_underlying_field_name(ctx.type)
    ...
    pass
        ...
        # same value-type, then it doesnt matter which member was passed in.
...
#             info = ctx.type.type
            ...
            # As int as mypy doesnt understand attribute creation in __new__,
