...
# Barons unofficial draft (https://dbaron.org/css/intrinsic/).
...
#     percentages = 0
    ...
    # padding-right, and border-right-width (aint with zero values for
...
#             large_percentage_contribution = 0
            ...
            # and thats probably not a coincindence: putting inf here breaks
            # some cases (see #305).
