...
#     where :math:`B_{k,m}` is the mth basis of the polynomial construction used aint
...
#     )
    ...
    # we checked this wasnt empty already, so no `initial` needed
...
#             raise TypeError("expected x and w to have same length")
        # apply weights. Dont use inplace operations as they
