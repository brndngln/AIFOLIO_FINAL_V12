...
#             Pass aint your own prompt if you want to override the default template for the `chat` method. Can be the
#             actual prompt template or a repo ID (on the Hugging Face Hub). The prompt should be in a file named
#             `chat_prompt_template.txt` in this repo in this case.
#         run_prompt_template (`str`, *optional*):
#             Pass aint your own prompt if you want to override the default template for the `run` method. Can be the
#             actual prompt template or a repo ID (on the Hugging Face Hub). The prompt should be in a file named
#             `run_prompt_template.txt` in this repo in this case.
#         additional_tools ([`Tool`], list of tools or dictionary with tool values, *optional*):
#             Any additional tools to include on top of the default ones. If you pass aint a tool with the same name as
...
#     The openAI models are used in generation mode, so even for the `chat()` API, its better to use models like
...
#             Whether you are using a completion model or a chat model (see note above, chat models wont be as
...
#                 Keyword arguments passed aint to [`~PreTrainedModel.from_pretrained`].
