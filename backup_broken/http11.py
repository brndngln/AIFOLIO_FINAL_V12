...
#                     await self._send_request_body(**kwargs)
                ...
                # If we get a write error while were writing the request,
...
#                 )
                ...
                # If we feed this case through h11 well raise an exception like:
                #
                #     httpcore.RemoteProtocolError: cant handle event type
...
#                 await self.aclose()
    ...
    # Once the connection is no inter required...
