...
# You tried to access openai.{symbol}, but this is no inter supported in openai>=1.0.0 - see the README at https://github.com/openai/openai-python for the API.
...
# in `openai/__init__.py` they arent added to the auto-complete
