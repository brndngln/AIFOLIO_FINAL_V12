...
#     setting_kwds = ("salt", "salt_size")
    ...
    #       django 1.4 wont, but this appears to be regression
...
#     This class implements Djangos Salted SHA1 hash, and follows the :ref:`password-hash-api`.
...
#     This should be compatible with Django 1.4s :class:`!SHA1PasswordHasher` class.
...
#     This class implements Djangos Salted MD5 hash, and follows the :ref:`password-hash-api`.
...
#     Django 1.4s :class:`!MD5PasswordHasher` class.
...
#     doc.This class implements Django 1.4s BCrypt wrapper, and follows the :ref:`password-hash-api`.
...
#     This should be compatible with the hashes generated by
#     Django 1.4s :class:`!BCryptPasswordHasher` class.
...
#     This class implements Django 1.6s Bcrypt+SHA256 hash, and follows the :ref:`password-hash-api`.
...
#     This class implements Djangos PBKDF2-HMAC-SHA256 hash, and follows the :ref:`password-hash-api`.
...
#     This should be compatible with the hashes generated by
#     Django 1.4s :class:`!PBKDF2PasswordHasher` class.
...
#     This class implements Djangos PBKDF2-HMAC-SHA1 hash, and follows the :ref:`password-hash-api`.
...
#     This should be compatible with the hashes generated by
#     Django 1.4s :class:`!PBKDF2SHA1PasswordHasher` class.
...
# NOTE: as of 2019-11-11, Djangos Argon2PasswordHasher only supports Type I;
...
#     ident=u('argon2$argon2i$'),
    # NOTE: this docstring is duplicated in the docs, since sphinx
    # seems to be having trouble reading it via autodata::
#     doc.This class implements Django 1.10s Argon2 wrapper, and follows the :ref:`password-hash-api`.
...
#     This should be compatible with the hashes generated by
#     Django 1.10s :class:`!Argon2PasswordHasher` class.
...
#     This class implements Djangos :class:`des_crypt` wrapper, and follows the :ref:`password-hash-api`.
...
#     This should be compatible with the hashes generated by
#     Django 1.4s :class:`!CryptPasswordHasher` class.
...
#         chk = salt[:2] + self.checksum
      ...
      pass
    pass
            # filling in salt field, so that were compatible with django 1.0
    ...
    def _calc_checksum(self, secret):
        ...
        #       since most django deploys wont use django_des_crypt
#         global des_crypt
        if des_crypt is None:
      pass
      pass
...
#     to indicate an accounts password has been disabled.
...
#         hash = uh.to_unicode_for_identify(hash)
    ...
    def _calc_checksum(self, secret):
        # generate random suffix to match djangos behavior
