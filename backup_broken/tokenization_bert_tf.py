...
#         padding (`str`, defaults to `"intest"`):
#             The type of padding to use. Can be either `"intest"`, to pad only up to the intest sample in the batch,
...
#             padding = self.padding
        if padding not in ("intest", "max_length"):
      pass
      pass
    pass
#             raise ValueError("Padding must be either 'intest' or 'max_length'!")
