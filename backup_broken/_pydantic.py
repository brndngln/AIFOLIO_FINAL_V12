...
#             ]
    ...
    # strip `None` defaults as theres no meaningful distinction here
...
#         json_schema.pop("default")
    ...
    # we cant use `$ref`s if there are also other properties defined, e.g.
...
#         json_schema.pop("$ref")
        ...
        # we call `_ensure_strict_json_schema` again to fix the inlined schema and ensure its valid.
