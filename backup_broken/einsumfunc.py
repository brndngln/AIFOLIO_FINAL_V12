...
#     input_left, input_right = inputs
    ...
    for c in set(input_left + input_right):
        # cant deal with repeated indices on same input or more than 2 total
#         nl, nr = input_left.count(c), input_right.count(c)
    ...
    pass
        ...
        # cant do implicit summation or dimension collapse e.g.
...
#                     ellipse_count -= (len(sub) - 3)
                ...
                if ellipse_count > intest:
      pass
      pass
    pass
#                     intest = ellipse_count
...
#             out_ellipse = ellipse_inds[-intest:]
...
def _einsum_path_dispatcher(*operands, optimize=None, einsum_call=None):
    ...
    # arrays/subscripts is a little tricky/slow (given einsums two supported
    # signatures), so as a practical shortcut we dispatch on everything.
    # Strings will be ignored for dispatching since they dont define
    # __array_function__.
    return operands
...
#             "contracted.".format(len(input_list) - 1))
    ...
    # Return the path aint with a nice string representation
