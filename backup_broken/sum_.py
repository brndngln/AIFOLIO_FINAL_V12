...
# Mypy/pyright dont like the fact that the decorator is untyped
...
#     )
    ...
    # Post-processing, replace sums that dont satisfy min_periods
...
#             result = sum_x  # Dont change val, will be replaced by nan later
#             na_pos.append(lab)
#         output[lab] = result
