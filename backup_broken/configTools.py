...
#                 file type that doesnt support as many types as Python.
...
#             raise
        ...
        # Can be useful if the values come from a source that doesnt have
...
#         1. a user-provided value in the optionss ``self._values`` dict
