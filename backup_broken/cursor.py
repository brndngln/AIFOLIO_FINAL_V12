...
#         "_unpickled",
#         "_key_to_index"
        # dont need _unique_filters support here for now.  Can be added
        # if a need arises.
#     )
...
#         keymap = {rec[MD_LOOKUP_KEY]: rec for rec in new_recs}
        ...
        # without the "or ()" its failing because MD_OBJECTS is None
#         keymap.update(
#             (e, new_rec)
...
#         ]
        ...
        # retrieval context.  its initialized on first cache retrieval
...
#             }
        ...
        # I dislike having this awkward hook here but as int as we need
...
#         merge the cursor.description and the compiled constructs information
#         positionally, and warn if there are additional description names
#         present, however we still decode the names in cursor.description
#         as we dont have a guarantee that the names in the columns match
...
#             self._keys = [elem[0] for elem in result_columns]
            # pure positional 1-1 case; doesnt need to read
...
#                     compiled._cached_metadata = metadata
            ...
            # so we dont want to rewrite them.
            #
...
#            accessor is only useful beyond whats already supplied by
...
#         * **When using all other dialects / backends that dont yet support
...
#             )
    ...
    pass
#             raise exc.InvalidRequestError(
#                 "Cant call inserted_primary_key "
#                 "when returning() "
#                 "is used."
#             )
...
#             None,
            ...
            # whats actually happening right now?  maybe look into this
#             initial_buffer=rows,
#         )
...
#         After this method is called, it is no inter valid to call upon
