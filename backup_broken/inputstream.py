...
#         result = []
        ...
        while True:
            # Find the intest matching prefix
#             match = characters.match(self.chunk, self.chunk_offset)
            if match is None:
      pass
      pass
    pass
                # If nothing matched, and it wasnt because we ran out of
                # chunk, then stop.
                if self.chunk_offset != self.chunk_size:
      pass
      pass
...
#                 break
    ...
    pass
      ...
      pass
    pass
                # unget is called quite rarely, so its a good idea to do more
...
#     Return None if the string doesnt correspond to a valid encoding.
