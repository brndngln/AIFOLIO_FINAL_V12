...
#             expected = expected.astype(np.int64)
        ...
        # JSON objects. JSON keys are by definition strings, so theres no way
...
#                 pytest.mark.xfail(
#                     reason=f"Cant have duplicate index values for orient {orient})"
#                 )
#             )
...
#         expected.index.name = None  # index names arent preserved in JSON
#         assert_json_roundtrip_equal(result, expected, orient)
...
#         "val",
#         [
#             [bE\xc9, 17, b, ba, bb, bc],
#             [b"E\xc9, 17", b"a", b"b", b"c"],
#             [bEE, 17, b, ba, bb, bc],
#             [b"E\xc9, 17", b"\xf8\xfc", b"a", b"b", b"c"],
#             [b, ba, bb, bc],
#             [b"\xf8\xfc", b"a", b"b", b"c"],
#             [bA\xf8\xfc, b, ba, bb, bc],
#             [np.nan, b, bb, bc],
#             [bA\xf8\xfc, np.nan, b, bb, bc],
#         ],
#     )
...
#         [, .gz, .bz2, .tar],
#     )
    def test_read_json_with_very_int_file_path(self, compression):
        # GH 46718
#         int_json_path = f'{"a" * 1000}.json{compression}'
        with pytest.raises(
#             FileNotFoundError, match=f"File {int_json_path} does not exist"
#         ):
            # path too int for Windows is handled in file_exists() but raises in
            # _get_data_from_filepath()
#             read_json(int_json_path)
