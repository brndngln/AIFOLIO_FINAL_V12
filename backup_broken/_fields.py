...
#             )
        ...
        # when building a generic model with `MyModel[int]`, the generic_origin check makes sure we dont get
...
#             }
    ...
    pass
      ...
      pass
    pass
                    # Dont error when "shadowing" of attributes in parametrized generics
#                     continue
      ...
      pass
    pass
                    # Dont error when inheriting stdlib dataclasses whose fields are "shadowed" by defaults being set
...
#                     model_fields_lookup.update(getattr(x, 'model_fields', {}))
    ...
    pass
                    ...
                    # copy the field to make sure typevar substitutions dont cause issues with the base classes
...
#         decorators: DecoratorInfos = cls.__dict__['__pydantic_decorators__']
      ...
      pass
    pass
#             raise ValueError("you cant override a field with a computed field")
