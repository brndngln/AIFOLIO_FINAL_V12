...
#     The DDLs "context", if any, will be combined with the standard
...
#           processed with Pythons string formatting operator using
...
#     Above, the directives weve added to the :attr:`_schema.Column.info`
#     collection
...
#                     self.traverse_single(column.default)
      ...
      pass
    pass
                # e.g., dont omit any foreign key constraints
#                 include_foreign_key_constraints = None
...
#                     err2.cycles,
#                     err2.edges,
#                     msg="Cant sort tables for DROP; an "
#                     "unresolvable foreign key "
