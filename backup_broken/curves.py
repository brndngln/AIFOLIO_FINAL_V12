...
#         self.order = generator.order()
    ...
    pass
            ...
            # are the same size (as its defined only with compressed points)
...
#                     "Cant encode curve using named_curve encoding without "
...
#             raise UnknownCurveError(
#                 "Twisted Edwards curves dont support explicit encoding"
#             )
...
#         curve_b_bytes, rest = der.remove_octet_string(rest)
        # seed can be defined here, but we dont parse it, so ignore `rest`
...
#         curves
    ...
    pass
            return c
#     raise UnknownCurveError(
#         "I dont know about the curve with oid %s."
