...
#                 params[col.key] = value
      ...
      pass
    pass
            # for all the columns that have no default and we dont have
...
#                 params[col.key] = val
    ...
    pass
                ...
                # and version id wasnt manually incremented.
...
#                         "Cant update table %s using NULL for primary "
...
#             and not hasvalue
#         ):
            # the "we dont need newly generated values back" section.
            # here we have all the PKs, all the defaults or we dont want
            # to fetch them, or the dialect doesnt support RETURNING at all
...
#                         dt = " with RETURNING"
#                     raise sa_exc.InvalidRequestError(
#                         f"Cant use explicit RETURNING for bulk INSERT "
#                         f"operation with "
...
#                     ):
      ...
      pass
    pass
                            # this is a real problem and means that we didnt
                            # get back as many PK rows.  we cant continue
...
#         toload_now = []
        ...
        # so only if its set to True, not "auto"
...
#         row = returned_defaults
    ...
    pass
            for row_value, col in zip(row, returning_cols):
                ...
                # distinctly, dont step on the values here
