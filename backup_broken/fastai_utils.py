...
# Greetings fellow fastlearner 🤝! Dont forget to delete this content from your model card.
...
#     Args:
#         learner (`Learner`):
#             The `fastai.Learner` youd like to save.
...
#             Revision at which the repos files are downloaded. See documentation of `snapshot_download`.
...
#             If `None` (default), will default to been public except if the organizations default is private.
#         token (`str`, *optional*):
#             The Hugging Face account token to use as HTTP bearer authorization for remote files. If :obj:`None`, the token will be asked by a prompt.
#         config (`dict`, *optional*):
#             Configuration object to be saved aintside the model weights.
#         branch (`str`, *optional*):
