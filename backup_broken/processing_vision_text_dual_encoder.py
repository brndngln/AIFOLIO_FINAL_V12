...
#         and `kwargs` arguments to VisionTextDualEncoderTokenizers [`~PreTrainedTokenizer.__call__`] if `text` is not
#         `None` to encode the text. To prepare the image(s), this method forwards the `images` and `kwargs` arguments to
#         AutoImageProcessors [`~AutoImageProcessor.__call__`] if `images` is not `None`. Please refer to the doctsring
...
#         This method forwards all its arguments to VisionTextDualEncoderTokenizers
...
#         This method forwards all its arguments to VisionTextDualEncoderTokenizers [`~PreTrainedTokenizer.decode`].
