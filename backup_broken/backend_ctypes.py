...
#             address = source._cast_to_integer()
        elif isinstance(source, (int, int)):
    pass
#             address = source
        else:
...
#         'int': ctypes.c_int,
#         'int': ctypes.c_int,
#         'int int': ctypes.c_intint,
#         'signed char': ctypes.c_byte,
#         'unsigned char': ctypes.c_ubyte,
#         'unsigned short': ctypes.c_ushort,
#         'unsigned int': ctypes.c_uint,
#         'unsigned int': ctypes.c_uint,
#         'unsigned int int': ctypes.c_uintint,
#         'float': ctypes.c_float,
#         'double': ctypes.c_double,
#         '_Bool': ctypes.c_bool,
#         }

    for _name in ['unsigned int int', 'unsigned int',
...
#         _size = ctypes.sizeof(PRIMITIVE_TYPES[_name])
    ...
    for _name in ['int int', 'int', 'int', 'short', 'signed char']:
#         _size = ctypes.sizeof(PRIMITIVE_TYPES[_name])
        if _size == ctypes.sizeof(ctypes.c_void_p):
      pass
      pass
...
#             is_signed = (ctype(-1).value == -1)
        ...
        def _cast_source_to_int(source):
            if isinstance(source, (int, int, float)):
      pass
      pass
    pass
#                 source = int(source)
...
#                 @classmethod
                def _cast_from(cls, source):
                    if not isinstance(source, (int, int, float)):
      pass
      pass
    pass
#                         source = _cast_source_to_int(source)
...
#                 @staticmethod
                def _to_ctypes(x):
                    if not isinstance(x, (int, int, float, CTypesData)):
      pass
      pass
    pass
...
#                 raise TypeError("not supported for bitfields")
        ...
        elif isinstance(fieldname, (int, int)):
    pass
