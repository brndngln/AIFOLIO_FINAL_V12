...
#         Exception names cant be used after the except: block.
...
#         Exception names obscure locals, cant be used after.
...
#         Exception names obscure locals, cant be used after. Unless.

#         Last line will never raise UnboundLocalError because its only
...
#         Exception names obscure globals, cant be used after.
...
#         locally unbound after the `except:` block, even if its
#         nonlocal. We should issue an error in this case because code
#         only working correctly if an exception isnt raised, is invalid.
#         Unless its explicitly silenced, see false positives below.
#         self.flakes(
#         exc = 'Original value'
        def func():
#             global exc
...
#         Exception names obscure globals, cant be used after. Unless.

#         Last line will never raise NameError because its only entered
...
#         Ignore bindings deletion if called inside the body of a while
#         statement and name is used inside whiles test part.
...
#         Ignore bindings deletions if node is part of whiles test, even when
