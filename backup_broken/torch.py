...
#             Extra information to save aint with the file.
...
#             Whether to fail if youre missing keys or having unexpected ones.
...
#             `unexpected` are names that are on the file, but werent used during
#             the load.
...
#         dtype = _getdtype(v["dtype"])
      ...
      pass
    pass
            # Workaround because frombuffer doesnt accept zero-size tensors
...
#             " are trying to save tensors which are reference of each other in which case its recommended to save"
