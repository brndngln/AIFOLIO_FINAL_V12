...
#         assert_raises(OSError, self.ds.open, invalid_file)
    ...
    def test_ValidGzipFile(self):
        try:
            ...
            # We dont have the gzip capabilities to test.
#             pytest.skip()
        # Test datasources internal file_opener for Gzip files.
...
#         assert_equal(magic_line, result)
    ...
    def test_ValidBz2File(self):
        try:
            ...
            # We dont have the bz2 capabilities to test.
#             pytest.skip()
        # Test datasources internal file_opener for BZip2 files.
