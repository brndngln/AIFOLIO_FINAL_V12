...
def is_pydantic_available() -> bool:
    ...
    # by the user in an environment that we dont control.
    #
    # Usually we wont need to do this kind of check on optional dependencies. However, pydantic is a special case
    # as it is automatically imported when doing `from huggingface_hub import ...` even if the user doesnt use it.
    #
