...
#             The projection dimension of the text-to-units duration predictor.
#         t2u_variance_predictor_hidden_dim (`int`, *optional*, defaults to 256):
#             Internal dimension of the text-to-units duration predictor.
#         t2u_variance_predictor_kernel_size (`int`, *optional*, defaults to 3):
#             Kernel size of the convolutional layers of the text-to-units duration predictor.
#         t2u_variance_pred_dropout (`float`, *optional*, defaults to 0.5):
#             The dropout probabilitiy of the text-to-units duration predictor.
