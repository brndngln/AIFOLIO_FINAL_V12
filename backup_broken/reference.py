...
#     It can be used with Kerchunks MultiZarrToZarr method to combine
#     references into a parquet store.
#     Examples of this use-case can be found here:
#     https://fsspec.github.io/kerchunk/advanced.html?highlight=parquet#parquet-storag.
...
#                 self.fss[k] = AsyncFileSystemWrapper(f, asynchronous=self.asynchronous)
    ...
    pass
#                 raise ValueError(
#                     "Reference-FSs target filesystem must have same value"
#                     "of asynchronous"
#                 )
