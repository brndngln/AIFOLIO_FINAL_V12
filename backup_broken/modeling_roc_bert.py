...
#         self.register_buffer(
#             "token_type_ids",
#             torch.zeros(self.position_ids.size(), dtype=torch.int, device=self.position_ids.device),
#             persistent=False,
#         )
...
#             embedding_in = torch.clone(inputs_embeds)
    ...
    pass
      ...
      pass
    pass
#                     input_shape_ids = torch.zeros(input_shape, dtype=torch.int, device=device)
#                 embedding_shape = self.shape_embed(input_shape_ids)
#                 embedding_in = torch.cat((embedding_in, embedding_shape), -1)
    ...
    pass
      ...
      pass
    pass
#                     input_pronunciation_ids = torch.zeros(input_shape, dtype=torch.int, device=device)
#                 embedding_pronunciation = self.pronunciation_embed(input_pronunciation_ids)
...
#             (effective_batch_size, 1), self.config.pad_token_id, dtype=torch.int, device=input_ids.device
#         )
