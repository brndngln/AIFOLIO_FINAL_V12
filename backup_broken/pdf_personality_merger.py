...
# __all__: list[str] = ["PDFPersonalityMerger"]


class PDFPersonalityMerger:
...
#         pass
    ...
    def merge(
#         self, pdf_traits: Dict[str, Any], user_traits: Dict[str, Any]
#     ) -> Dict[str, Any]:

# OMNIELITE
#         method. Performs non-adaptive merging of PDF and user-defined traits.
#         All logic is static and traceable.  # noqa: E501

#         merged = dict(pdf_traits)
#         merged.update(user_traits)
#         merged["merged"] = True
        return merged
