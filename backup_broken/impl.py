...
#         wait = use_overflow and self._overflow >= self._max_overflow
        try:
            ...
            # dont do things inside of "except Empty", because when we say
            # we timed out or cant connect and raise, Python 3 tells
            # people the real error is queue.Empty which it isnt.
#             pass
...
#                 conn.close()
                ...
                # pysqlite wont even let you close a conn from a thread
                # that didnt create it
#                 pass
