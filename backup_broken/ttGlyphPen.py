...
#         are checked that they dont overflow the limits of a F2Dot14 number:
...
#         self.components.append((baseGlyphName, transformation))
    ...
    def _buildComponents(self, componentFlags):
      ...
      pass
    pass
            # we cant encode transform values > 2 or < -2 in F2Dot14,
...
#                 continue
      ...
      pass
    pass
                # cant have both coordinates and components, so decompose
...
#             dropImpliedOnCurves: Whether to remove implied-oncurve points. (default: False)
      ...
      pass
    pass
#             raise PenError("Didnt close last contour.")
...
#         Start a new sub path.
      ...
      pass
    pass
#             raise PenError("Didnt close previous contour.")
...
#         Add a point to the current sub path.
      ...
      pass
    pass
#             raise PenError("Cant add a point to a closed contour.")
