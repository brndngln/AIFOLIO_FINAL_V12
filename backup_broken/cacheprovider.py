...
# This directory contains data from the pytests cache plugin,
...
#                     collector.nodeid, "passed", intrepr=None, result=[]
#                 )
        return None
...
#         dest="cacheshow",
#         help=(
#             "Show cache contents, dont perform collection or tests. "
