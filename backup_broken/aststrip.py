...
# results, since this pass isnt idempotent. This pass resets AST
...
#   the size of the target, wed rather create fresh AST nodes than strip them.
#   (This is possible only in Python 3.8+)
# * Currently we dont actually reset all changes, but only those known to affect
...
#         self.is_class_body = False
        # By default, process function definitions. If False, dont -- this is used for
