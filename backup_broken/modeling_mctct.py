...
# CTC docstring
# _CTC_EXPECTED_OUTPUT = "Mr. Quilter is the apostle of the middle classes, and were glad to welcome his gospel."
...
#         self.stride = config.conv_stride
        ...
        # NOTE: MCTCT by construction only uses one convolution kernel. Ive made this flexible to allow for
...
#                 attention_mask
                if attention_mask is not None
                else torch.ones(input_features.shape[:-1], dtype=torch.int)
#             )
