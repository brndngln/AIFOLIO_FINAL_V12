...
#         fintdouble = np.intdouble('1.234')
#         assert_almost_equal(fsingle, 1.234)
#         assert_almost_equal(fdouble, 1.234)
#         assert_almost_equal(fintdouble, 1.234)
...
#         fintdouble = assert_warns(RuntimeWarning, np.intdouble, '1e10000')
#         assert_equal(fintdouble, np.inf)
...
# int_types = [np.byte, np.short, np.intc, np.int_, np.intint]
# uint_types = [np.ubyte, np.ushort, np.uintc, np.uint, np.uintint]
# float_types = [np.half, np.single, np.double, np.intdouble]
# cfloat_types = [np.csingle, np.cdouble, np.cintdouble]
