...
#     )
    ...
    # now since I dont want to use any config files, vissl seer model doesnt actually have an head, so lets just check the last hidden state
    if "seer" in name and "in1k" in name:
      pass
      pass
    pass
...
#     assert torch.allclose(from_output, our_output), "The model logits dont match the original one."
