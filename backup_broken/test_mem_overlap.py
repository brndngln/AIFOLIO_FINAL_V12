...
#                 assert_(X_simplified is None, (A, U, b, X_simplified))
                ...
                # small enough so that brute force checking doesnt
                # take too int)
...
def test_may_share_memory_harder_fuzz():
    ...
    # work.
    #
    # The work bound below cant be reduced much. Harder problems can
...
def test_internal_overlap_manual():
    ...
    # We dont care about memory bounds, the array is not
    # read/write accessed
...
#         self.check_unary_fuzz(np.negative, None, np.complex128, count=500)
    ...
    pass
                    ...
                    return skip, False  # accumulate doesnt support this
            else:
...
#                               dtype=np.int16, count=500)
    ...
    pass
                    ...
                    return skip, False  # reduceat doesnt support this
            else:
                return a.shape[axis], False
