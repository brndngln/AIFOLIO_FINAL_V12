...
#: message about why test module isnt present (if not found)
# hashers_skip_msg = None

#----------------------------------------------------------------------
# try to load djangos tests/auth_tests/test_hasher.py module,
...
#         hashers_skip_msg = "requires PASSLIB_TESTS_DJANGO_SOURCE_PATH to be set"
      ...
      pass
    pass
            # print warning so user knows whats happening
...
#----------------------------------------------------------------------
# if found module, create wrapper to run djangos own tests,
...
#                              getattr(hasher, "iterations", None)
    ...
    pass
#                         continue
                    # XXX: this doesnt modify the context, which would
...
#             super(HashersTest, self).tearDown()
        ...
        #==================================================================
        # skip a few methods that cant be replicated properly
...
#         _OMIT = lambda self: self.skipTest("omitted by passlib")
        ...
        #      something we dont support -- how does django sanely handle
        #      that anyways? get_hashers_by_algorithm() should throw KeyError, right?
#         test_pbkdf2_upgrade_new_hasher = _OMIT

        # TODO: support wrapping djangos harden-runtime feature?
