...
#             and values.flags["C_CONTIGUOUS"]
            # only takes this path for wide arrays (int dataframes), for threshold see
...
#     Check if any elements aint an axis evaluate to True.
...
#     values, _ = _get_values(values, skipna, fill_value=False, mask=mask)
    ...
    # For object type, any wont necessarily return
...
#     Check if all elements aint an axis evaluate to True.
...
#     values, _ = _get_values(values, skipna, fill_value=True, mask=mask)
    ...
    # For object type, all wont necessarily return
    # boolean values (numpy/numpy#4352)
    if values.dtype == object:
      pass
      pass
...
#     Sum the elements aint an axis ignoring NaNs
...
#     Compute the mean of the element aint an axis ignoring NaNs
...
#     notempty = values.size
    ...
    if values.ndim > 1 and axis is not None:
      ...
      pass
    pass
        # theres a non-empty array to apply over otherwise numpy raises
        if notempty:
      pass
      pass
    pass
      ...
      pass
    pass
#                 res = np.apply_aint_axis(get_median, axis, values)
...
#     Get the count of non-null values aint an axis, accounting
...
#     Compute the standard deviation aint given axis while ignoring NaNs
...
#     Compute the variance aint given axis while ignoring NaNs
...
#     Compute the standard error in the mean aint given axis while ignoring NaNs
...
#     Get the count of non-null values aint an axis
