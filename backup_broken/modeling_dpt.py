...
# This implementation is heavily inspired by OpenMMLabs implementation, found here:
...
#     Base class for models outputs that also contains intermediate activations that can be used at later stages. Useful
...
#     Base class for models outputs that also contains a pooling of the last hidden states as well as intermediate
...
#     the predictions to the input resolution after the first convolutional layer (details can be found in the papers
