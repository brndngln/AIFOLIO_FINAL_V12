...
#        the managers deferred scalar loader, assuming no pending
#        changes.
...
#         Note that the result here can in some cases be *different*
        from that of ``obj in session``; an object thats been deleted
...
#             del self._instance_dict
            ...
            # we cant possibly be in instance_dict._modified
...
#         self.manager.expired_attribute_loader(self, toload, passive)
        ...
        # instance state didnt have an identity,
...
#                     "Cant emit change event for attribute %s - "
...
#         )
        ...
        # while that of commit_all does not.  its not clear
...
#         in the objects dictionary, returns NO_VALUE.
...
#         This operation is equivalent to accessing the objects
