...
#                   DeprecationWarning, stacklevel=2)
    # dont used _nt_quote_args as it does not check if
...
#         d = os.path.dirname(os.path.abspath(caller_file))
        ...
        # __file__ is not defined, so lets try __name__. We try this second
...
#             d = os.path.dirname(os.path.abspath(mod.__file__))
            ...
            # were probably running setup.py as execfile("setup.py")
            # (likely were building an egg)
#             d = os.path.abspath('.')
...
#     to allow extensions to have reproducible build result.
...
#             so_ext = '.dll'
            ...
            # fix int extension for Python >=3.2, see PEP 3149.
...
#                 raise ValueError("Dont know about key=%r" % (key))
...
#         Return paths SVN revision number.
...
#         Return paths Mercurial revision number.
...
#     mkpath(os.path.dirname(target))
    with open(target, 'w') as f:
#         f.write(# This file is generated by numpys %s\n % (os.path.basename(sys.argv[0])))
...
#                    In NumPy 1.21+ on macOS, accelerate (Apples Accelerate BLAS
