...
#         If called with unknown/supported digest, wont throw error immediately,
...
#         name=name,
#         __module__=module, # so ABCMeta wont clobber it
#         _hash_func=staticmethod(info.const), # sometimes its a function, sometimes not. so wrap it.
...
#     @classmethod
    def genhash(cls, secret, config, user, realm, encoding=None):
        ...
        #       just have to make sure its valid.
