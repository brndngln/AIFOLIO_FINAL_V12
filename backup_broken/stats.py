...
#         self.record_line(o.line, TYPE_PRECISE)  # TODO: Look at base classes
        # Override this method because we dont want to analyze base_type_exprs (base_type_exprs
...
#         t = get_proper_type(t)
    ...
    pass
            ...
            # Dont count these because there can be an unanalyzed value on a line with other
...
class HasAnyQuery2(HasAnyQuery):
    def visit_callable_type(self, t: CallableType) -> bool:
        # We dont want to flag references to functions with some Any
        # argument types (etc.) since they generally dont mean trouble.
        return False
