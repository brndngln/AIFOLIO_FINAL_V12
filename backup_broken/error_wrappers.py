...
def get_exc_type(cls: Type[Exception]) -> str:
    # slightly more efficient than using lru_cache since we dont need to worry about the cache filling up
    try:
...
#     base_name = 'type_error' if issubclass(cls, TypeError) else 'value_error'
    ...
    # if its not a TypeError or ValueError, we just take the lowercase of the exception name
