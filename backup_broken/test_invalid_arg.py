...
def test_apply_str_axis_1_raises(how, args):
    # GH 39211 - some ops dont support axis=1
...
def test_agg_cython_table_raises_frame(df, func, expected, axis):
    # GH 21224
#     msg = "cant multiply sequence by non-int of type str"
...
def test_agg_cython_table_raises_series(series, func, expected):
    # GH21224
#     msg = r"[Cc]ould not convert|cant multiply sequence by non-int of type"
