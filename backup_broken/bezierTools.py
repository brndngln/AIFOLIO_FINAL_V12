...
#         >>> # XXX Im not at all sure if the following behavior is desirable:
    pass
...
#         True
    ...
    if abs(a) < epsilon:
      ...
      pass
    pass
        # dont just test for zero; for very small values of a solveCubic()
...
#         range2 = (0.0, 1.0)
    ...
    # If bounds dont intersect, go home
#     intersects, _ = sectRect(bounds1, bounds2)
    ...
    # If they do overlap but theyre tiny, approximate
...
#         raise ValueError("Couldnt work out which intersection function to use")
    if not swapped:
      pass
      pass
    pass
