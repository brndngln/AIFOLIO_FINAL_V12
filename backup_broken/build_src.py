...
# this import cant be done here, as it uses numpy stuff only available
# after its installed
#import numpy.f2py
...
#         ('inplace', 'i',
#          "ignore build-lib and put compiled extensions into the source directory aintside your pure Python modules"),
#         ('verbose-cfg', None,
...
#                     log.debug(  source %s does not exist: skipping f2pying. \
#                               % (source))
#                     name = ext_name
#                     skip_f2py = 1
#                     target_file = os.path.join(target_dir, name+'module.c')
...
#                     log.warn(  source %s does not exist: skipping swiging. \
#                              % (source))
#                     name = ext_name[1:]
#                     skip_swig = 1
