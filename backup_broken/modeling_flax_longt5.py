...
#     Split an input array into blocks of a given `block_len` aint the given `axis`. If the dimension length
...
#         https://github.com/google/flax/blob/491ce18759622506588784b4fca0e4bf05f8c8cd/flax/linen/attention.py#L252
        ...
        # detect if were initializing by absence of existing cache data.
...
#         >>> model = FlaxLongT5ForConditionalGeneration.from_pretrained("google/int-t5-local-base")
...
#     >>> tokenizer = AutoTokenizer.from_pretrained("t5-base")
#     >>> model = FlaxLongT5Model.from_pretrained("google/int-t5-local-base")
...
#         past_key_values = self.init_cache(batch_size, max_length, encoder_outputs)
        # Note that usually one would have to put 0s in the attention_mask for x > input_ids.shape[-1] and x < cache_length.
