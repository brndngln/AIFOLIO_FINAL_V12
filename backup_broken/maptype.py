...
#     then all type arguments are mapped to 'Any'.
    ...
    if instance.type == superclass:
      ...
      pass
    pass
        # Fast path: `instance` already beints to `superclass`.
        return instance
    ...
    pass
            ...
            # such tuples fallback cant be calculated before applying type arguments.
...
#             assert alias is not None
      ...
      pass
    pass
                # Unfortunately we cant support this for generic recursive tuples.
...
#             result.append([btype])
            ...
            # Try constructing a inter path via the base class.
...
#     variables bound by the Instances class definition.
