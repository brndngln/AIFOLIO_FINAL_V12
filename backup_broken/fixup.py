...
#         self.type_fixer = TypeFixer(self.modules, allow_missing)
    ...
    # NOTE: This method isnt (yet) part of the NodeVisitor API.
...
#             self.current_info = save_info
    ...
    # NOTE: This method *definitely* isnt part of the NodeVisitor API.
...
#         raise RuntimeError("Shouldnt get here", o)
