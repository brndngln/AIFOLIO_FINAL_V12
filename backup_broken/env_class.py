...
#     instantiate_env_class(builder)
    ...
    # that were previously added to the environment with references to the functions
    # environment class.
    if builder.fn_info.is_nested:
      pass
      pass
...
#     AssignmentTarget instances of the environment at the given indexs
...
#     index = len(builder.builders) - 2
    ...
    # FuncInfo instances prev_env_reg field.
    if index > 1:
      pass
      pass
    pass
