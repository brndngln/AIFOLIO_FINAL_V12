...
# interface thats useful for testing and prototyping purposes.
...
#     @event.listens_for(engine.sync_engine, "connect")
    def do_connect(dbapi_connection, connection_record):
        # disable aiosqlites emitting of the BEGIN statement entirely.
...
#     @isolation_level.setter
    def isolation_level(self, value):
        # aiosqlites isolation_level setter works outside the Thread
        # that its supposed to, necessitating setting check_same_thread=False.
        # for improved stability, we instead invent our own awaitable version
        # using aiosqlites async queue directly.
