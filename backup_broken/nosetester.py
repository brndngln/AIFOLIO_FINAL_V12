...
#     pkg_name.reverse()
    ...
    # dont include the outer egg directory
...
#     is typically added to a packages __init__.py like so::
...
#           - "release" : equals ``()``, dont raise on any warnings.
...
#                  check_fpu_mode=False):
        ...
        # accept None for back-compat, but its now just an alias for the
        # default "release".
