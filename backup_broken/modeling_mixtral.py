...
#     dropped tokens). Its faster since it formulates MoE operations
...
#             current_hidden_states = expert_layer(current_state, routing_weights[top_x_list, idx_list, None])
            ...
            # However `index_add_` only support torch tensors for indexing so well use
...
#             position_ids = position_ids.view(-1, seq_length).int()
...
#         "Hey, are you conscious? Can you talk to me?\nIm not conscious, but I can talk to you."
#         ```
...
#                 input_ids = input_ids[:, past_length:]
            # 3 - Otherwise (past_length >= input_ids.shape[1]), lets assume input_ids only has unprocessed tokens.
