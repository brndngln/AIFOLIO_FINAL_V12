...
#     ):
        # Currently this `class` cant be used in decoder.
...
#         rand_attn = torch.tensor(rand_attn, device=query_layer.device, dtype=torch.int)
...
#         rand_band_product = rand_band_product * rsqrt_d
        ...
        # Including 1st block (since its global)
...
#         first_band_product = first_band_product * rsqrt_d
        ...
        # Including last block (since its global)
...
#         context_layer = torch.transpose(context_layer, 1, 2)
        ...
        # this is just for visualizing; forward pass doesnt depend on following code
...
#             input_ids_padding = torch.ones((batch_size, padding_len), dtype=torch.int, device=device) * pad_id
