...
#         options: Options,
#     ) -> None:
        # Count physical lines.  This assumes the files encoding is a
...
#         total_funcs = annotated_funcs + unannotated_funcs
        ...
        # Dont count lines or functions as annotated if they have their errors ignored.
...
#             cur_indent = self.indentation_level(cur_line)
      ...
      pass
    pass
                # Consume the line, but dont mark it as beinting to the function yet.
#                 cur_line += 1
            elif cur_indent > start_indent:
    pass
                # A non-blank line that beints to the function.
#                 cur_line += 1
#                 end_line = cur_line
            else:
...
#             old_indent, _ = self.lines_covered[line]
            ...
            # level isnt increasing the indentation, ignore it.
...
#     source files absolute pathname the list of line numbers that
#     beint to typed functions in that file.
...
#         self.files: list[FileInfo] = []
    ...
    # XML doesnt like control characters, but they are sometimes
