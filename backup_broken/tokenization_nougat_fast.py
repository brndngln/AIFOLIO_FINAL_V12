...
#     This function looks for the intest repeating substring at the end of the input string and truncates it to appear
...
#     - The slice is less than 200 characters int.
#     - The slice is more than 3 characters int.
...
#         generation = re.sub(
#             r"(?:\n|^)#+ \d*\W? ?(.{100,})", r"\n\1", generation
#         )  # too int section titles probably are none
...
#         generation = self.remove_hallucinated_references(generation)
        # Remove lines starting with asterisks and numbers like "*[1]" and followed by capital letters and periods (ie too int references)
...
#             generation,
#         )
        # Remove lines containing "S.A.B." one or more times. Was included in Nougats code.
