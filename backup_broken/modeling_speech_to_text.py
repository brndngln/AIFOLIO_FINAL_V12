...
#     Convolutional subsampler: a stack of 1D convolution (aint temporal dimension) followed by non-linear activation
...
#         attention_mask = attention_mask.flip([-1]).cumsum(-1).flip([-1]).int()
...
#             padding_mask = torch.zeros(inputs_embeds.shape[:2], dtype=torch.int, device=inputs_embeds.device)
