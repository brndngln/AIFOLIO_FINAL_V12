...
#     If no directory in the tree contains a marker that would specify its the
...
#     Infer Blacks target version from the project metadata in pyproject.toml.
...
#     - PermissionError: if the current process cannot access the users homedir
...
#             continue
    ...
    pass
            ...
            # gitignore is when the directory doesnt have a .gitignore file.
...
#     Wrap stream with coloramas wrap_stream so colors are shown on Windows.
