...
#     Adapted in part from [Facebooks XLM beam search
#     code](https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529).

#     Reference for the diverse beam search algorithm and implementation [Ashwin Kalyans DBS
...
#                 batch_beam_idx = batch_idx * self.group_size + next_index
      ...
      pass
    pass
                    # if beam_token does not beint to top num_beams tokens, it should not be added
...
#                     beam_idx += 1
                ...
                # once the beam for next step is full, dont add more tokens to it.
...
#                         track_new["new_states"].append(new_state)
    ...
    pass
                ...
                # especially if its not in the list of `sent_beam_indices`. But this often leads to lengthened beam
...
#                 advance_state.reset(advance_seq)
      ...
      pass
    pass
                    # but still dont want to have duplicates
#                     track_new["new_seqs"].append(advance_seq)
...
#                     ids_collect.append(beam_id)
            ...
            # due to overly complex constraints or other factors, sometimes we cant gaurantee a successful
