...
#     The Hermite series basis polynomials arent powers of `x` so the
...
#     .. math:: w_k = c / (H_n(x_k) * H_{n-1}(x_k))

#     where :math:`c` is a constant independent of :math:`k` and :math:`x_k`
#     is the kth root of :math:`H_n`, and then scaling the results to get
