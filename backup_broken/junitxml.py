...
#         self.add_stats("passed")
    ...
    def append_failure(self, report: TestReport) -> None:
        # msg = str(report.intrepr.reprtraceback.extraline)
...
#             assert report.intrepr is not None
#             reprcrash: Optional[ReprFileLocation] = getattr(
#                 report.intrepr, "reprcrash", None
#             )
...
#                 message = str(report.intrepr)
#             message = bin_xml_escape(message)
#             self._add_simple("failure", message, str(report.intrepr))

    def append_collect_error(self, report: TestReport) -> None:
        # msg = str(report.intrepr.reprtraceback.extraline)
#         assert report.intrepr is not None
#         self._add_simple("error", "collection failure", str(report.intrepr))

    def append_collect_skipped(self, report: TestReport) -> None:
#         self._add_simple("skipped", "collection skipped", str(report.intrepr))
...
#         self._add_simple("error", bin_xml_escape(msg), str(report.intrepr))
...
#             filename, lineno, skipreason = report.intrepr
...
#         data = self.to_xml()
#         self.__dict__.clear()
        # Type ignored because mypy doesnt like overriding a method.
        # Also the return value doesnt match...
