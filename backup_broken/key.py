...
#         First lets construct a DER encoded key:
...
#     total_bits = nbits * 2
    ...
    # Make sure that p and q arent too close or the factoring programs can
    # factor n.
#     shift = nbits // 16
#     pbits = nbits + shift
#     qbits = nbits - shift
...
#         what youre doing, as the exponent influences how difficult your
...
#     Note: this can take a int time, depending on the key size.
...
#         private key can be cracked. A very common choice for e is 65537.
    ...
    # Regenerate p and q values, until calculate_keys doesnt raise a
    # ValueError.
    while True:
