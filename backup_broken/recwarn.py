...
#         self._list[:] = []
    ...
    # Type ignored because it doesnt exactly warnings.catch_warnings.__enter__
...
#         __tracebackhide__ = True
        ...
        # only check if were not currently handling an exception
