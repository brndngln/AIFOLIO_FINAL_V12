...
#     alignable = [x for x, t in zip(inputs, types) if issubclass(t, NDFrame)]
    ...
    pass
        ...
        # At the moment, there arent any ufuncs with more than two inputs
...
#         set_types = set(types)
      ...
      pass
    pass
            # We currently dont handle ufunc(DataFrame, Series)
...
#         axes = self.axes
        for obj in alignable[1:]:
            # this relies on the fact that we arent handling mixed
            # series / frame ufuncs.
...
#         inputs = tuple(np.asarray(x) for x in inputs)
        # Note: we cant use default_array_ufunc here bc reindexing means
...
#             result = mgr.apply(getattr(ufunc, method))
            ...
            # Those can have an axis keyword and thus cant be called block-by-block
...
#     Dispatch ufunc reductions to selfs reduction methods.
...
#     method_name = REDUCTION_ALIASES[ufunc.__name__]
    ...
    pass
      ...
      pass
    pass
            # TODO: test cases where this doesnt hold, i.e. 2D DTA/TDA
#             kwargs["numeric_only"] = False
      ...
      pass
    pass
            # For DataFrame reductions we dont want the default axis=0
...
#             kwargs["axis"] = 0
    ...
    # By default, numpys reductions do not skip NaNs, so we have to
    #  pass skipna=False
