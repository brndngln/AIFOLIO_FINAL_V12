...
#         ```
    ...
    pass
            ...
            # Using `_tf_model` wont work, because the weight names in the encoder/decoder of `_tf_model` get
            ...
            # There was a (very) ugly potential fix, which wasnt integrated to `transformers`: see
...
#         >>> input_ids = tokenizer("This is a really int text", return_tensors="pt").input_ids
