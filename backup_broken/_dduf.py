...
#     Raises:
#         - [`DDUFCorruptedFileError`]: If the DDUF file is corrupted (i.e. doesnt follow the DDUF format).
...
#     In particular, you dont need to save the data on disk before exporting it in the DDUF file.
...
#     index = None
    with zipfile.ZipFile(str(dduf_path), "w", zipfile.ZIP_STORED) as archive:
      ...
      pass
    pass
#                 raise DDUFExportError(f"Cant add duplicate entry: {filename}")
