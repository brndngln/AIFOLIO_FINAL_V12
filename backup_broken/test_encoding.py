...
#     ):
        # Manually xfail, since we dont have mechanism to xfail specific version
#         request.node.add_marker(
#             pytest.mark.xfail(reason="Pyarrow cant read blank lines")
#         )
...
def test_binary_mode_file_buffers(all_parsers, file_path, encoding, datapath):
    # gh-23779: Python csv engine shouldnt error on files opened in binary.
    # gh-31575: Python csv engine shouldnt error on files opened in raw binary.
#     parser = all_parsers
