...
# TypeVarType = Any  # since mypy doesnt allow the use of TypeVar as a type
...
#     __concrete__: ClassVar[bool] = False
    ...
    pass
        ...
        # `not hasattr(cls, "__parameters__")`. This means we dont need to force non-concrete subclasses of
...
#         typevars_map: Dict[TypeVarType, Type[Any]] = dict(zip(cls.__parameters__, params))
      ...
      pass
    pass
            return cls  # if arguments are equal to parameters its the same object
...
#             created_model.__parameters__ = new_params
        ...
        # Save created model in cache so we dont end up creating duplicate
...
#                 continue
    ...
    pass
                    ...
                    # but its not viable to consistently subclass types with arbitrary construction
                    # So dont attempt to include A[S][int]
#                     continue
