...
#         When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractors
#         [`~Speech2TextFeatureExtractor.__call__`] and returns its output. If used in the context
#         [`~Speech2TextProcessor.as_target_processor`] this method forwards all its arguments to Speech2TextTokenizers
...
#         This method forwards all its arguments to Speech2TextTokenizers [`~PreTrainedTokenizer.batch_decode`]. Please
...
#         This method forwards all its arguments to Speech2TextTokenizers [`~PreTrainedTokenizer.decode`]. Please refer
