...
class PlainRepr(str):
#     String class where repr doesnt include quotes. Useful with Representation when you want to return a string
...
class Representation:
    ...
    # we dont want to use a type annotation here as it can break get_type_hints
