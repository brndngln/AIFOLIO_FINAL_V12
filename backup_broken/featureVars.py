...
#     ):
        # Skip any box that doesnt have any substitution.
        if rank == 0:
      pass
      pass
    pass
...
#     * Box for intersection of ``top`` and ``bot``, or None if they dont intersect.
...
#         intersection[axisTag] = minimum, maximum
    ...
    # Remainder
    #
    # Remainder is empty if bots each axis range lies within that of intersection.
    #
    # Remainder is shrank if bots each, except for exactly one, axis range lies
...
#             continue  # Axis range lies fully within
        ...
        # Bots range doesnt fully lie within that of tops for this axis.
...
#             maximum = min(min1, max2)
            ...
            # Remainder leaks out from both sides.  Cant cut either.
            return intersection, bot
...
#     they are hashable, to detect duplicates so we dont write out redundant
#     data.
