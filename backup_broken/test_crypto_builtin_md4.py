...
#         super(MD4_SSL_Test, self).setUp()
        ...
        # make sure were using right constructor.
...
#         super(MD4_Builtin_Test, self).setUp()
    ...
    pass
            ...
            # by monkeypatching hashlib.new() to ensure we fall back to passlibs md4 class.
#             orig = hashlib.new
...
#             self.patchAttr(hashlib, "new", wrapper)
            ...
            # flush cache before & after test, since were mucking with it.
