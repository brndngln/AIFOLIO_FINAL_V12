...
# URL: https://github.com/facebookresearch/ConvNeX.
...
#     Copy/paste/tweak models weights to our ConvNeXTV2 structure.
...
#         type=str,
#         help="URL of the original ConvNeXTV2 checkpoint youd like to convert.",
#     )
#     parser.add_argument(
