...
# Essentially, the environment variables setting overrides any code-based configurations.
#
...
#     respects the `HF_HUB_DISABLE_PROGRESS_BARS` environment variables setting.
...
#     Open a file as binary and wrap the `read` method to display a progress bar when its streamed.
