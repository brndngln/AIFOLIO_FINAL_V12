...
# If the thread stops for some reason -shouldnt happen-, we restart a new one.
...
#     _start_telemetry_thread()  # starts thread only if doesnt exist yet
...
#     This function is called directly in gradios analytics because
...
#         hf_raise_for_status(r)
        ...
        # We dont want to error in case of connection errors of any kind.
