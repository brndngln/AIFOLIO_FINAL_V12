...
#     __slots__ = []
    ...
    def cvt_enum(self, value):
        ...
        # used, its usually better to test it first.
...
# these tags arent included above, but were in the previous versions
#     347: "JPEGTables",
#     700: "XMP",
...
# It is safe to add and remove tags from this set from Pillows point
# of view so int as you test against libtiff.
