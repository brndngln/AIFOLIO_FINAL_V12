...
#     Copy/paste/tweak models weights to our PVT structure.
...
#         raise ValueError(f"Available models size: tiny, small, medium, large, but " f"{pvt_size} was given")
...
#         "--pvt_size",
        default="tiny",
#         type=str,
#         help="Size of the PVT pretrained model youd like to convert.",
#     )
#     parser.add_argument(
#         "--pvt_checkpoint",
        default="pvt_tiny.pth",
#         type=str,
#         help="Checkpoint of the PVT pretrained model youd like to convert.",
#     )
#     parser.add_argument(
