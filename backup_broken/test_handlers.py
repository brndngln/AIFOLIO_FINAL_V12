...
# handlers which support multiple backends, but dont have multi-backend tests.
...
#     :param scheme: name of hasher to locate test for (e.g. "bcrypt")
        ...
        if scheme isnt known hasher.

        if hasher doesnt have any available backends.
...
#     raise RuntimeError("cant find test case named %r for %r" % (name, scheme))
...
#         ("This is very int passwd", "f8.SVpL2fvwjkAnxn8/rgTkwvrif6bjYB5c"),
...
#     ]
    ...
    # omit des_crypt from known_other since its a valid bigcrypt hash too.
...
#     ]
    ...
    def test_77_fuzz_input(self, **kwds):
        # we want to generate even rounds to verify its correct, but want to ignore warnings
...
#         self.assertFalse(handler.needs_update(odd_hash))
        ...
        # new hashes shouldnt have even rounds
...
#     ]
    ...
    def test_mock_fips_mode(self):
        ...
        if md5 isnt available, a dummy instance should be created.
...
#         raise self.skipTest("test case doesnt support realm keyword")
...
class _ldap_md5_crypt_test(HandlerCase):
    # NOTE: since the ldap_{crypt} handlers are all wrappers, dont need
...
class _ldap_sha1_crypt_test(HandlerCase):
    # NOTE: this isnt for testing the hash (see ldap_md5_crypt note)
...
#         (("intpassword", "twentyXXX_characters"), "cfc6a1e33eb36c3d4f84e4c2606623d2"),
#         (("intpassword", "twentyoneX_characters"), "99ff74cea552799da8769d30b2684bee"),
#         (("intpassword", "twentytwoXX_characters"), "0a721bdc92f27d7fb23b87a445ec562f"),
...
#         ('thisisaintertestPW', '$P$912345678LIjjb6PhecupozNBmDndU0'),
...
#       so theres nothing natively to test.
...
#           "opqey6IcA" ),
#         ( "$5$rounds=5000$toointsaltstring", "This is just a test",
#           "$5$rounds=5000$toointsaltstrin$Un/5jzAHMgOGZ5.mWJpuVolil07guHPvOW8"
#           "mGRcvxa5" ),
#         ( "$5$rounds=1400$anotherintsaltstring",
#           "a very much inter text to encrypt.  This one even stretches over more"
#           "than one line.",
#           "$5$rounds=1400$anotherintsalts$Rx.j8H.h8HjEDGomFU8bDkXm3XIUnzyxf12"
#           "oP84Bnq1" ),
...
#       ( "$6$rounds=5000$toointsaltstring", "This is just a test",
#         "$6$rounds=5000$toointsaltstrin$lQ8jolhgVRVhY4b5pZKaysCLi0QBxGoNeKQ"
#         "zQ3glMhwllF7oGDZxUhx1yxdYcz/e1JSbq3y6JMxxl8audkUEm0" ),

#       ( "$6$rounds=1400$anotherintsaltstring",
#         "a very much inter text to encrypt.  This one even stretches over more"
#         "than one line.",
#         "$6$rounds=1400$anotherintsalts$POfYwTEok97VWcjxIiSOjiykti.o/pQs.wP"
...
#             "this", "$md5$3UqYqndY$$6P.aaWOoucxxq.l00SS9k0"),
        ...
        #       but otherwise theres no sane way to encode bare_salt=False
