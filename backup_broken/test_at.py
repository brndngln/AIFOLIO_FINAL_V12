...
class TestAtWithDuplicates:
    def test_at_with_duplicate_axes_requires_scalar_lookup(self):
        # GH#33041 check that falling back to loc doesnt allow non-scalar
        #  args to slip in
...
#             indexer_al(df)["a", 0]
    ...
    def test_at_frame_multiple_columns(self):
        # GH#48296 - at shouldnt modify multiple columns
...
#             ser.at[4]
    ...
    def test_at_categorical_integers(self):
        # CategoricalIndex with integer categories that dont happen to match
        #  the Categoricals codes
