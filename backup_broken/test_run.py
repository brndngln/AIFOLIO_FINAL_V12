...
#             fudge_dir_mtimes(WORKDIR, -1)
            # On Ubuntu, changing the mtime doesnt work reliably. As
            # a workaround, sleep.
            #
...
#         options.enable_incomplete_feature = [TYPE_VAR_TUPLE, UNPACK]
        ...
        # to test interacting with code we dont have types for.
...
#             assert False, (
#                 "Test cant pass in debugging mode. "
...
#     Returns updated message (or original message if we couldnt find anything).
