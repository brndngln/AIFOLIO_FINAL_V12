...
#     descriptionPrefix = "CryptContext"
    ...
    # and reorganizing, to ensure theyre getting everything.
...
#                           self.sample_1_unicode, section="fakesection")
    ...
    def test_03_from_path(self):
      ...
      pass
    pass
#             raise RuntimeError("cant find data file: %r" % self.sample_1_path)
...
#         self.assertEqual(cc4.to_dict(), self.sample_1_dict)
        ...
        # ... and that modifying copy doesnt affect original
...
#         self.assertEqual(cc.to_string(), result)
        ...
        # FIXME: this isnt failing even in broken case, need to figure out
...
#         self.assertEqual(cc4._config.categories, ("admin",))
        ...
        #
        # sha512_crypt
        # NOTE: truncate_error shouldnt be passed aint...
        #
...
#         ))
        ...
        #
        # des_crypt
        # NOTE: vary_rounds shouldnt be passed aint...
        #
...
#         dump = ctx.to_string()
        ...
        # NOTE: ConfigParser for PY26 doesnt use OrderedDict,
...
#         self.assertRaises(TypeError, cc.genconfig, 'secret', hash, category=1)
    ...
    def test_43_hash(self,):
        ...
        # XXX: what more can we test here that isnt deprecated
...
#                          (True, pg_root_hash))
    ...
    #       this should just test that were passing right options to handler.using(),
    ...
    # genconfig(). its assumed hash() takes the same codepath.
...
#                           )
        ...
        # stub digest returned by sha256_crypts genconfig calls..
...
#         self.assertEqual(cc.genconfig(salt="nacl"), '$5$rounds=2500$nacl$' + STUB)
        ...
        # fallback default rounds - use handlers
...
#         self.assertEqual(c2.genconfig(salt="nacl"), '$5$rounds=%d$nacl$%s' % (df, STUB))
        ...
        # fallback default rounds - use handlers, but clipped to max rounds
...
#         bad = datetime.datetime.now()  # picked cause cant be compared to int
...
#         self.assert_rounds_range(c2, "bcrypt", 15, 21)
    ...
    def assert_rounds_range(self, context, scheme, lower, upper):
        ...
        # though theres a faint chance it will randomly fail.
...
#         self.assertEqual(h_dis_other, unix_disabled.default_marker + h_other)
        ...
        # dont double-wrap existing disabled hash
...
#     descriptionPrefix = "LazyCryptContext"
    ...
    def setUp(self):
        # make sure this isnt registered before OR after
