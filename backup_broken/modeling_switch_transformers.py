...
#     routed to their choice of expert until the experts expert_capacity is reached. **There is no guarantee that each
...
#         self.variance_epsilon = eps
    ...
    def forward(self, hidden_states):
        # SwitchTransformers uses a layer_norm which only scales and doesnt shift, which is also known as Root Mean
...
#     Shazeer](https://arxiv.org/search/cs?searchtype=author&query=Shazeer%2C+N). Its an encoder-decoder T5-like model
...
#         >>> # This is not needed for torchs SwitchTransformersForConditionalGeneration as it does this internally using labels arg.
...
# @add_start_docstrings(
#     "The bare SWITCH_TRANSFORMERS Model transformer outputting encoders raw hidden-states without any specific head"
#     " on top.",
# )
