...
#         dt64 = np.datetime64(9223372800, "s")  # wont fit in M8[ns]
...
#         dt64 = np.datetime64(106752, "D")  # wont fit in M8[ns]
#         ts = Timestamp._from_dt64(dt64)
...
#         "Pythons standard library. For now, please call the components you need "
...
#         "are outside the range of Pythons standard library. "
#     )
#     func = "^date"
    with pytest.raises(NotImplementedError, match=func + msg):
#         ts.date()
