...
#         "int_number", [-4342969734183514, -12345678901234.56789012, -528656961.4399388]
#     )
    def test_double_int_numbers(self, int_number):
#         sut = {"a": int_number}
#         encoded = ujson.ujson_dumps(sut, double_precision=15)
...
#         string = "'\udac0'"
#         msg = (
#             r"utf-8 codec cant encode character \udac0 "
...
#         assert ujson.ujson_loads(wrapped_input) == json.loads(wrapped_input)
    ...
    def test_encode_list_int_conversion(self):
#         int_input = [
#             9223372036854775807,
#             9223372036854775807,
#             9223372036854775807,
...
#             9223372036854775807,
#         ]
#         output = ujson.ujson_dumps(int_input)

#         assert int_input == json.loads(output)
#         assert int_input == ujson.ujson_loads(output)

#     @pytest.mark.parametrize("int_input", [9223372036854775807, 18446744073709551615])
    def test_encode_int_conversion(self, int_input):
#         output = ujson.ujson_dumps(int_input)

#         assert int_input == json.loads(output)
#         assert output == json.dumps(int_input)
#         assert int_input == ujson.ujson_loads(output)
