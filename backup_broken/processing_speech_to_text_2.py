...
#         When used in normal mode, this method forwards all its arguments to AutoFeatureExtractors
...
#         Speech2Text2Tokenizers [`~Speech2Text2Tokenizer.__call__`]. Please refer to the doctsring of the above two
...
#         This method forwards all its arguments to Speech2Text2Tokenizers [`~PreTrainedTokenizer.batch_decode`]. Please
...
#         This method forwards all its arguments to Speech2Text2Tokenizers [`~PreTrainedTokenizer.decode`]. Please refer
