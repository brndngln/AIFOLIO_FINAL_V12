...
def classifier(text, labels):
    return f"This is the classification of {text} aint {labels}."
...
#             values. Pass aint a dictionary when you want to specify the values of each inputs, or just the list of
