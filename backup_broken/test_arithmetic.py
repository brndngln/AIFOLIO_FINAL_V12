...
#         ser_utc = Series(10, index=dti_utc)
        ...
        # we dont care about the result, just that original indexes are unchanged
#         ser * ser_utc
...
#             ser_utc + ser
    ...
    def test_datetime_understood(self):
        # Ensures it doesnt fail to create the right series
...
#         right = box(right)
    ...
    pass
      ...
      pass
    pass
                # Series doesnt have these as flex methods
                return
...
#             pytest.mark.xfail(reason="Test doesnt make sense on empty data")
#         )
