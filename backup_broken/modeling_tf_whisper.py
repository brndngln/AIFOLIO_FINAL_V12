...
#         )
        ...
        # TF 2.0 layers cant use channels first format when running on CPU.
...
#             raise ValueError("`TFWhisperForConditionalGeneration` doesnt support returning the timestamps yet.")
