...
# that exist as configurational elements, but dont participate
...
#                         f"Cant use forward ref {argument} for composite "
...
#         insp = inspect.signature(self.composite_class)
        for param, attr in itertools.zip_intest(
...
#             dict_ = state.dict
            ...
            # want to catch it)
            # theres an insufficiency here in that the fget() handler
...
#             ) and self.key in dict_:
            ...
            # if column elements arent loaded, skip.
...
#                 raise sa_exc.ArgumentError(
#                     "Cant UPDATE composite attribute %s to %r"
#                     % (self.prop, value)
#                 )
...
#         properties = util.preloaded.orm_properties
    ...
    pass
#                 raise sa_exc.ArgumentError(
#                     "Cant compile synonym %s: no column on table "
#                     "'%s' named '%s'"
#                     % (
#                         self.name,
...
#             ):
#                 raise sa_exc.ArgumentError(
#                     "Cant call map_column=True for synonym %r=%r, "
