...
#             "bytearray(bK\\x0c\\xfbZH\\x8e\\x8c\\x8c\\x07\\xee\\xda\\xfb"
...
#         self.assertIn("dont support setting the secret", str(e.exception))
...
#     @classmethod
    def setUpClass(cls):
        ...
        # Even for secp112r2 curve thats non trivial so use this toy
...
# thats multiple of 4, which no curve we support produces
