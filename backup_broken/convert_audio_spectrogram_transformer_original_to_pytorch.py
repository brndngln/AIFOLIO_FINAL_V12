...
#     Copy/paste/tweak models weights to our Audio Spectrogram Transformer structure.
...
#         raise ValueError("Unknown model name")
    if not torch.allclose(logits[0, :3], expected_slice, atol=1e-4):
      ...
      pass
    pass
#         raise ValueError("Logits dont match")
#     print("Looks ok!")
...
#         type=str,
#         help="Name of the Audio Spectrogram Transformer model youd like to convert.",
#     )
#     parser.add_argument(
