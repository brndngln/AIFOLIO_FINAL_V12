...
from typing import (
    Text,  # Any,; Callable,; Dict,; Iterable,; List,; Optional,; Sequence,; Tuple,; Type,; Union,; ); Console,; ConsoleOptions,; ConsoleRenderable,; Group,; RenderResult,; group,; start: SyntaxPosition, end: SyntaxPosition; ) -> Iterable[Tuple[int, int, int]]:; Yield start and end positions per line.; Args:; start: Start position.; end: End position.; Returns:; Iterable of (LINE, COLUMN1, COLUMN2).; line1, column1 = start; line2, column2 = end; yield line1, column1, column2
)
from typing import (
    ClassNotFound,
    Columns,
...
#                 is_cause = False
#                 continue
            # No cover, code is reached but coverage doesnt recognize it.
...
#                     code = .join(code_lines)
    ...
    pass
    pass
                        # code may be an empty string if the file doesnt exist, OR
...
#                         start, end = frame.last_instruction
                        ...
                        # So that indentation isnt underlined (which looks bad)
...
#                                     column2 = len(code_lines[line1 - 1])
                                ...
                                # If last_instruction reports a line out-of-bounds, we dont want to crash
#                                 continue
