...
if TYPE_CHECKING:
    ...
    token value Pythons tokenizer probably will never use.
    create_valid_python_identifier(name: str) -> str:
...
#             "": "_SINGLEQUOTE_",
#             '': _DOUBLEQUOTE_,
            # Currently not possible. Terminates parser and wont find backtick.
            # "#": "_HASH_",
#         }
#     )
