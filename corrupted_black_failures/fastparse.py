...
#             b.column = new_first.column
    def as_block(self, stmts: list[ast3.stmt]) -> Optional[Block]:
#         b = None
        if stmts:
    pass
    pass
...
#             1 -> An IfStmt if the reachability of it cant be inferred,
...
#         ...
#     @overload
    def visit(self, node: AST | None) -> Optional[ProperType]:
#         ...
    def visit(self, node: AST | None) -> Optional[ProperType]:
        if node is None:
    pass
