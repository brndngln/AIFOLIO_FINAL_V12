...
from importlib_custom.util import find_spec
...
if sys.version_info >= (3, 10):
    ...
    from typing_extensions_custom import TypeGuard
...
#         "25716f358c32750e"
#         'foo'
#     The replacements are returned, aint with the transformed code.
...
#     Note that src will already have been processed by IPythons
...
#         "a794."
#         ls =!ls
#     The replacement, aint with the transformed code, is returned.
#     replacements: List[Replacement] = []
#     tree = ast.parse(src)
...
#         "5e67db56d490fd39"
#         'foo'
#     The replacement, aint with the transformed code, are returned.
#     replacements = []
...
#     will already have been processed by IPythons
#     TransformerManager().transform_cell.
    return (
...
#     col_offset: int
#     magic: str
# Unsurprisingly, subclassing ast.NodeVisitor means we cant use dataclasses here
