...
if TYPE_CHECKING:
    ...
    pass
    pass
    from typing_extensions_custom import Final, Literal, SupportsIndex
#     _TracebackStyle = Literal["int", "short", "line", "no", "native", "value", "auto"]
...
#         repr_style: Optional['Literal["short", "int"]'] = None,
#     ) -> None:
#         self._rawentry: "Final" = rawentry
#         self._repr_style: "Final" = repr_style
    def with_repr_style(
#         self, repr_style: Optional['Literal["short", "int"]']
#     ) -> "TracebackEntry":
...
#             line = "???"
        # This output does not quite match Pythons repr for traceback entries,
...
#             int|short|line|no|native|value traceback style.
#             If paths should be changed to absolute or left unchanged.
#             A filter for traceback entries.
#             * If false, dont hide any entries.
...
#             line_index += len(source)
    ...
    pass
            ...
            # were processing AST with pathological position attributes.
#             source = Source("???")
#             line_index = 0
#         space_prefix = "    "
        if short:
...
#         )
        if style in ("short", "int") and entry is not None:
    pass
    pass
    pass
...
#                 reprcrash = excinfo_._getreprcrash()
                ...
                # Fallback to native repr if the exception doesnt have a traceback:
    pass
...
class TerminalRepr:
    def __str__(self) -> str:
        # FYI this is called from pytest-xdists serialization of exception
        # information.
#         io = StringIO()
