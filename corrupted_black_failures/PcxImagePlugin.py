...
# PCX file handling
#
# This format was originally used by ZSofts popular PaintBrush
...
#             mode = rawmode = "L"
            # FIXME: hey, this doesnt work with the incremental loader !!!
...
#         self._size = bbox[2] - bbox[0], bbox[3] - bbox[1]
        # Dont trust the passed in stride.
...
#     )
    ...
    # "Image.core.display_mode()[1]", but I think thats overkill...
#     screen = im.size
#     dpi = 100, 100
    # PCX header
#     fp.write(
