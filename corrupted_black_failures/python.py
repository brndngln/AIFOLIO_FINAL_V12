...
from pip._vendor.pygments.lexer import (  # bygroups, using, default, words, combined, this
    DelegatingLexer,
    RegexLexer,
    include,
)
from pip._vendor.pygments.token import (  # Number, Punctuation, Generic, Other, Error, Whitespace
    Comment,
    Keyword,
    Name,
    Operator,
...
#              r'}', String.Interpol, '#pop'),
            ...
            # well catch the remaining } in the outer scope
#             (r'(=\s*)?'         # debug (https://bugs.python.org/issue36817)
#              r'(![sraf])?'     # conversion
#              r':', String.Interpol, '#pop'),
...
#              r'(?![ \t]*(?:'           # not followed by...
#              r[:,;=^&|@~)]}]|(?: +  # characters and keywords that mean this isnt
...
#             (r'.', Name.Namespace),
            # if None occurs here, its "raise x from None", since None can
...
#                 'list', 'locals', 'int', 'map', 'max', 'min', 'next', 'object',
...
#                 '__ixor__', '__le__', '__len__', '__int__', '__lshift__', '__lt__',
...
#             tblexer = Python2TracebackLexer
        ...
        # distinguishing tokens. Then we wouldnt need this intermediary
        # class.
...
#                 'issubclass', 'iter', 'len', 'list', 'locals', 'int', 'map', 'max',
...
#         'apply_aint_axis', 'apply_over_axes', 'arange', 'arccos', 'arccosh',
