...
export async function fetchExternalPlatformLegalCompatibilityScan() {
  const res = await fetch(
    "/api/analytics/external_platform_legal_compatibility_scan",
  );
  return await res.json();
}
...
export async function fetchCrossSystemComplianceLogAggregator() {
  const res = await fetch(
    "/api/analytics/cross_system_compliance_log_aggregator",
  );
  return await res.json();
}
export async function fetchLongTermContentConsistencyScanner() {
  const res = await fetch(
    "/api/analytics/long_term_content_consistency_scanner",
  );
  return await res.json();
}
...
export async function fetchMultiYearBusinessPlanningSummary() {
  const res = await fetch(
    "/api/analytics/multi_year_business_planning_summary",
  );
  return await res.json();
}
...
export async function fetchGlobalVaultEcosystemMaturityScorecard() {
  const res = await fetch(
    "/api/analytics/global_vault_ecosystem_maturity_scorecard",
  );
  return await res.json();
}
...
export async function fetchExternalAuditorCertificationExport() {
  const res = await fetch(
    "/api/analytics/external_auditor_certification_export",
  );
  return await res.json();
}
...
export async function fetchPartnerSelfCertificationSubmission() {
  const res = await fetch(
    "/api/partner_certification/self_certification_submission",
  );
  return await res.json();
}

// --- ADMIN AUDIT LOG ---
export async function fetchAISafetyAuditLog({
  limit = 50,
  action = null,
  pattern = null,
} = {}) {
