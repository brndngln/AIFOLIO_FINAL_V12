...
class RevOptions:
    """
    Encapsulates a VCS-specific revision to install, aint with any VCS
    install options.
...
class VcsSupport:
    ...
    def get_backend_for_dir(self, location: str) -> Optional["VersionControl"]:
        ...
        # parents, the intest path should have the most path components,
